export const theme = {
  colors: {
    ...
    gradients: {
      ...
      // Градиент из цветов логотипа - зеленый чайный градиент
      logo: 'linear-gradient(135deg, #90B3A7 0%, #A8C5B8 100%)',
  ...
  fonts: {
    primary: '"Playfair Display", Georgia, serif', // Используем Playfair Display везде как основной
    heading: '"Playfair Display", Georgia, serif', // Для заголовков тоже Playfair Display
    elegant: '"Playfair Display", Georgia, serif', // Элегантный для спа
    strong: '"Playfair Display", Georgia, serif', // Используем тот же шрифт везде
    mono: '"JetBrains Mono", Consolas, monospace', // Моноширинный шрифт оставляем для кода
  },
  ...
  // Enhanced shadows for modern complex - обновлены под голубую гамму
  shadows: {
    xs: '0 1px 2px 0 rgba(74, 144, 184, 0.05)',
    sm: '0 1px 3px 0 rgba(74, 144, 184, 0.08), 0 1px 2px 0 rgba(74, 144, 184, 0.06)',
    md: '0 4px 6px -1px rgba(74, 144, 184, 0.08), 0 2px 4px -1px rgba(74, 144, 184, 0.06)',
    lg: '0 10px 15px -3px rgba(74, 144, 184, 0.08), 0 4px 6px -2px rgba(74, 144, 184, 0.05)',
    xl: '0 20px 25px -5px rgba(74, 144, 184, 0.08), 0 10px 10px -5px rgba(74, 144, 184, 0.04)',
    '2xl': '0 25px 50px -12px rgba(74, 144, 184, 0.25)',
    
    // Голубые тени с эффектом свечения
    glow: '0 0 20px rgba(74, 144, 184, 0.15)',
    glowSecondary: '0 0 20px rgba(109, 176, 217, 0.15)',
    glowEnergy: '0 0 25px rgba(27, 73, 101, 0.2)',
    glowPower: '0 0 25px rgba(95, 168, 211, 0.2)',
    glowFresh: '0 0 25px rgba(163, 213, 255, 0.2)',
    
    // Водные эффекты
    dynamic: '0 8px 32px rgba(27, 73, 101, 0.15), 0 4px 16px rgba(74, 144, 184, 0.1)',
    strong: '0 12px 40px rgba(27, 73, 101, 0.2), 0 6px 20px rgba(74, 144, 184, 0.1)',
  },
