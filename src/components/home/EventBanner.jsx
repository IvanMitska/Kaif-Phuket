...
const EventBanner = ({ onClose }) => {
  ...
  const [imageError, setImageError] = useState(false); // Изображение добавлено
  ...
  const handleBooking = () => {
    ...
    if (window.gtag) {
      window.gtag('event', 'click', {
        ...
        event_label: 'Sauna Rave Booking'
      });
    }
  };
  ...
  // Event details in multiple languages
  const eventDetails = {
    en: {
      label: 'Special Event',
      title: 'SAUNA RAVE',
      ...
      time: '7 PM - 10 PM',
      location: 'KAIF Kathu, Phuket',
      features: ['DJ Show by MBJ', 'Welcome Detox & Gifts', 'Exclusive Experience'],
      bookText: 'Book Now',
      infoText: 'Learn More',
      message: 'Hi! I want to book a spot for the SAUNA RAVE event on October 17'
    },
    ru: {
      label: 'Специальное Мероприятие',
      title: 'SAUNA RAVE',
      date: '17 октября, Пятница',
      time: '19:00 - 22:00',
      location: 'KAIF Катху, Пхукет',
      features: ['DJ шоу от MBJ', 'Детокс и подарки', 'Эксклюзивный опыт'],
      bookText: 'Забронировать',
      infoText: 'Подробнее',
      message: 'Здравствуйте! Хочу забронировать место на SAUNA RAVE 17 октября'
    },
    th: {
      label: 'กิจกรรมพิเศษ',
      title: 'SAUNA RAVE',
      date: '17 ตุลาคม วันศุกร์',
      time: '19:00 - 22:00 น.',
      location: 'KAIF กะทู้ ภูเก็ต',
      features: ['ดีเจโชว์โดย MBJ', 'ดีท็อกซ์และของขวัญ', 'ประสบการณ์พิเศษ'],
      bookText: 'จองเลย',
      infoText: 'ดูรายละเอียด',
      message: 'สวัสดี! ฉันต้องการจองที่สำหรับงาน SAUNA RAVE วันที่ 17 ตุลาคม'
    }
  };

  const content = eventDetails[i18n.language] || eventDetails.en;
    ...
    <AnimatePresence>
      {isVisible && (
        ...
        >
          ...
          <GlowEffect />
          <FlameIcon className="top-left" />
          <FlameIcon className="top-right" />
          <FlameIcon className="bottom-left" />
          <FlameIcon className="bottom-right" />
          ...
          <ContentWrapper>
            ...
            <BannerContent>
              ...
              >
                {!imageError ? (
                  <PosterImage
                    src="/images/events/sauna-rave-poster.webp"
                  ...
                  <PosterPlaceholder>
                    ...
                    <div className="subtitle">KAIF KATHU, PHUKET</div>
                  </PosterPlaceholder>
                )}
              </PosterContainer>
              ...
              <InfoContainer>
                ...
                >
                  <EventDetails>
                    <DetailRow>
                      <strong>📅</strong> {content.date}
                    </DetailRow>
                    <DetailRow>
                      <strong>🕐</strong> {content.time}
                    </DetailRow>
                    <DetailRow>
                      <strong>📍</strong> {content.location}
                    </DetailRow>
                  </EventDetails>
                </motion.div>
                ...
                >
                  <CTAContainer>
                    <BookButton
                      href={`https://wa.me/66624805877?text=${encodeURIComponent(content.message)}`}
                      target="_blank"
