  ...
  const faqData = [
    {
      id: 'panoramic',
      icon: SparklesIcon,
      question: t('banya.faq.questions.panoramic.question', 'Что особенного в панорамной бане?'),
      answer: t('banya.faq.questions.panoramic.answer', 'Наша баня уникальна несколькими особенностями: площадь 150 квадратных метров с панорамными окнами в джунгли, финские печи Woodson премиум-класса, натуральные материалы из сибирских пород дерева. Это единственная панорамная русская баня на Пхукете, где можно наслаждаться традиционными банными ритуалами с видом на тропическую природу.')
    },
    {
      id: 'procedures',
      icon: FireIcon,
      question: t('banya.faq.questions.procedures.question', 'Какие процедуры входят в банный ритуал?'),
      answer: t('banya.faq.questions.procedures.answer', 'В зависимости от выбранной программы вы получите: классический банный ритуал с березовыми вениками, ароматерапию с эфирными маслами, травяные настои и чаи, возможность заказать массаж в парной, а также персональное сопровождение мастера парения для VIP-программ.')
    },
    {
      id: 'materials',
      icon: ShieldCheckIcon,
      question: t('banya.faq.questions.materials.question', 'Из каких материалов построена баня?'),
      answer: t('banya.faq.questions.materials.answer', 'Баня построена исключительно из натуральных экологически чистых материалов: сибирский кедр, алтайская липа, карельская береза. Все покрытия природные, без химических добавок. Такие материалы создают особый микроклимат и обеспечивают естественную ароматерапию.')
    },
    {
      id: 'woodson',
      icon: ClockIcon,
      question: t('banya.faq.questions.woodson.question', 'Что такое технология Woodson?'),
      answer: t('banya.faq.questions.woodson.answer', 'Woodson - это премиальные финские печи, которые обеспечивают равномерное распределение тепла и создают идеальный банный пар. Печи быстро прогревают помещение до оптимальной температуры 85°C, экологически чистые в использовании и отличаются долговечностью. Это та же технология, что используется в лучших саунах Финляндии.')
    }
  ];
      ...
      <ContentWrapper>
        ...
        >
          <SectionBadge variants={itemVariants}>
            <QuestionMarkCircleIcon />
            {t('banya.faq.badge', 'Вопросы и ответы')}
          </SectionBadge>
          
          <SectionTitle variants={itemVariants}>
            {t('banya.faq.title', 'Часто задаваемые вопросы')}
          </SectionTitle>
          
          <SectionSubtitle variants={itemVariants}>
            {t('banya.faq.subtitle', 'Ответы на самые популярные вопросы о нашей бане')}
          </SectionSubtitle>
        </SectionHeader>
