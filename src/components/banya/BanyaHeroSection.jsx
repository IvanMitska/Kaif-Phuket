...
// === STYLED COMPONENTS — Matching HeroFullscreen style ===
  ...
  return (
    <HeroContainer>
      ...
      <ContentContainer>
        <ContentWrapper>
          <HeroTextBlock>
            <HeroWord>{t('banya.hero.title_part1', 'Russian')}</HeroWord>
            <HeroWord>{t('banya.hero.title_part2', 'Banya')}</HeroWord>
            <LocationText>{t('banya.hero.location', 'Phuket')}</LocationText>
          </HeroTextBlock>
        </ContentWrapper>
      </ContentContainer>
    </HeroContainer>
