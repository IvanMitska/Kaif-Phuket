import{r as e,j as a,R as t}from"./react-core-DWAaPJsY.js";import{d as i,m as r}from"./styled-components-fuCKgGld.js";import{P as n}from"./PageScrollReset-BDYyiQ41.js";import{P as o}from"./PageHead-ByG18s83.js";import{B as s}from"./BookingModal-CAtnWKl-.js";import{u as l}from"./i18n-core-DrMVsQFB.js";import{n as c,a as d,o as p,p as g,q as m,r as b,F as f,b as h,s as u,t as x}from"./heroicons-DSEs4UIN.js";import{m as y}from"./framer-motion-Ep29qSuC.js";import"./vendor-misc-D8JVgYt7.js";import"./react-helmet-BCF-s7y-.js";i.div`
  position: relative;
  overflow: hidden;
...
`,C=e.memo(()=>{const{t:t,i18n:i}=l(),r="ru"===i.language,[n,o]=e.useState(0),[p,g]=e.useState(0),[m,b]=e.useState(!1),f=[{src:"/images/banya/panoramic.png",alt:t("banya.hero.images.panoramic","Panoramic sauna 150 m²")},{src:"/images/banya/private.jpg",alt:t("banya.hero.images.private","Private sauna")},{src:"/images/banya/public.jpg",alt:t("banya.hero.images.public","Public sauna")}];e.useEffect(()=>{const e=setInterval(()=>{g(e=>(e+1)%f.length)},8e3);return()=>clearInterval(e)},[f.length]),e.useEffect(()=>{const e=setTimeout(()=>{o(p)},1500);return()=>clearTimeout(e)},[p]);return a.jsxs(w,{children:[a.jsxs(v,{children:[a.jsx(k,{style:{backgroundImage:`url(${f[n].src})`,opacity:1,zIndex:1}},`current-${n}`),a.jsx(k,{initial:{opacity:0},animate:{opacity:n===p?0:1},transition:{duration:2,ease:"easeInOut"},style:{backgroundImage:`url(${f[p].src})`,zIndex:2}},`next-${p}`)]}),a.jsx(j,{}),a.jsx(N,{className:"top-left",children:"᚛ᚏᚓᚐᚉ᚜"}),a.jsx(N,{className:"top-right",children:"᚛ᚈᚓᚐᚉ᚜"}),a.jsx(N,{className:"bottom-left",children:"᚛ᚄᚐᚒᚈ᚜"}),a.jsx(N,{className:"bottom-right",children:"᚛ᚏᚓᚐᚉ᚜"}),a.jsxs(z,{children:[a.jsxs(I,{initial:{opacity:0,y:30},animate:{opacity:1,y:0},transition:{duration:1,delay:.2},children:[t("banya.hero.title_part1",r?"Русская":"Russian")," ",a.jsx("span",{className:"accent",children:t("banya.hero.title_part2",r?"Баня":"Banya")})]}),a.jsxs(T,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.8,delay:.4},children:[a.jsx("span",{className:"location",children:t("banya.hero.location",r?"Пхукет":"Phuket")})," — ",a.jsxs("span",{className:"size",children:["150 ",t("banya.hero.area_unit",r?"м²":"m²")]}),a.jsx("span",{className:"feature",children:t("banya.hero.feature",r?"Самая большая баня на острове":"Largest banya on the island")})]}),a.jsx(S,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.8,delay:.6},children:"Сибирский кедр и алтайская липа"}),a.jsxs(_,{initial:{opacity:0,y:30},animate:{opacity:1,y:0},transition:{duration:.8,delay:.8},children:[a.jsxs(B,{onClick:()=>b(!0),whileHover:{scale:1.05},whileTap:{scale:.95},children:[a.jsx(c,{}),t("banya.hero.book_button","ЗАБРОНИРОВАТЬ")]}),a.jsxs(E,{onClick:()=>{const e=t("common.phone_number","+66 62 480 5877");window.open(`tel:${e}`,"_self")},whileHover:{scale:1.05},whileTap:{scale:.95},children:[a.jsx(d,{}),t("banya.hero.contacts_button","КОНТАКТЫ")]})]})]}),a.jsx(s,{isOpen:m,onClose:()=>b(!1),service:t("banya.booking.service","Russian Banya"),source:"Banya page - Hero"})]})}),H=i.section`
...
`,BanyaBookingSection=()=>{const{t:t}=l(),[i,r]=e.useState(!1),n=[{icon:b,title:t("banya.booking.contact.whatsapp.title","WhatsApp"),value:t("banya.booking.contact.whatsapp.value","Book via WhatsApp"),action:()=>{const e=t("common.phone_number","+66 62 480 5877"),a=encodeURIComponent(t("common.whatsapp_messages.book_banya","Hello! I would like to book the Russian Banya"));window.open(`https://wa.me/${e.replace(/\D/g,"")}?text=${a}`,"_blank")}},{icon:f,title:t("banya.booking.contact.location.title","Location"),value:t("banya.booking.contact.location.value","Kathu, Phuket"),action:()=>{window.open("https://maps.app.goo.gl/h7PzpHpBeurg7eK18","_blank")}},{icon:h,title:t("banya.booking.contact.hours.title","Hours"),value:t("banya.booking.contact.hours.value","17:00 - 22:00"),action:null}];return a.jsxs(ke,{children:[a.jsx(Ve,{className:"top-left",children:"᚛ᚃᚔᚏᚓ᚜"}),a.jsx(Ve,{className:"bottom-right",children:"᚛ᚔᚉᚓ᚜"}),a.jsxs(je,{children:[a.jsxs(ze,{children:[a.jsx(Ie,{initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.6},children:t("banya.booking.badge","Booking")}),a.jsx(Te,{initial:{opacity:0,y:30},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.8,delay:.2},children:a.jsx("span",{dangerouslySetInnerHTML:{__html:t("banya.booking.title",'Book the <span className="highlight">Banya</span>')}})}),a.jsx(Se,{initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.6,delay:.4},children:t("banya.booking.description","Contact us through convenient channels for booking")})]}),a.jsx(y.div,{initial:{opacity:0,y:40},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.8,delay:.6},children:a.jsxs(_e,{children:[a.jsx(Be,{children:a.jsx("span",{dangerouslySetInnerHTML:{__html:t("banya.booking.cta.title",'Ready to immerse in the world of <span className="highlight">Russian Banya</span>?')}})}),a.jsx(Ee,{children:t("banya.booking.cta.description","Contact us for detailed information about prices, availability and features of our banya programs")}),a.jsx(Ne,{children:n.map((e,t)=>a.jsxs(Ce,{initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.6,delay:.8+.1*t},onClick:e.action,style:{cursor:e.action?"pointer":"default"},children:[a.jsx(He,{children:a.jsx(e.icon,{})}),a.jsx($e,{children:e.title}),a.jsx(Ae,{children:e.value})]},t))}),a.jsxs(qe,{children:[a.jsxs(Me,{onClick:()=>r(!0),whileHover:{scale:1.05},whileTap:{scale:.95},children:[a.jsx(c,{}),t("banya.booking.book_online_button","Book Online")]}),a.jsxs(Le,{onClick:()=>{const e=t("common.phone_number","+66 62 480 5877");window.open(`tel:${e}`,"_self")},whileHover:{scale:1.05},whileTap:{scale:.95},children:[a.jsx(d,{}),t("banya.booking.call_now_button","Call Now")]})]})]})})]}),a.jsx(s,{isOpen:i,onClose:()=>r(!1),service:t("banya.booking.service","Russian Banya"),source:"Banya page - booking section"})]})};r`
  0%, 100% { text-shadow: 0 0 10px #ff6b35, 0 0 20px #ff6b35; }
  50% { text-shadow: 0 0 20px #ff6b35, 0 0 30px #ff6b35, 0 0 40px #ff6b35; }
`,r`
...
`,BanyaFAQSection=()=>{const{t:t}=l(),[i,r]=e.useState(null),n=[{question:t("banya.faq.questions.panoramic.question","What's special about the panoramic banya?"),answer:t("banya.faq.questions.panoramic.answer","Our banya is unique with several features: 150 square meters with panoramic jungle windows, built from Siberian cedar and Altai linden - premium natural materials. It's the only panoramic Russian banya in Phuket where you can enjoy traditional banya rituals with tropical nature views.")},{question:t("banya.faq.questions.procedures.question","What procedures are included in the banya ritual?"),answer:t("banya.faq.questions.procedures.answer","Depending on your chosen program you'll receive: classic banya ritual with birch brooms, aromatherapy with essential oils, herbal infusions and teas, option to order massage in the steam room, and personal accompaniment by a master attendant for VIP programs.")},{question:t("banya.faq.questions.materials.question","What materials is the banya built from?"),answer:t("banya.faq.questions.materials.answer","The banya is built exclusively from natural eco-friendly materials: Siberian cedar, Altai linden, Karelian birch. All finishes are natural, without chemical additives. Such materials create a special microclimate and provide natural aromatherapy.")}];return a.jsx(Oe,{children:a.jsxs(Pe,{children:[a.jsxs(Re,{children:[a.jsxs(Ge,{initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.6},children:[a.jsx(u,{}),t("banya.faq.badge","Questions & Answers")]}),a.jsx(Ye,{initial:{opacity:0,y:30},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.8,delay:.2},children:a.jsx("span",{dangerouslySetInnerHTML:{__html:t("banya.faq.title",'Frequently Asked <span className="highlight">Questions</span>')}})}),a.jsx(We,{initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.6,delay:.4},children:t("banya.faq.subtitle","Answers to the most popular questions about our banya")})]}),a.jsx(Ue,{children:n.map((e,t)=>a.jsxs(De,{initial:{opacity:0,y:30},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.6,delay:.1*t},children:[a.jsxs(Fe,{onClick:()=>(e=>{r(i===e?null:e)})(t),children:[a.jsx(Ke,{$isOpen:i===t,children:e.question}),a.jsx(Xe,{$isOpen:i===t,children:a.jsx(x,{})})]}),a.jsx(Qe,{$isOpen:i===t,children:a.jsx(Je,{children:a.jsx("p",{children:e.answer})})})]},t))})]})})},Ze=i.div`
...
`,BanyaPage=()=>{const{t:e}=l(),[i,r]=t.useState(!1);t.useEffect(()=>{document.body.classList.add("banya-page"),window.scrollTo(0,0);const e=setTimeout(()=>{r(!0)},50);return()=>{document.body.classList.remove("banya-page"),clearTimeout(e)}},[]);return i?a.jsxs(Ze,{as:y.div,initial:"initial",animate:"animate",exit:"exit",variants:{initial:{opacity:0,scale:.98},animate:{opacity:1,scale:1,transition:{duration:.4,ease:[.43,.13,.23,.96]}},exit:{opacity:0,scale:.98,transition:{duration:.3,ease:[.43,.13,.23,.96]}}},transition:{duration:.2},children:[a.jsx(o,{titleKey:"page_titles.banya",description:e("banya.hero.subtitle","Traditional Russian banya experience"),keywords:"KAIF banya, Russian sauna, traditional banya, steam bath, Phuket",ogImage:"/images/banya/panoramic.jpg"}),a.jsx(n,{}),a.jsx(C,{}),a.jsx(BanyaServicesSection,{}),a.jsx(BanyaGallerySection,{}),a.jsx(BanyaFeaturesSection,{}),a.jsx(BanyaFAQSection,{}),a.jsx(BanyaBookingSection,{})]}):null};export{BanyaPage as default};
