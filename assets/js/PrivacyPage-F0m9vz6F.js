import{j as i}from"./react-core-CV8k_GRh.js"
import{d as r}from"./styled-components-CMIfAvVS.js"
import{P as t}from"./CommonComponents-BxKEOWPe.js"
import{u as e}from"./i18n-core-CSZVPE1N.js"
...
`,a=r.h1`
  font-family: ${({theme:i})=>{var r
return(null==(r=null==i?void 0:i.fonts)?void 0:r.elegant)||'"Playfair Display", serif'}};
  font-size: clamp(2rem, 4vw, 3rem);
  font-weight: 300;
  color: ${({theme:i})=>{var r,t
return(null==(t=null==(r=null==i?void 0:i.colors)?void 0:r.text)?void 0:t.primary)||"#2C3E2D"}};
  margin-bottom: 2rem;
  text-align: center;
`,l=r.div`
  font-family: ${({theme:i})=>{var r
return(null==(r=null==i?void 0:i.fonts)?void 0:r.primary)||"Inter, sans-serif"}};
  font-size: 1.1rem;
  line-height: 1.8;
  color: ${({theme:i})=>{var r,t
return(null==(t=null==(r=null==i?void 0:i.colors)?void 0:r.text)?void 0:t.secondary)||"#666"}};
