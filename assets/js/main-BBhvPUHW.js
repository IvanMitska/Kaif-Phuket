const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/js/AdvantagesSection-CJ9Wf9y_.js","assets/js/vendor-react-2dSHS-vn.js","assets/js/vendor-other-CZupzcPt.js","assets/js/vendor-styles-trh3mqkF.js","assets/js/vendor-animations-Coyk9q7u.js","assets/js/GallerySection-s8NSVHXv.js","assets/js/FAQSection-Cb4AU9-p.js","assets/js/RestaurantPage-CYZZqgbK.js","assets/js/PageScrollReset-BJFNCQZ7.js","assets/js/vendor-i18n-C4kh69yx.js","assets/js/SpaPage-BzoVdk7u.js","assets/js/SportsPage-CLKHP7Gw.js","assets/js/BanyaPage-Hsd5D6S1.js","assets/js/ContactsPage-BgTx7RZ8.js","assets/js/CommonComponents-zMySpn2D.js","assets/js/PrivacyPage-h6Z9ExpP.js","assets/js/TermsPage-B5FcK2XI.js","assets/js/SurveyPage-CgngyOBW.js"])))=>i.map(i=>d[i]);
import{r as e,j as i,R as t,u as a,i as n,a as o,b as r,F as s,c as l,d as c,L as p,H as d,e as m,f as h,g as u,I as g,h as b,B as f,k as x,l as _,N as y,m as w}from"./vendor-react-2dSHS-vn.js";import{f as v,m as k,d as A,o as j}from"./vendor-styles-trh3mqkF.js";import{i as F,B as S}from"./vendor-i18n-C4kh69yx.js";import{m as C,A as P}from"./vendor-animations-Coyk9q7u.js";import"./vendor-other-CZupzcPt.js";!function(){const e=document.createElement("link").relList;if(!(e&&e.supports&&e.supports("modulepreload"))){for(const e of document.querySelectorAll('link[rel="modulepreload"]'))i(e);new MutationObserver(e=>{for(const t of e)if("childList"===t.type)for(const e of t.addedNodes)"LINK"===e.tagName&&"modulepreload"===e.rel&&i(e)}).observe(document,{childList:!0,subtree:!0})}function i(e){if(e.ep)return;e.ep=!0;const i=function(e){const i={};return e.integrity&&(i.integrity=e.integrity),e.referrerPolicy&&(i.referrerPolicy=e.referrerPolicy),"use-credentials"===e.crossOrigin?i.credentials="include":"anonymous"===e.crossOrigin?i.credentials="omit":i.credentials="same-origin",i}(e);fetch(e.href,i)}}();const z={},I=function(e,i,t){let a=Promise.resolve();if(i&&i.length>0){let e=function(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:"fulfilled",value:e}),e=>({status:"rejected",reason:e}))))};document.getElementsByTagName("link");const t=document.querySelector("meta[property=csp-nonce]"),n=(null==t?void 0:t.nonce)||(null==t?void 0:t.getAttribute("nonce"));a=e(i.map(e=>{if((e=function(e){return"/"+e}(e))in z)return;z[e]=!0;const i=e.endsWith(".css"),t=i?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${e}"]${t}`))return;const a=document.createElement("link");return a.rel=i?"stylesheet":"modulepreload",i||(a.as="script"),a.crossOrigin="",a.href=e,n&&a.setAttribute("nonce",n),document.head.appendChild(a),i?new Promise((i,t)=>{a.addEventListener("load",i),a.addEventListener("error",()=>t(new Error(`Unable to preload CSS for ${e}`)))}):void 0}))}function n(e){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=e,window.dispatchEvent(i),!i.defaultPrevented)throw e}return a.then(i=>{for(const e of i||[])"rejected"===e.status&&n(e.reason);return e().catch(n)})},T=v`
...
`,E=e.createContext();let M=!1;const K=()=>e.useContext(E),R=({children:t})=>{const[a,n]=e.useState(!1),[o,r]=e.useState(!0),s=e.useRef(!1),l=e.useRef(!1);return i.jsx(E.Provider,{value:{isLoading:a,isContentReady:o,showLoading:(e=1e3)=>s.current||l.current||M?Promise.resolve():(M=!0,s.current=!0,l.current=!0,r(!1),n(!0),new Promise(i=>{setTimeout(()=>{n(!1),setTimeout(()=>{r(!0),s.current=!1,i()},200)},e)})),showContentDirectly:()=>{l.current=!0,n(!1),r(!0),s.current=!1},resetLoading:()=>{l.current=!1,s.current=!1,n(!1),r(!0)}},children:t})},q=k`
  from { opacity: 0; }
  to { opacity: 1; }
`,L=k`
  from { opacity: 1; }
...
`,xe=({children:t})=>{const n=a(),[o,r]=e.useState(!0),s=e.useRef(!0),{isLoading:l}=K();return e.useEffect(()=>{if(s.current)return s.current=!1,void r(!0);r(!1),window.scrollTo(0,0);const e=setTimeout(()=>{r(!0)},500);return()=>clearTimeout(e)},[n.pathname]),i.jsxs(i.Fragment,{children:[i.jsx(B,{}),i.jsx($,{isVisible:!o&&!l}),i.jsx(J,{}),i.jsxs(be,{children:[i.jsx(fe,{children:t}),o&&i.jsx(ge,{})]})]})},_e=({titleKey:t="page_titles.home",defaultTitle:a="KAIF | Sauna & Spa",description:n,keywords:r,ogImage:s,pageType:l="website"})=>{const{t:c,i18n:p}=o(),m=c(t,a);return e.useEffect(()=>{document.title=m},[m,p.language]),i.jsxs(d,{children:[i.jsx("title",{children:m}),n&&i.jsx("meta",{name:"description",content:n}),r&&i.jsx("meta",{name:"keywords",content:r}),i.jsx("meta",{property:"og:title",content:m}),n&&i.jsx("meta",{property:"og:description",content:n}),i.jsx("meta",{property:"og:type",content:l}),s&&i.jsx("meta",{property:"og:image",content:s}),i.jsx("meta",{name:"twitter:title",content:m}),n&&i.jsx("meta",{name:"twitter:description",content:n}),i.jsx("meta",{name:"twitter:card",content:"summary_large_image"}),s&&i.jsx("meta",{name:"twitter:image",content:s}),i.jsx("link",{rel:"shortcut icon",type:"image/png",href:"/favicon.png"}),i.jsx("link",{rel:"icon",type:"image/png",href:"/favicon.png"}),i.jsx("meta",{name:"theme-color",content:"#2C614F"})]})},ye=A.section`
  ${"\n  @keyframes flicker {\n    0%, 100% { opacity: 1; }\n    50% { opacity: 0.8; }\n    55% { opacity: 1; }\n    60% { opacity: 0.9; }\n    65% { opacity: 0.95; }\n  }\n"}
  position: relative;
  width: 100%;
  min-height: 100vh;
...
`,ze=e.memo(()=>{const{t:e}=o();return i.jsxs(ye,{children:[i.jsx(we,{}),i.jsx(ve,{children:i.jsxs(ke,{children:[i.jsx(Ae,{initial:{opacity:0,y:-20},animate:{opacity:1,y:0},transition:{duration:.8,ease:"easeOut",delay:.2},children:"MENTAL HOSPITAL"}),i.jsx(je,{initial:{opacity:0,y:-10},animate:{opacity:1,y:0},transition:{duration:.6,ease:"easeOut",delay:.4},children:"OF KAIF"}),i.jsxs("picture",{style:{display:"block"},children:[i.jsx("source",{srcSet:"/assets/images/logo-homepage-Bvg3zKLL.webp",type:"image/webp"}),i.jsx(Fe,{src:"/assets/images/logo-homepage-H1DZjSiR.png",alt:"KAIF",initial:{scale:.95,opacity:0},animate:{scale:1,opacity:1},transition:{duration:.8,ease:"easeOut",delay:.5},whileHover:{scale:1.02,transition:{duration:.2,ease:"easeOut"}}})]}),i.jsxs(Pe,{as:C.div,initial:{opacity:0,y:15},animate:{opacity:1,y:0},transition:{duration:.5,ease:"easeOut",delay:.7},children:[i.jsx(C.div,{whileHover:{scale:1.02,transition:{duration:.15,ease:"easeOut"}},whileTap:{scale:.98},children:i.jsx(Se,{href:"https://wa.me/66624805877?text=Hi!%20I%20want%20to%20book%20for%20Halloween%20Mental%20Hospital%20at%20KAIF",target:"_blank",rel:"noopener noreferrer",children:"🎃 ENTER IF YOU DARE"})}),i.jsx(C.div,{onClick:()=>{const e=document.querySelector("#exclusive-zones");e&&e.scrollIntoView({behavior:"smooth",block:"start"})},whileHover:{scale:1.01,transition:{duration:.15,ease:"easeOut"}},whileTap:{scale:.99},children:i.jsx(Ce,{children:"EXPLORE THE ASYLUM"})})]})]})})]})});ze.displayName="HeroFullscreen";const Ie=A.section`
  position: relative;
  padding: 6rem 0;
  background-color: #ffffff;
  overflow: hidden;
...
`,Ue=()=>{const{t}=o(),[a,n]=e.useState("all"),r=e.useMemo(()=>[{id:"fitness",name:t("zones.activity.fitness.name"),description:t("zones.activity.fitness.description"),image:"/images/zones/fitness.jpg",path:"/sports"},{id:"combat",name:t("zones.activity.combat.name"),description:t("zones.activity.combat.description"),image:"/images/zones/combat.jpg",path:"/sports"},{id:"pool",name:t("zones.activity.pool.name"),description:t("zones.activity.pool.description"),image:"/images/zones/pool.jpg",path:"/sports"}],[t]),s=e.useMemo(()=>[{id:"spa",name:t("zones.relax.spa.name"),description:t("zones.relax.spa.description"),image:"/images/zones/spa.jpg",path:"/spa"},{id:"banya",name:t("zones.relax.banya.name"),description:t("zones.relax.banya.description"),image:"/assets/images/hero-luxury-CYZ2FLIl.png",path:"/banya"},{id:"restaurant",name:t("zones.relax.restaurant.name"),description:t("zones.relax.restaurant.description"),image:"/images/zones/restaurant.jpg",path:"/restaurant"}],[t]),l=(e,a)=>e.map((e,n)=>i.jsxs(Oe,{initial:{opacity:0,y:30},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.1,margin:"-50px"},transition:{duration:.6,delay:.05*n},children:[i.jsx(He,{src:e.image,alt:e.name}),i.jsxs(De,{children:[i.jsx(We,{children:e.name}),i.jsx($e,{children:e.description}),i.jsxs(Ne,{to:e.path,children:[t("common.exploreMore","Подробнее"),i.jsx(u,{})]})]})]},`${a}-${e.id}`)),c=e=>{e!==a&&n(e)};return i.jsx(Ie,{id:"exclusive-zones",children:i.jsxs(Te,{children:[i.jsxs(Be,{children:[i.jsx(Ee,{initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.2},transition:{duration:.8},children:t("zones.overline","Пространства KAIF")}),i.jsx(Me,{initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.2},transition:{duration:.8,delay:.2},children:t("zones.title","Всё необходимое для активного отдыха и релаксации")})]}),i.jsxs(Ve,{children:[i.jsx(Ge,{$active:"all"===a,onClick:()=>c("all"),children:t("zones.all","Все зоны")}),i.jsxs(Ge,{$active:"activity"===a,onClick:()=>c("activity"),children:[i.jsx(m,{}),t("zones.activity_label","Активити")]}),i.jsxs(Ge,{$active:"relax"===a,onClick:()=>c("relax"),children:[i.jsx(h,{}),t("zones.relax_label","Релакс")]})]}),i.jsxs(Ke,{children:[("all"===a||"activity"===a)&&i.jsxs("div",{children:[i.jsx(Re,{children:i.jsxs(qe,{children:[i.jsx(m,{}),t("zones.activity_label","Активити")]})}),i.jsx(Le,{children:l(r,"activity")})]}),("all"===a||"relax"===a)&&i.jsxs("div",{children:[i.jsx(Re,{children:i.jsxs(qe,{children:[i.jsx(h,{}),t("zones.relax_label","Релакс")]})}),i.jsx(Le,{children:l(s,"relax")})]})]})]})})},Ye=k`
...
`,bi=A.div`
  ...
  opacity: 0.3;
  animation: ${Xe} ${e=>e.duration||"3s"} infinite;
  animation-delay: ${e=>e.delay||"0s"};
  z-index: 1;
  pointer-events: none;
...
`,xi=A.div`
  position: absolute;
  top: ${e=>e.top||"10%"};
  ${e=>e.left?`left: ${e.left};`:`right: ${e.right};`}
...
`,_i=A.div`
  ...
  @media (max-width: 768px) {
    width: ${e=>e.mobileSize||"50px"};
    height: ${e=>e.mobileSize||"50px"};
    opacity: 0.5;
...
`,ki=A.div`
  ...
  height: 2px;
  background: rgba(139, 0, 0, 0.3);
  transform: rotate(${e=>e.rotate||"-15deg"});
  z-index: 1;
  pointer-events: none;
...
`,Ai=A.div`
  ...
  @media (max-width: 768px) {
    font-size: ${e=>e.mobileFontSize||"1.2rem"};
    opacity: 0.25;
    letter-spacing: 0.2em;
  }
`,ji=A.div`
...
`,Fi=({onClose:t})=>{const[a,n]=e.useState(!0);return e.useEffect(()=>{sessionStorage.getItem("halloweenBannerClosed")&&n(!1)},[]),a?i.jsx(P,{children:a&&i.jsxs(ei,{initial:{opacity:0,y:-20},animate:{opacity:1,y:0},exit:{opacity:0,y:-20},transition:{duration:.5,ease:"easeOut"},children:[i.jsx(gi,{style:{top:"15%",left:"5%"},size:"4rem",mobileSize:"2.5rem",delay:"0s"}),i.jsx(gi,{style:{top:"20%",right:"8%"},size:"3.5rem",mobileSize:"2rem",delay:"0.5s"}),i.jsx(gi,{style:{bottom:"20%",left:"10%"},size:"3rem",mobileSize:"1.8rem",delay:"1s"}),i.jsx(gi,{style:{bottom:"15%",right:"5%"},size:"4rem",mobileSize:"2.5rem",delay:"1.5s"}),i.jsx(bi,{style:{top:"10%",left:"15%"},duration:"4s",delay:"0s"}),i.jsx(bi,{style:{top:"10%",right:"20%"},duration:"5s",delay:"1s"}),i.jsx(bi,{style:{top:"10%",left:"50%"},duration:"4.5s",delay:"2s"}),i.jsx(bi,{style:{top:"10%",right:"35%"},duration:"5.5s",delay:"0.5s"}),i.jsx(bi,{style:{top:"10%",left:"25%"},duration:"4.2s",delay:"1.5s"}),i.jsx(bi,{style:{top:"10%",right:"45%"},duration:"5.2s",delay:"2.5s"}),i.jsx(bi,{style:{top:"10%",left:"60%"},duration:"4.8s",delay:"0.8s"}),i.jsx(bi,{style:{top:"10%",right:"12%"},duration:"5.8s",delay:"1.8s"}),i.jsx(_i,{style:{top:"15%",left:"8%"},size:"100px",mobileSize:"60px"}),i.jsx(_i,{style:{top:"25%",right:"12%"},size:"80px",mobileSize:"50px"}),i.jsx(_i,{style:{bottom:"30%",left:"5%"},size:"120px",mobileSize:"70px"}),i.jsx(_i,{style:{bottom:"25%",right:"8%"},size:"90px",mobileSize:"55px"}),i.jsx(_i,{style:{top:"45%",left:"15%"},size:"70px",mobileSize:"45px"}),i.jsx(_i,{style:{top:"50%",right:"18%"},size:"110px",mobileSize:"65px"}),i.jsx(yi,{style:{top:"5%",left:"20%"},length:"180px",mobileLength:"100px"}),i.jsx(yi,{style:{top:"5%",right:"25%"},length:"200px",mobileLength:"110px"}),i.jsx(yi,{style:{top:"5%",left:"45%"},length:"160px",mobileLength:"90px"}),i.jsx(yi,{style:{top:"5%",right:"50%"},length:"220px",mobileLength:"120px"}),i.jsx(ki,{style:{top:"30%",left:"12%"},rotate:"-20deg"}),i.jsx(ki,{style:{top:"55%",right:"15%"},rotate:"15deg"}),i.jsx(ki,{style:{bottom:"35%",left:"18%"},rotate:"-25deg"}),i.jsx(ki,{style:{top:"40%",left:"8%"},rotate:"10deg"}),i.jsx(ki,{style:{bottom:"45%",right:"10%"},rotate:"-30deg"}),i.jsx(Ai,{style:{top:"20%",left:"18%"},fontSize:"3rem",mobileFontSize:"1.5rem",rotate:"-8deg",children:"INSANE"}),i.jsx(Ai,{style:{top:"60%",right:"15%"},fontSize:"2rem",mobileFontSize:"1rem",rotate:"12deg",children:"HELP ME"}),i.jsx(Ai,{style:{bottom:"25%",left:"12%"},fontSize:"2.5rem",mobileFontSize:"1.2rem",rotate:"-5deg",children:"NO ESCAPE"}),i.jsx(Ai,{style:{top:"45%",right:"20%"},fontSize:"1.8rem",mobileFontSize:"0.9rem",rotate:"8deg",children:"TREATMENT"}),i.jsx(ji,{style:{top:"18%",left:"10%"},rotate:"-30deg"}),i.jsx(ji,{style:{top:"50%",right:"12%"},rotate:"25deg"}),i.jsx(ji,{style:{bottom:"30%",left:"8%"},rotate:"40deg"}),i.jsx(wi,{style:{top:"12%",left:"3%"},children:"PATIENT #66-613"}),i.jsx(wi,{style:{top:"70%",right:"3%"},children:"WARD #13"}),i.jsx(wi,{style:{bottom:"12%",left:"4%"},children:"ADMIT #1031"}),i.jsx(vi,{style:{top:"8%",left:"35%"},rotate:"-2deg",children:"DANGER"}),i.jsx(vi,{style:{bottom:"8%",right:"30%"},rotate:"3deg",children:"NO EXIT"}),i.jsx(xi,{left:"2%",top:"5%",rotate:"-5deg",children:"⚠ Ward A"}),i.jsx(xi,{right:"2%",top:"8%",rotate:"3deg",children:"Psychiatric"}),i.jsx(xi,{left:"3%",top:"85%",rotate:"2deg",children:"Emergency"}),i.jsx(xi,{right:"4%",top:"92%",rotate:"-4deg",children:"Isolation"}),i.jsx(fi,{}),i.jsxs(ii,{children:[i.jsx(ai,{onClick:()=>{n(!1),sessionStorage.setItem("halloweenBannerClosed","true"),t&&t()},whileHover:{scale:1.1},whileTap:{scale:.9},children:i.jsx(g,{})}),i.jsxs(ti,{children:[i.jsx(ni,{initial:{scale:.9,opacity:0},animate:{scale:1,opacity:1},transition:{delay:.2,duration:.5},children:i.jsx(oi,{src:"/images/events/hospital.png",alt:"Halloween Event",loading:"eager"})}),i.jsxs(ri,{children:[i.jsx(C.div,{initial:{opacity:0,x:20},animate:{opacity:1,x:0},transition:{delay:.3,duration:.5},children:i.jsx(si,{children:"🎃 HALLOWEEN EVENT"})}),i.jsx(C.div,{initial:{opacity:0,x:20},animate:{opacity:1,x:0},transition:{delay:.4,duration:.5},children:i.jsxs(li,{children:["MENTAL",i.jsx("span",{children:"HOSPITAL"})]})}),i.jsx(C.div,{initial:{opacity:0,x:20},animate:{opacity:1,x:0},transition:{delay:.5,duration:.5},children:i.jsxs(ci,{children:[i.jsxs(pi,{children:[i.jsx("strong",{children:"📅"})," October 31, Thursday"]}),i.jsxs(pi,{children:[i.jsx("strong",{children:"🕐"})," 7 PM - 12 AM"]}),i.jsxs(pi,{children:[i.jsx("strong",{children:"📍"})," KAIF Jungle Club & SPA"]})]})}),i.jsx(C.div,{initial:{opacity:0,x:20},animate:{opacity:1,x:0},transition:{delay:.6,duration:.5},children:i.jsxs(di,{children:[i.jsx(mi,{children:"Insane Asylum Experience"}),i.jsx(mi,{children:"Horror Show"}),i.jsx(mi,{children:"Crazy Night"})]})}),i.jsx(C.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.7,duration:.5},children:i.jsx(hi,{children:i.jsx(ui,{href:"https://wa.me/66624805877?text=Hi!%20I%20want%20to%20book%20for%20the%20Halloween%20Mental%20Hospital%20event%20on%20October%2031",target:"_blank",rel:"noopener noreferrer",whileHover:{scale:1.05},whileTap:{scale:.95},children:"🎃 BOOK NOW"})})})]})]})]})]})}):null},Si=e.lazy(()=>I(()=>import("./AdvantagesSection-CJ9Wf9y_.js"),__vite__mapDeps([0,1,2,3,4])).then(i=>({default:e.memo(i.default)}))),Ci=e.lazy(()=>I(()=>import("./GallerySection-s8NSVHXv.js"),__vite__mapDeps([5,1,2,3,4])).then(i=>({default:e.memo(i.GallerySection)}))),Pi=e.lazy(()=>I(()=>import("./FAQSection-Cb4AU9-p.js"),__vite__mapDeps([6,1,2,3,4])).then(i=>({default:e.memo(i.default)}))),zi=A.div`
  height: 120px;
  display: flex;
  align-items: center;
  justify-content: center;
...
`,Bi=e.memo(()=>{const{t}=o(),{showLoading:a}=K(),n=e.useRef(!1);return e.useEffect(()=>{n.current||(n.current=!0,a(1e3))},[]),i.jsxs("main",{children:[i.jsx(_e,{titleKey:"page_titles.home",description:t("home.hero.subtitle","Unique relaxation and wellness experience in Phuket"),keywords:"KAIF, spa, wellness, Phuket, gym, restaurant, banya, massage",ogImage:"/images/logos/logo-og.png"}),i.jsx(ze,{}),i.jsx(Fi,{}),i.jsx(Ue,{}),i.jsx(e.Suspense,{fallback:i.jsx(zi,{}),children:i.jsx(Si,{})}),i.jsx(e.Suspense,{fallback:i.jsx(zi,{}),children:i.jsx(Ci,{})}),i.jsx(e.Suspense,{fallback:i.jsx(zi,{}),children:i.jsx(Pi,{})}),i.jsx(Ii,{children:i.jsxs(Ti,{to:"/contacts",children:[t("common.contact_us"),i.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",children:i.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M17 8l4 4m0 0l-4 4m4-4H3"})})]})})]})});Bi.displayName="HomePage";const Ei=t.lazy(()=>I(()=>import("./RestaurantPage-CYZZqgbK.js"),__vite__mapDeps([7,1,2,3,8,4,9]))),Mi=t.lazy(()=>I(()=>import("./SpaPage-BzoVdk7u.js"),__vite__mapDeps([10,1,2,3,8,4,9]))),Ki=t.lazy(()=>I(()=>import("./SportsPage-CLKHP7Gw.js").then(e=>e.d),__vite__mapDeps([11,1,2,3,4,8]))),Ri=t.lazy(()=>I(()=>import("./BanyaPage-Hsd5D6S1.js"),__vite__mapDeps([12,1,2,3,8,4,9]))),qi=t.lazy(()=>I(()=>import("./ContactsPage-BgTx7RZ8.js"),__vite__mapDeps([13,1,2,3,4,14,8,9]))),Li=t.lazy(()=>I(()=>import("./PrivacyPage-h6Z9ExpP.js"),__vite__mapDeps([15,1,2,3,14,4]))),Oi=t.lazy(()=>I(()=>import("./TermsPage-B5FcK2XI.js"),__vite__mapDeps([16,1,2,3,14,4]))),Hi=t.lazy(()=>I(()=>import("./SurveyPage-CgngyOBW.js"),__vite__mapDeps([17,1,2,3,8,4,9]))),Di=()=>null,Wi=()=>{const t=a();return i.jsx(e.Suspense,{fallback:i.jsx(Di,{}),children:i.jsxs(x,{location:t,children:[i.jsx(_,{path:"/",element:i.jsx(Bi,{})}),i.jsx(_,{path:"/restaurant",element:i.jsx(Ei,{})}),i.jsx(_,{path:"/spa",element:i.jsx(Mi,{})}),i.jsx(_,{path:"/sports",element:i.jsx(Ki,{})}),i.jsx(_,{path:"/banya",element:i.jsx(Ri,{})}),i.jsx(_,{path:"/contacts",element:i.jsx(qi,{})}),i.jsx(_,{path:"/privacy",element:i.jsx(Li,{})}),i.jsx(_,{path:"/terms",element:i.jsx(Oi,{})}),i.jsx(_,{path:"/survey",element:i.jsx(Hi,{})}),i.jsx(_,{path:"*",element:i.jsx(y,{to:"/",replace:!0})})]})})},$i=()=>{const{isLoading:e,isContentReady:t}=K();return i.jsxs(i.Fragment,{children:[i.jsx($,{isVisible:e}),i.jsx(N,{}),t&&i.jsx("div",{className:"App",children:i.jsx(xe,{children:i.jsx(Wi,{})})})]})};function Ni(){const{i18n:a,t:n}=o(),[r,s]=t.useState(0);return e.useEffect(()=>{const e=()=>{s(e=>e+1)};return a.on("languageChanged",e),()=>{a.off("languageChanged",e)}},[a]),e.useEffect(()=>{document.documentElement.dir=a.dir(),document.documentElement.lang=a.language,"KAIF | Sauna & Spa"!==document.title&&!document.title.includes("KAIF")&&document.title.includes("|")||(document.title=n("page_titles.home","KAIF | Sauna & Spa"))},[a.language,n,r]),i.jsx(b,{children:i.jsxs(j,{theme:Y,children:[i.jsx(T,{}),i.jsx(B,{}),i.jsx(R,{children:i.jsx(f,{basename:"/",children:i.jsx($i,{})})})]})},`app-${a.language}-${r}`)}console.log=()=>{},console.warn=()=>{},console.info=()=>{},"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("/sw.js").then(e=>{e.addEventListener("updatefound",()=>{const i=e.installing;i.addEventListener("statechange",()=>{"installed"===i.state&&navigator.serviceWorker.controller})})}).catch(e=>{})}),w.createRoot(document.getElementById("root")).render(i.jsx(Ni,{}));export{_e as P,I as _};
