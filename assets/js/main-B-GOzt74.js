const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/js/AdvantagesSection-BaVBjjOf.js","assets/js/vendor-react-CLtL0QWO.js","assets/js/vendor-other-CZupzcPt.js","assets/js/vendor-styles-CCTfl_7F.js","assets/js/vendor-animations-CEvQOT_g.js","assets/js/GallerySection-B33VT9Ua.js","assets/js/FAQSection-CiV-DH2a.js","assets/js/RestaurantPage-DLGsbQ1I.js","assets/js/PageScrollReset-DNwck8vB.js","assets/js/vendor-i18n-C4kh69yx.js","assets/js/SpaPage-D8sPbsrO.js","assets/js/SportsPage-CEbnjINa.js","assets/js/BanyaPage-47F_Sd9g.js","assets/js/ContactsPage-GCLY3dCY.js","assets/js/CommonComponents-EiP6YwIs.js","assets/js/PrivacyPage-sNEg1-tl.js","assets/js/TermsPage-Cdd3YlLs.js"])))=>i.map(i=>d[i]);
import{r as e,j as i,R as t,u as a,i as n,a as o,b as r,F as s,c as l,d as c,L as p,H as d,e as m,f as u,g as h,h as g,B as f,k as b,l as _,N as y,m as x}from"./vendor-react-CLtL0QWO.js";import{f as v,m as w,d as k,o as A}from"./vendor-styles-CCTfl_7F.js";import{i as F,B as C}from"./vendor-i18n-C4kh69yx.js";import{m as j,A as S}from"./vendor-animations-CEvQOT_g.js";import"./vendor-other-CZupzcPt.js";!function(){const e=document.createElement("link").relList;if(!(e&&e.supports&&e.supports("modulepreload"))){for(const e of document.querySelectorAll('link[rel="modulepreload"]'))i(e);new MutationObserver(e=>{for(const t of e)if("childList"===t.type)for(const e of t.addedNodes)"LINK"===e.tagName&&"modulepreload"===e.rel&&i(e)}).observe(document,{childList:!0,subtree:!0})}function i(e){if(e.ep)return;e.ep=!0;const i=function(e){const i={};return e.integrity&&(i.integrity=e.integrity),e.referrerPolicy&&(i.referrerPolicy=e.referrerPolicy),"use-credentials"===e.crossOrigin?i.credentials="include":"anonymous"===e.crossOrigin?i.credentials="omit":i.credentials="same-origin",i}(e);fetch(e.href,i)}}();const P={},I=function(e,i,t){let a=Promise.resolve();if(i&&i.length>0){let e=function(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:"fulfilled",value:e}),e=>({status:"rejected",reason:e}))))};document.getElementsByTagName("link");const t=document.querySelector("meta[property=csp-nonce]"),n=(null==t?void 0:t.nonce)||(null==t?void 0:t.getAttribute("nonce"));a=e(i.map(e=>{if((e=function(e){return"/"+e}(e))in P)return;P[e]=!0;const i=e.endsWith(".css"),t=i?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${e}"]${t}`))return;const a=document.createElement("link");return a.rel=i?"stylesheet":"modulepreload",i||(a.as="script"),a.crossOrigin="",a.href=e,n&&a.setAttribute("nonce",n),document.head.appendChild(a),i?new Promise((i,t)=>{a.addEventListener("load",i),a.addEventListener("error",()=>t(new Error(`Unable to preload CSS for ${e}`)))}):void 0}))}function n(e){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=e,window.dispatchEvent(i),!i.defaultPrevented)throw e}return a.then(i=>{for(const e of i||[])"rejected"===e.status&&n(e.reason);return e().catch(n)})},B=v`
...
`,je={logo:{initial:{scale:.95,opacity:0},animate:{scale:1,opacity:1,transition:{duration:.8,ease:"easeOut",delay:.2}}},buttons:{initial:{opacity:0,y:15},animate:{opacity:1,y:0,transition:{duration:.5,ease:"easeOut",delay:.6}}}},Se=e.memo(()=>{const{t}=o(),[a,n]=e.useState(0);e.useEffect(()=>{const e=setInterval(()=>{requestAnimationFrame(()=>{n(e=>(e+1)%be.length)})},6e3);return()=>clearInterval(e)},[]);const r=e.useCallback(()=>{const e=document.getElementById("exclusive-zones");if(e){let i=function(e){null===s&&(s=e);const a=e-s,l=t(a,n,o,r);window.scrollTo(0,l),a<r&&requestAnimationFrame(i)},t=function(e,i,t,a){return(e/=a/2)<1?t/2*e*e+i:-t/2*(--e*(e-2)-1)+i};const a=e.offsetTop-80,n=window.pageYOffset,o=a-n,r=800;let s=null;requestAnimationFrame(i)}},[]);return i.jsxs(_e,{children:[i.jsx(ye,{children:be.map((e,t)=>i.jsx(xe,{$active:t===a,children:i.jsx("img",{src:e,alt:`KAIF - Слайд ${t+1}`,loading:0===t?"eager":"lazy",decoding:"async",onError:e=>{const i=["https://images.unsplash.com/photo-1544161515-4ab6ce6db874?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=75","https://images.unsplash.com/photo-1600334129128-685c5582fd35?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=75","https://images.unsplash.com/photo-1519823551278-64ac92734fb1?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=75","https://images.unsplash.com/photo-1515377905703-c4788e51af15?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=75"];e.target.src=i[t%i.length]}})},`slide-${t}`))}),i.jsx(ve,{children:i.jsxs(we,{children:[i.jsx(ke,{src:"/assets/images/logo-homepage-Yn4-hFZp.png",alt:"KAIF",initial:je.logo.initial,animate:je.logo.animate,whileHover:{scale:1.02,transition:{duration:.2,ease:"easeOut"}}}),i.jsxs(Ce,{as:j.div,initial:je.buttons.initial,animate:je.buttons.animate,children:[i.jsx(j.div,{whileHover:{scale:1.02,transition:{duration:.15,ease:"easeOut"}},whileTap:{scale:.98},children:i.jsx(Ae,{to:"/contacts",children:t("common.book")})}),i.jsx(j.div,{whileHover:{scale:1.01,transition:{duration:.15,ease:"easeOut"}},whileTap:{scale:.99},children:i.jsx(Fe,{onClick:r,children:t("common.learn_more")})})]})]})})]})});Se.displayName="HeroFullscreen";const Pe=k.section`
  position: relative;
  padding: 6rem 0;
  background-color: #ffffff;
  overflow: hidden;
