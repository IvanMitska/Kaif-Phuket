import{r as e,j as t,u as a,e as r,f as i,g as n,h as s,H as o,k as l,l as d,c as p,b as m,m as c,n as g,o as u,p as x,q as h}from"./vendor-react-core-CiytVzfL.js"
import{P as b}from"./main-tG30qmu8.js"
import{d as f}from"./vendor-styled-6ntj7xXP.js"
import{P as y}from"./PageScrollReset-CBLPOmkb.js"
import{m as w,A as k}from"./vendor-framer-DJEKn808.js"
...
return f.current&&e.observe(f.current),()=>e.disconnect()},[]),t.jsx(v,{ref:f,className:`${i||""} ${m||g?"":"loading"}`,style:n,children:(x||"eager"===s)&&t.jsx(j,{ref:b,src:g?d:a,alt:r,loaded:m,loading:s,onLoad:e=>{c(1),o&&o(e)},onError:e=>{u(1),l&&l(e)},...p})})},B=()=>{const{t:e}=a()
...
`,M=e.memo(({menuSectionRef:e})=>{const{t:r}=a()
...
return null==(t=e.current)?void 0:t.scrollIntoView({behavior:"smooth"})},whileHover:{scale:1.01},whileTap:{scale:.98},initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.5,delay:.9},children:[r("restaurant.hero.button","Наше меню"),t.jsx(s,{})]}),t.jsx(A,{onClick:()=>{const e=r("common.whatsapp_messages.book_table","Здравствуйте! Хочу забронировать столик в ресторане KAIF")
window.open(`https://wa.me/66624805877?text=${encodeURIComponent(e)}`,"_blank")},whileHover:{scale:1.01},whileTap:{scale:.98},initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.5,delay:1},children:r("common.book","Забронировать")})]})]})})]})]})})
