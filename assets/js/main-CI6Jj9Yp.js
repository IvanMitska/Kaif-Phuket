const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/js/AdvantagesSection-DXCIqUzX.js","assets/js/vendor-react-DH92txf0.js","assets/js/vendor-other-CZupzcPt.js","assets/js/vendor-styles-BdfYSv7I.js","assets/js/vendor-animations-CUcon76j.js","assets/js/GallerySection-CxFWl1Hb.js","assets/js/FAQSection-C4eVaYjy.js","assets/js/RestaurantPage-DHIsy4Ay.js","assets/js/PageScrollReset-Cnr3na49.js","assets/js/vendor-i18n-C4kh69yx.js","assets/js/SpaPage-CNYKEXsq.js","assets/js/SportsPage-BvdhjfX7.js","assets/js/BanyaPage-B3Qzjle5.js","assets/js/ContactsPage-D9zDJWu_.js","assets/js/CommonComponents-DBAtl2Fe.js","assets/js/PrivacyPage-DZLPpIFG.js","assets/js/TermsPage-l54KVwuU.js"])))=>i.map(i=>d[i]);
import{r as e,j as i,R as t,u as a,i as n,a as o,b as r,F as s,c as l,d as c,L as p,e as d,H as m,f as u,g as h,h as g,k as f,B as b,l as _,m as y,N as x,n as v}from"./vendor-react-DH92txf0.js";import{f as w,m as k,d as A,o as F}from"./vendor-styles-BdfYSv7I.js";import{i as C,B as j}from"./vendor-i18n-C4kh69yx.js";import{m as S,A as P}from"./vendor-animations-CUcon76j.js";import"./vendor-other-CZupzcPt.js";!function(){const e=document.createElement("link").relList;if(!(e&&e.supports&&e.supports("modulepreload"))){for(const e of document.querySelectorAll('link[rel="modulepreload"]'))i(e);new MutationObserver(e=>{for(const t of e)if("childList"===t.type)for(const e of t.addedNodes)"LINK"===e.tagName&&"modulepreload"===e.rel&&i(e)}).observe(document,{childList:!0,subtree:!0})}function i(e){if(e.ep)return;e.ep=!0;const i=function(e){const i={};return e.integrity&&(i.integrity=e.integrity),e.referrerPolicy&&(i.referrerPolicy=e.referrerPolicy),"use-credentials"===e.crossOrigin?i.credentials="include":"anonymous"===e.crossOrigin?i.credentials="omit":i.credentials="same-origin",i}(e);fetch(e.href,i)}}();const I={},B=function(e,i,t){let a=Promise.resolve();if(i&&i.length>0){let e=function(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:"fulfilled",value:e}),e=>({status:"rejected",reason:e}))))};document.getElementsByTagName("link");const t=document.querySelector("meta[property=csp-nonce]"),n=(null==t?void 0:t.nonce)||(null==t?void 0:t.getAttribute("nonce"));a=e(i.map(e=>{if((e=function(e){return"/"+e}(e))in I)return;I[e]=!0;const i=e.endsWith(".css"),t=i?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${e}"]${t}`))return;const a=document.createElement("link");return a.rel=i?"stylesheet":"modulepreload",i||(a.as="script"),a.crossOrigin="",a.href=e,n&&a.setAttribute("nonce",n),document.head.appendChild(a),i?new Promise((i,t)=>{a.addEventListener("load",i),a.addEventListener("error",()=>t(new Error(`Unable to preload CSS for ${e}`)))}):void 0}))}function n(e){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=e,window.dispatchEvent(i),!i.defaultPrevented)throw e}return a.then(i=>{for(const e of i||[])"rejected"===e.status&&n(e.reason);return e().catch(n)})},T=w`
