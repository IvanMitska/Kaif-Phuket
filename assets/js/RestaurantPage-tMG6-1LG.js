import{r as e,j as t}from"./react-core-DWAaPJsY.js";import{a}from"./react-helmet-BCF-s7y-.js";import{P as r}from"./PageHead-ByG18s83.js";import{d as i}from"./styled-components-fuCKgGld.js";import{P as n}from"./PageScrollReset-CpzNA0Jq.js";import{u as s}from"./i18n-core-DrMVsQFB.js";import{c as o,d as l,e as d,f as p,g as m,h as c,b as g,a as u,i as x,j as h,k as b,l as f,m as y}from"./heroicons-DSEs4UIN.js";import{B as w}from"./BookingModal-DgblHROr.js";import{m as k,A as v}from"./framer-motion-DOblPXrY.js";import"./vendor-misc-D8JVgYt7.js";const j=i.div`
  position: relative;
  overflow: hidden;
...
`,R=e.memo(({menuSectionRef:a})=>{const{t:r}=s(),[i,n]=e.useState(!1);return t.jsxs(A,{children:[t.jsx(S,{children:t.jsxs("picture",{children:[t.jsx("source",{srcSet:"/images-optimized/restaurant/booking.jpg",type:"image/jpeg"}),t.jsx("img",{src:"/images-optimized/restaurant/booking.jpg",alt:r("restaurant.hero.image_alt","Restaurant interior"),loading:"eager",style:{width:"100%",height:"100%",objectFit:"cover"}})]})}),t.jsxs(H,{children:[t.jsx(F,{className:"top-right",initial:{opacity:0,scale:.8},animate:{opacity:1,scale:1},transition:{duration:.6,delay:.4}}),t.jsx(F,{className:"bottom-left",initial:{opacity:0,scale:.8},animate:{opacity:1,scale:1},transition:{duration:.6,delay:.4}}),t.jsx(N,{children:t.jsxs(C,{children:[t.jsx(I,{initial:{opacity:0,y:30},animate:{opacity:1,y:0},transition:{duration:.6},children:r("restaurant.hero.label","Наш ресторан")}),t.jsx(W,{initial:{opacity:0,y:30},animate:{opacity:1,y:0},transition:{duration:.6,delay:.2},children:r("restaurant.hero.title","Изысканная кухня с современным подходом")}),t.jsx(T,{initial:{opacity:0,scaleX:0},animate:{opacity:1,scaleX:1},transition:{duration:.6,delay:.4}}),t.jsx(D,{initial:{opacity:0,y:30},animate:{opacity:1,y:0},transition:{duration:.6,delay:.6},children:r("restaurant.hero.subtitle","Наши шеф-повара создают уникальные блюда, сочетая традиционные рецепты с новыми кулинарными техниками.")}),t.jsxs(E,{initial:{opacity:0,y:30},animate:{opacity:1,y:0},transition:{duration:.6,delay:.8},children:[t.jsxs(B,{onClick:()=>{var e;return null==(e=a.current)?void 0:e.scrollIntoView({behavior:"smooth"})},whileHover:{scale:1.01},whileTap:{scale:.98},initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.5,delay:.9},children:[r("restaurant.hero.button","Наше меню"),t.jsx(p,{})]}),t.jsx(z,{onClick:()=>n(!0),whileHover:{scale:1.01},whileTap:{scale:.98},initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.5,delay:1},children:r("common.book","Забронировать")})]})]})})]}),t.jsx(w,{isOpen:i,onClose:()=>n(!1),service:r("restaurant.booking.service","Бронирование столика"),source:"Restaurant - Hero"})]})});R.displayName="HeroSection";const M=i(k.div)`
