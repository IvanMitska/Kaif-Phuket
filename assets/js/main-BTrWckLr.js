const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/js/AdvantagesSection-DvFwAJIZ.js","assets/js/vendor-react-Ce3vtg5u.js","assets/js/vendor-other-CZupzcPt.js","assets/js/vendor-styles-CmrnBrPu.js","assets/js/vendor-animations-C-51Dz0N.js","assets/js/GallerySection-B1VYW2j7.js","assets/js/FAQSection-D4V1rHRM.js","assets/js/RestaurantPage-Ck0ZBJaC.js","assets/js/PageScrollReset-Cu8pCFiy.js","assets/js/vendor-i18n-C4kh69yx.js","assets/js/SpaPage-BbdZihcm.js","assets/js/SportsPage-CdsCQxWS.js","assets/js/BanyaPage-BlSvVJ1O.js","assets/js/ContactsPage-D8Ao8Lo3.js","assets/js/CommonComponents-TGDZot_d.js","assets/js/PrivacyPage-y6l7Je8f.js","assets/js/TermsPage-DeqPuLWf.js","assets/js/SurveyPage-B50WWE4h.js"])))=>i.map(i=>d[i]);
import{r as e,j as i,R as t,u as a,i as n,a as o,b as r,F as s,c as l,d as c,L as p,H as d,e as m,f as u,g as h,h as g,B as b,k as f,l as _,N as y,m as x}from"./vendor-react-Ce3vtg5u.js";import{f as v,m as w,d as k,o as A}from"./vendor-styles-CmrnBrPu.js";import{i as F,B as C}from"./vendor-i18n-C4kh69yx.js";import{m as j,A as S}from"./vendor-animations-C-51Dz0N.js";import"./vendor-other-CZupzcPt.js";!function(){const e=document.createElement("link").relList;if(!(e&&e.supports&&e.supports("modulepreload"))){for(const e of document.querySelectorAll('link[rel="modulepreload"]'))i(e);new MutationObserver(e=>{for(const t of e)if("childList"===t.type)for(const e of t.addedNodes)"LINK"===e.tagName&&"modulepreload"===e.rel&&i(e)}).observe(document,{childList:!0,subtree:!0})}function i(e){if(e.ep)return;e.ep=!0;const i=function(e){const i={};return e.integrity&&(i.integrity=e.integrity),e.referrerPolicy&&(i.referrerPolicy=e.referrerPolicy),"use-credentials"===e.crossOrigin?i.credentials="include":"anonymous"===e.crossOrigin?i.credentials="omit":i.credentials="same-origin",i}(e);fetch(e.href,i)}}();const P={},I=function(e,i,t){let a=Promise.resolve();if(i&&i.length>0){let e=function(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:"fulfilled",value:e}),e=>({status:"rejected",reason:e}))))};document.getElementsByTagName("link");const t=document.querySelector("meta[property=csp-nonce]"),n=(null==t?void 0:t.nonce)||(null==t?void 0:t.getAttribute("nonce"));a=e(i.map(e=>{if((e=function(e){return"/"+e}(e))in P)return;P[e]=!0;const i=e.endsWith(".css"),t=i?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${e}"]${t}`))return;const a=document.createElement("link");return a.rel=i?"stylesheet":"modulepreload",i||(a.as="script"),a.crossOrigin="",a.href=e,n&&a.setAttribute("nonce",n),document.head.appendChild(a),i?new Promise((i,t)=>{a.addEventListener("load",i),a.addEventListener("error",()=>t(new Error(`Unable to preload CSS for ${e}`)))}):void 0}))}function n(e){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=e,window.dispatchEvent(i),!i.defaultPrevented)throw e}return a.then(i=>{for(const e of i||[])"rejected"===e.status&&n(e.reason);return e().catch(n)})},B=v`
