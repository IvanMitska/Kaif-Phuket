const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/js/AdvantagesSection-Y25Ni4G4.js","assets/js/vendor-react-C8d7Q6_M.js","assets/js/vendor-other-CZupzcPt.js","assets/js/vendor-styles-DGlzumVJ.js","assets/js/vendor-animations-DZaFu96O.js","assets/js/GallerySection-C8tRUNKJ.js","assets/js/FAQSection-CvQMkQAh.js","assets/js/RestaurantPage-BFe0lP_5.js","assets/js/PageScrollReset-BkpYX3BD.js","assets/js/vendor-i18n-C4kh69yx.js","assets/js/SpaPage-Be47HgDl.js","assets/js/SportsPage-8R0v4av7.js","assets/js/BanyaPage-BbXPgmcL.js","assets/js/ContactsPage-C2rLKK26.js","assets/js/CommonComponents-CcaxQwyA.js","assets/js/PrivacyPage-B1MwoNFY.js","assets/js/TermsPage-RhpYgG5C.js","assets/js/SurveyPage-B4VCqaA6.js"])))=>i.map(i=>d[i]);
import{r as e,j as i,R as t,u as a,i as n,a as o,b as r,F as s,c as l,d as c,L as p,e as d,f as m,H as u,g as h,h as g,k as b,l as f,B as _,m as y,n as x,N as v,o as w}from"./vendor-react-C8d7Q6_M.js";import{f as k,m as A,d as F,o as C}from"./vendor-styles-DGlzumVJ.js";import{i as j,B as S}from"./vendor-i18n-C4kh69yx.js";import{m as P,A as I}from"./vendor-animations-DZaFu96O.js";import"./vendor-other-CZupzcPt.js";!function(){const e=document.createElement("link").relList;if(!(e&&e.supports&&e.supports("modulepreload"))){for(const e of document.querySelectorAll('link[rel="modulepreload"]'))i(e);new MutationObserver(e=>{for(const t of e)if("childList"===t.type)for(const e of t.addedNodes)"LINK"===e.tagName&&"modulepreload"===e.rel&&i(e)}).observe(document,{childList:!0,subtree:!0})}function i(e){if(e.ep)return;e.ep=!0;const i=function(e){const i={};return e.integrity&&(i.integrity=e.integrity),e.referrerPolicy&&(i.referrerPolicy=e.referrerPolicy),"use-credentials"===e.crossOrigin?i.credentials="include":"anonymous"===e.crossOrigin?i.credentials="omit":i.credentials="same-origin",i}(e);fetch(e.href,i)}}();const B={},T=function(e,i,t){let a=Promise.resolve();if(i&&i.length>0){let e=function(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:"fulfilled",value:e}),e=>({status:"rejected",reason:e}))))};document.getElementsByTagName("link");const t=document.querySelector("meta[property=csp-nonce]"),n=(null==t?void 0:t.nonce)||(null==t?void 0:t.getAttribute("nonce"));a=e(i.map(e=>{if((e=function(e){return"/"+e}(e))in B)return;B[e]=!0;const i=e.endsWith(".css"),t=i?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${e}"]${t}`))return;const a=document.createElement("link");return a.rel=i?"stylesheet":"modulepreload",i||(a.as="script"),a.crossOrigin="",a.href=e,n&&a.setAttribute("nonce",n),document.head.appendChild(a),i?new Promise((i,t)=>{a.addEventListener("load",i),a.addEventListener("error",()=>t(new Error(`Unable to preload CSS for ${e}`)))}):void 0}))}function n(e){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=e,window.dispatchEvent(i),!i.defaultPrevented)throw e}return a.then(i=>{for(const e of i||[])"rejected"===e.status&&n(e.reason);return e().catch(n)})},z=k`
...
`,E=e.createContext();let K=!1;const R=()=>e.useContext(E),q=({children:t})=>{const[a,n]=e.useState(!1),[o,r]=e.useState(!0),s=e.useRef(!1),l=e.useRef(!1);return i.jsx(E.Provider,{value:{isLoading:a,isContentReady:o,showLoading:(e=1e3)=>s.current||l.current||K?Promise.resolve():(K=!0,s.current=!0,l.current=!0,r(!1),n(!0),new Promise(i=>{setTimeout(()=>{n(!1),setTimeout(()=>{r(!0),s.current=!1,i()},200)},e)})),showContentDirectly:()=>{l.current=!0,n(!1),r(!0),s.current=!1},resetLoading:()=>{l.current=!1,s.current=!1,n(!1),r(!0)}},children:t})},L=A`
  from { opacity: 0; }
  to { opacity: 1; }
`,O=A`
  from { opacity: 1; }
...
`,W=F.div`
  ...
  &.exiting {
    animation: ${O} 0.3s ease-in forwards;
  }
...
`,N=F.img`
  ...
  /* Упрощенная анимация */
  animation: ${D} 0.6s ease-out 0.1s both;
...
`,ye=F.div`
  position: fixed;
  bottom: ${({$isVisible:e})=>e?"30px":"-200px"};
  right: 30px;
  z-index: 99;
  width: 340px;
  ...
  @media (max-width: 768px) {
    ...
    max-width: 340px;
    right: 20px;
    bottom: ${({$isVisible:e})=>e?"20px":"-200px"};
  }
`,xe=F.div`
  background: linear-gradient(135deg, #FF6600 0%, #CC3300 100%);
  border-radius: 16px;
...
`,je=()=>{const[t,a]=e.useState(!1),[n,r]=e.useState(!0),{t:s}=o();return e.useEffect(()=>{const e=new Date("2025-08-01"),i=new Date;if(i>=e)return void r(!1);const t=localStorage.getItem("kaifPromoClosed");t&&(i-new Date(t))/36e5<24&&r(!1)},[]),i.jsxs(i.Fragment,{children:[n&&!t&&i.jsx(_e,{onClick:()=>{a(!0)},"aria-label":"Show promotion",title:"Special offer!",children:i.jsx(d,{})}),i.jsx(ye,{$isVisible:t,children:i.jsxs(xe,{children:[i.jsxs(ve,{children:[i.jsx(we,{onDoubleClick:()=>{localStorage.removeItem("kaifPromoClosed"),r(!0),a(!1)},children:i.jsx(d,{})}),i.jsx(Ae,{children:s("promo.title")}),i.jsx(Ce,{onClick:()=>{a(!1),r(!1),localStorage.setItem("kaifPromoClosed",(new Date).toISOString())},"aria-label":"Close",children:i.jsx(m,{})})]}),i.jsx(ke,{children:i.jsx(Fe,{children:s("promo.subtitle")})})]})})]})},Se=F.div`
  min-height: 100vh;
  width: 100%;
  position: relative;
  z-index: 1;
...
`,Pe=F.main`
  ...
  padding: 65px 0 0 0;
  background: transparent;
`,Ie=({children:t})=>{const n=a(),[o,r]=e.useState(!0),s=e.useRef(!0),{isLoading:l}=R();return e.useEffect(()=>{if(s.current)return s.current=!1,void r(!0);r(!1),window.scrollTo(0,0);const e=setTimeout(()=>{r(!0)},500);return()=>clearTimeout(e)},[n.pathname]),i.jsxs(i.Fragment,{children:[i.jsx(M,{}),i.jsx($,{isVisible:!o&&!l}),i.jsx(Q,{}),i.jsx(je,{}),i.jsxs(Se,{children:[i.jsx(Pe,{children:t}),o&&i.jsx(be,{})]})]})},Be=({titleKey:t="page_titles.home",defaultTitle:a="KAIF | Jungle Club & Spa",description:n,keywords:r,ogImage:s,pageType:l="website"})=>{const{t:c,i18n:p}=o(),d=c(t,a);return e.useEffect(()=>{document.title=d},[d,p.language]),i.jsxs(u,{children:[i.jsx("title",{children:d}),n&&i.jsx("meta",{name:"description",content:n}),r&&i.jsx("meta",{name:"keywords",content:r}),i.jsx("meta",{property:"og:title",content:d}),n&&i.jsx("meta",{property:"og:description",content:n}),i.jsx("meta",{property:"og:type",content:l}),s&&i.jsx("meta",{property:"og:image",content:s}),i.jsx("meta",{name:"twitter:title",content:d}),n&&i.jsx("meta",{name:"twitter:description",content:n}),i.jsx("meta",{name:"twitter:card",content:"summary_large_image"}),s&&i.jsx("meta",{name:"twitter:image",content:s}),i.jsx("link",{rel:"shortcut icon",type:"image/png",href:"/favicon.png"}),i.jsx("link",{rel:"icon",type:"image/png",href:"/favicon.png"}),i.jsx("meta",{name:"theme-color",content:"#2C614F"})]})},Te="/assets/images/hero-restaurant-B-WOCk0r.jpg",ze=["/assets/images/hero-spa-DTdp7JL8.jpg","/assets/images/hero-pool-D1w69rNO.jpg",Te,"/assets/images/hero-fitness-C8kFY2Cm.jpg"],Me=F.section`
  position: relative;
  width: 100%;
  min-height: 100vh;
  height: auto;
...
`,He={logo:{initial:{scale:.95,opacity:0},animate:{scale:1,opacity:1,transition:{duration:.8,ease:"easeOut",delay:.2}}},buttons:{initial:{opacity:0,y:15},animate:{opacity:1,y:0,transition:{duration:.5,ease:"easeOut",delay:.6}}}},Ne=e.memo(()=>{const{t}=o(),[a,n]=e.useState(0);return e.useEffect(()=>{const e=setInterval(()=>{requestAnimationFrame(()=>{n(e=>(e+1)%ze.length)})},6e3);return()=>clearInterval(e)},[]),i.jsxs(Me,{children:[i.jsx(Ee,{children:ze.map((e,t)=>i.jsx(Ke,{$active:t===a,children:i.jsx("img",{src:e,alt:`KAIF - Слайд ${t+1}`,loading:0===t?"eager":"lazy",decoding:"async",onError:e=>{const i=["https://images.unsplash.com/photo-1544161515-4ab6ce6db874?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=75","https://images.unsplash.com/photo-1600334129128-685c5582fd35?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=75","https://images.unsplash.com/photo-1519823551278-64ac92734fb1?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=75","https://images.unsplash.com/photo-1515377905703-c4788e51af15?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=75"];e.target.src=i[t%i.length]}})},`slide-${t}`))}),i.jsx(Re,{children:i.jsxs(qe,{children:[i.jsx(Le,{src:"/assets/images/logo-homepage-Yn4-hFZp.png",alt:"KAIF",initial:He.logo.initial,animate:He.logo.animate,whileHover:{scale:1.02,transition:{duration:.2,ease:"easeOut"}}}),i.jsxs(We,{as:P.div,initial:He.buttons.initial,animate:He.buttons.animate,children:[i.jsx(P.div,{whileHover:{scale:1.02,transition:{duration:.15,ease:"easeOut"}},whileTap:{scale:.98},children:i.jsx(Oe,{href:"https://wa.me/66624805877?text=Здравствуйте! Хочу записаться в KAIF",target:"_blank",rel:"noopener noreferrer",children:t("common.book")})}),i.jsx(P.div,{onClick:()=>{const e=document.querySelector("#exclusive-zones");e&&e.scrollIntoView({behavior:"smooth",block:"start"})},whileHover:{scale:1.01,transition:{duration:.15,ease:"easeOut"}},whileTap:{scale:.99},children:i.jsx(De,{children:t("common.learn_more")})})]})]})})]})});Ne.displayName="HeroFullscreen";const $e=F.section`
  position: relative;
  padding: 6rem 0;
  background-color: #ffffff;
  overflow: hidden;
...
`,li=()=>{const{t}=o(),[a,n]=e.useState("all"),r=e.useMemo(()=>[{id:"fitness",name:t("zones.activity.fitness.name"),description:t("zones.activity.fitness.description"),image:"/images/zones/fitness.jpg",path:"/sports"},{id:"combat",name:t("zones.activity.combat.name"),description:t("zones.activity.combat.description"),image:"/images/zones/combat.jpg",path:"/sports"},{id:"pool",name:t("zones.activity.pool.name"),description:t("zones.activity.pool.description"),image:"/images/zones/pool.jpg",path:"/sports"}],[t]),s=e.useMemo(()=>[{id:"spa",name:t("zones.relax.spa.name"),description:t("zones.relax.spa.description"),image:"/images/zones/spa.jpg",path:"/spa"},{id:"banya",name:t("zones.relax.banya.name"),description:t("zones.relax.banya.description"),image:"/assets/images/hero-luxury-CYZ2FLIl.png",path:"/banya"},{id:"restaurant",name:t("zones.relax.restaurant.name"),description:t("zones.relax.restaurant.description"),image:"/images/zones/restaurant.jpg",path:"/restaurant"}],[t]),l=(e,a)=>e.map((e,n)=>i.jsxs(ei,{initial:{opacity:0,y:30},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.1,margin:"-50px"},transition:{duration:.6,delay:.05*n},children:[i.jsx(ii,{src:e.image,alt:e.name}),i.jsxs(ti,{children:[i.jsx(ai,{children:e.name}),i.jsx(ni,{children:e.description}),i.jsxs(oi,{to:e.path,children:[t("common.exploreMore","Подробнее"),i.jsx(b,{})]})]})]},`${a}-${e.id}`)),c=e=>{e!==a&&n(e)};return i.jsx($e,{id:"exclusive-zones",children:i.jsxs(Ve,{children:[i.jsxs(Je,{children:[i.jsx(Ge,{initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.2},transition:{duration:.8},children:t("zones.overline","Пространства KAIF")}),i.jsx(Ue,{initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.2},transition:{duration:.8,delay:.2},children:t("zones.title","Всё необходимое для активного отдыха и релаксации")})]}),i.jsxs(ri,{children:[i.jsx(si,{$active:"all"===a,onClick:()=>c("all"),children:t("zones.all","Все зоны")}),i.jsxs(si,{$active:"activity"===a,onClick:()=>c("activity"),children:[i.jsx(h,{}),t("zones.activity_label","Активити")]}),i.jsxs(si,{$active:"relax"===a,onClick:()=>c("relax"),children:[i.jsx(g,{}),t("zones.relax_label","Релакс")]})]}),i.jsxs(Ye,{children:[("all"===a||"activity"===a)&&i.jsxs("div",{children:[i.jsx(Qe,{children:i.jsxs(Xe,{children:[i.jsx(h,{}),t("zones.activity_label","Активити")]})}),i.jsx(Ze,{children:l(r,"activity")})]}),("all"===a||"relax"===a)&&i.jsxs("div",{children:[i.jsx(Qe,{children:i.jsxs(Xe,{children:[i.jsx(g,{}),t("zones.relax_label","Релакс")]})}),i.jsx(Ze,{children:l(s,"relax")})]})]})]})})},ci=e.lazy(()=>T(()=>import("./AdvantagesSection-Y25Ni4G4.js"),__vite__mapDeps([0,1,2,3,4])).then(i=>({default:e.memo(i.default)}))),pi=e.lazy(()=>T(()=>import("./GallerySection-C8tRUNKJ.js"),__vite__mapDeps([5,1,2,3,4])).then(i=>({default:e.memo(i.GallerySection)}))),di=e.lazy(()=>T(()=>import("./FAQSection-CvQMkQAh.js"),__vite__mapDeps([6,1,2,3,4])).then(i=>({default:e.memo(i.default)}))),mi=F.div`
  height: 120px;
  display: flex;
  align-items: center;
  justify-content: center;
...
`,gi=e.memo(()=>{const{t}=o(),{showLoading:a}=R(),n=e.useRef(!1);return e.useEffect(()=>{n.current||(n.current=!0,a(1e3))},[]),i.jsxs("main",{children:[i.jsx(Be,{titleKey:"page_titles.home",description:t("home.hero.subtitle","Unique relaxation and wellness experience in Phuket"),keywords:"KAIF, spa, wellness, Phuket, gym, restaurant, banya, massage",ogImage:"/images/logos/logo-og.png"}),i.jsx(Ne,{}),i.jsx(li,{}),i.jsx(e.Suspense,{fallback:i.jsx(mi,{}),children:i.jsx(ci,{})}),i.jsx(e.Suspense,{fallback:i.jsx(mi,{}),children:i.jsx(pi,{})}),i.jsx(e.Suspense,{fallback:i.jsx(mi,{}),children:i.jsx(di,{})}),i.jsx(ui,{children:i.jsxs(hi,{to:"/contacts",children:[t("common.contact_us"),i.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",children:i.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M17 8l4 4m0 0l-4 4m4-4H3"})})]})})]})});gi.displayName="HomePage";const bi=t.lazy(()=>T(()=>import("./RestaurantPage-BFe0lP_5.js"),__vite__mapDeps([7,1,2,3,8,4,9]))),fi=t.lazy(()=>T(()=>import("./SpaPage-Be47HgDl.js"),__vite__mapDeps([10,1,2,3,8,4,9]))),_i=t.lazy(()=>T(()=>import("./SportsPage-8R0v4av7.js").then(e=>e.d),__vite__mapDeps([11,1,2,3,4,8]))),yi=t.lazy(()=>T(()=>import("./BanyaPage-BbXPgmcL.js"),__vite__mapDeps([12,1,2,3,8,4,9]))),xi=t.lazy(()=>T(()=>import("./ContactsPage-C2rLKK26.js"),__vite__mapDeps([13,1,2,3,4,14,8,9]))),vi=t.lazy(()=>T(()=>import("./PrivacyPage-B1MwoNFY.js"),__vite__mapDeps([15,1,2,3,14,4]))),wi=t.lazy(()=>T(()=>import("./TermsPage-RhpYgG5C.js"),__vite__mapDeps([16,1,2,3,14,4]))),ki=t.lazy(()=>T(()=>import("./SurveyPage-B4VCqaA6.js"),__vite__mapDeps([17,1,2,3,8,4,9]))),Ai=()=>null,Fi=()=>{const t=a();return i.jsx(e.Suspense,{fallback:i.jsx(Ai,{}),children:i.jsxs(y,{location:t,children:[i.jsx(x,{path:"/",element:i.jsx(gi,{})}),i.jsx(x,{path:"/restaurant",element:i.jsx(bi,{})}),i.jsx(x,{path:"/spa",element:i.jsx(fi,{})}),i.jsx(x,{path:"/sports",element:i.jsx(_i,{})}),i.jsx(x,{path:"/banya",element:i.jsx(yi,{})}),i.jsx(x,{path:"/contacts",element:i.jsx(xi,{})}),i.jsx(x,{path:"/privacy",element:i.jsx(vi,{})}),i.jsx(x,{path:"/terms",element:i.jsx(wi,{})}),i.jsx(x,{path:"/survey",element:i.jsx(ki,{})}),i.jsx(x,{path:"*",element:i.jsx(v,{to:"/",replace:!0})})]})})},Ci=()=>{const{isLoading:e,isContentReady:t}=R();return i.jsxs(i.Fragment,{children:[i.jsx($,{isVisible:e}),i.jsx(V,{}),t&&i.jsx("div",{className:"App",children:i.jsx(Ie,{children:i.jsx(Fi,{})})})]})};function ji(){const{i18n:a,t:n}=o(),[r,s]=t.useState(0);return e.useEffect(()=>{const e=()=>{s(e=>e+1)};return a.on("languageChanged",e),()=>{a.off("languageChanged",e)}},[a]),e.useEffect(()=>{document.documentElement.dir=a.dir(),document.documentElement.lang=a.language,"KAIF | Jungle Club & Spa"!==document.title&&!document.title.includes("KAIF")&&document.title.includes("|")||(document.title=n("page_titles.home","KAIF | Jungle Club & Spa"))},[a.language,n,r]),i.jsx(f,{children:i.jsxs(C,{theme:Y,children:[i.jsx(z,{}),i.jsx(M,{}),i.jsx(q,{children:i.jsx(_,{basename:"/",children:i.jsx(Ci,{})})})]})},`app-${a.language}-${r}`)}console.log=()=>{},console.warn=()=>{},console.info=()=>{},"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("/sw.js").then(e=>{e.addEventListener("updatefound",()=>{const i=e.installing;i.addEventListener("statechange",()=>{"installed"===i.state&&navigator.serviceWorker.controller})})}).catch(e=>{})}),w.createRoot(document.getElementById("root")).render(i.jsx(ji,{}));export{Be as P,T as _,Te as h};
