...
`,M=()=>{const{t:o}=t(),[M,$]=e.useState("all"),[T,D]=e.useState(0),[Y,L]=e.useState(0),{isOpen:P,content:Z,open:H,close:V}=(()=>{const[t,i]=e.useState(!1),[a,r]=e.useState(null),n=e.useCallback(e=>{r(e),i(!0),document.body.style.overflow="hidden"},[]),o=e.useCallback(()=>{i(!1),r(null),document.body.style.overflow="auto"},[]);return e.useEffect(()=>{if(!t)return;const e=e=>{"Escape"===e.key&&o()};return document.addEventListener("keydown",e),()=>document.removeEventListener("keydown",e)},[t,o]),{isOpen:t,content:a,open:n,close:o}})(),[N,R]=((t,i)=>{const[a,r]=e.useState(()=>{try{const e=window.localStorage.getItem(t);return e?JSON.parse(e):i}catch(e){return i}}),n=e.useCallback(e=>{try{const i=e instanceof Function?e(a):e;r(i),window.localStorage.setItem(t,JSON.stringify(i))}catch(i){}},[t,a]),o=e.useCallback(()=>{try{window.localStorage.removeItem(t),r(i)}catch(e){}},[t,i]);return[a,n,o]})("gallery-liked-images",[]),{getOptimizedAnimation:W,isReducedMotion:X}=(()=>{const[t,i]=e.useState(!1),[a,r]=e.useState(!1);e.useEffect(()=>{const e=window.matchMedia("(prefers-reduced-motion: reduce)");i(e.matches);const t=e=>i(e.matches);return e.addEventListener("change",t),"hardwareConcurrency"in navigator&&r(navigator.hardwareConcurrency<=2),()=>e.removeEventListener("change",t)},[]);const n=e.useCallback(e=>t?{duration:0}:a?{...e,duration:.7*(e.duration||.5)}:e,[t,a]);return{isReducedMotion:t,isSlowDevice:a,getOptimizedAnimation:n}})(),[q,F]=((t={})=>{const[i,a]=e.useState(null),[r,n]=e.useState(!1),[o,s]=e.useState(!1);return e.useEffect(()=>{if(!i)return;const e=new IntersectionObserver(([e])=>{n(e.isIntersecting),e.isIntersecting&&!o&&s(!0)},{threshold:.1,rootMargin:"20px",...t});return e.observe(i),()=>{i&&e.unobserve(i)}},[i,o,t]),[a,r,o]})({threshold:.1}),J=e.useMemo(()=>[{id:1,image:"/images/spa/services/thai-massage.jpg",title:o("gallery.slides.thai_massage.title","Thai Massage"),category:"spa",description:o("gallery.slides.thai_massage.description","Traditional Thai massage performed by experienced masters. Energy restoration and body harmony.")},{id:2,image:"/images/spa/services/aromatherapy.jpg",title:o("gallery.slides.aromatherapy.title","Aromatherapy"),category:"spa",description:o("gallery.slides.aromatherapy.description","Relaxing treatments with premium natural essential oils.")},{id:3,image:"/images/sports/gym/gym-1.jpg",title:o("gallery.slides.gym.title","Gym"),category:"fitness",description:o("gallery.slides.gym.description","Over 70 modern premium equipment. Professional equipment for all types of workouts.")},{id:4,image:"/images/beauty/services/facial.jpg",title:o("gallery.slides.facial.title","Cosmetology"),category:"relax",description:o("gallery.slides.facial.description","Professional facial treatments using premium cosmetics.")}],[o]),_=e.useMemo(()=>[{id:"all",label:o("gallery.filters.all")},{id:"spa",label:o("gallery.filters.spa")},{id:"fitness",label:o("gallery.filters.fitness")}],[o]),G=e.useMemo(()=>"all"===M?J:J.filter(e=>e.category===M),[M,J]);e.useEffect(()=>{L(0)},[M]);const U=e.useCallback(e=>{$(e)},[]),K=e.useCallback(()=>{L(e=>(e+1)%G.length)},[G.length]),Q=e.useCallback(()=>{L(e=>(e-1+G.length)%G.length)},[G.length]),[ee,te]=e.useState(!0);e.useEffect(()=>{if(G.length<=1||!ee||!F)return;const e=setInterval(()=>{L(e=>(e+1)%G.length)},4e3);return()=>clearInterval(e)},[G.length,ee,F]);const ie=e.useCallback(()=>{te(!1)},[]),ae=e.useCallback(()=>{te(!0)},[]),re=d(K,Q);e.useCallback(e=>{R(t=>{const i=[...t],a=i.indexOf(e);return a>-1?i.splice(a,1):i.push(e),i})},[R]);const ne=e.useCallback((e,t)=>{D(t),H(e)},[H]),oe=e.useCallback(e=>{const t="next"===e?(T+1)%G.length:(T-1+G.length)%G.length;D(t),H(G[t])},[T,G,H]),se=d(()=>oe("next"),()=>oe("prev"));return e.useEffect(()=>{if(!P)return;const e=e=>{switch(e.key){case"Escape":V();break;case"ArrowLeft":oe("prev");break;case"ArrowRight":oe("next")}};return document.addEventListener("keydown",e),()=>document.removeEventListener("keydown",e)},[P,V,oe]),i.jsxs(c,{id:"gallery",ref:q,children:[i.jsxs(m,{children:[i.jsxs(p,{children:[i.jsx(h,{initial:{opacity:0,y:30},whileInView:{opacity:1,y:0},transition:W({duration:.8,ease:"easeOut"}),viewport:{once:!0},children:o("gallery.overline")}),i.jsx(g,{initial:{opacity:0,y:40},whileInView:{opacity:1,y:0},transition:W({duration:.8,delay:.2,ease:"easeOut"}),viewport:{once:!0},children:o("gallery.title")}),i.jsxs(x,{initial:{opacity:0,y:30},whileInView:{opacity:1,y:0},transition:W({duration:.8,delay:.4,ease:"easeOut"}),viewport:{once:!0},children:[o("gallery.subtitle"),"Познакомьтесь с нашими услугами и возможностями комплекса."]})]}),i.jsx(u,{initial:{opacity:0,y:30},whileInView:{opacity:1,y:0},transition:W({duration:.8,delay:.6,ease:"easeOut"}),viewport:{once:!0},children:_.map((e,t)=>i.jsx(f,{active:M===e.id,onClick:()=>U(e.id),initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},transition:W({duration:.5,delay:.7+.1*t}),viewport:{once:!0},whileHover:X?{}:{scale:1.05},whileTap:X?{}:{scale:.95},children:e.label},e.id))}),F&&G.length>0&&i.jsx(s,{mode:"wait",children:i.jsxs(b,{initial:{opacity:0,scale:.95},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.95},transition:W({duration:.4,ease:"easeInOut"}),onMouseEnter:ie,onMouseLeave:ae,...re,style:{...re.style,overscrollBehavior:"auto",WebkitOverscrollBehavior:"auto"},children:[i.jsx(w,{animate:{x:`-${100*Y}%`},transition:{type:"tween",ease:"easeOut",duration:.4},children:G.map((e,t)=>i.jsxs(y,{children:[i.jsx(v,{src:e.image,alt:e.title,onClick:()=>ne(e,t),loading:"lazy",$customPosition:"Тайский массаж"===e.title?"center bottom":"center"}),i.jsx(k,{children:i.jsx(j,{children:e.title})})]},`${M}-${e.id}`))}),G.length>1&&i.jsxs(i.Fragment,{children:[i.jsx(C,{className:"prev",onClick:Q,whileHover:{scale:1.05},whileTap:{scale:.95},disabled:G.length<=1,children:i.jsx(a,{})}),i.jsx(C,{className:"next",onClick:K,whileHover:{scale:1.05},whileTap:{scale:.95},disabled:G.length<=1,children:i.jsx(r,{})})]})]},M)})]}),i.jsx(s,{children:P&&Z&&i.jsx(z,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:W({duration:.3}),onClick:V,...se,style:{...se.style,overscrollBehavior:"contain"},children:i.jsxs(S,{onClick:e=>e.stopPropagation(),initial:{scale:.8,opacity:0,y:50},animate:{scale:1,opacity:1,y:0},exit:{scale:.8,opacity:0,y:30},transition:W({duration:.4,ease:[.25,.1,.25,1]}),children:[i.jsx(A,{src:Z.image,alt:Z.title,initial:{opacity:0},animate:{opacity:1},transition:W({duration:.5,delay:.2})}),i.jsxs(E,{children:[i.jsx(l.h3,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:W({duration:.5,delay:.3}),children:Z.title}),i.jsx(l.p,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:W({duration:.5,delay:.4}),children:Z.description}),i.jsxs(I,{children:[i.jsxs(B,{onClick:()=>oe("prev"),disabled:0===T,whileHover:X?{}:{scale:1.05},whileTap:X?{}:{scale:.95},children:[i.jsx(a,{}),"Предыдущее"]}),i.jsxs("span",{style:{color:"#5A6B5D",fontSize:"0.875rem",fontWeight:"500"},children:[T+1," из ",G.length]}),i.jsxs(B,{onClick:()=>oe("next"),disabled:T===G.length-1,whileHover:X?{}:{scale:1.05},whileTap:X?{}:{scale:.95},children:["Следующее",i.jsx(r,{})]})]})]}),i.jsx(O,{onClick:V,whileHover:X?{}:{scale:1.1,rotate:90},whileTap:X?{}:{scale:.9},children:i.jsx(n,{})})]})})})]})};export{M as GallerySection,M as default};
