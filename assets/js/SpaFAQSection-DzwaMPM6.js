import{u as e,r as i,j as n,ag as r,c as a,y as s,a8 as t,a7 as o,x as d,a9 as l,aa as m}from"./vendor-react-core-CiytVzfL.js"
import{d as p}from"./vendor-styled-6ntj7xXP.js"
import{m as h,A as c}from"./vendor-framer-DJEKn808.js"
...
return(null==(i=null==e?void 0:e.fonts)?void 0:i.primary)||"Inter, sans-serif"}};
  ...
  color: #64748b;
  margin: 0;
`,S=()=>{const{t:p}=e(),[S,z]=i.useState(null),I={hidden:{opacity:.4,y:15},visible:{opacity:1,y:0,transition:{duration:.3,ease:"easeOut"}}},C={hidden:{height:0,opacity:0,transition:{height:{duration:.3},opacity:{duration:.2}}},visible:{height:"auto",opacity:1,transition:{height:{duration:.4,ease:[.25,.46,.45,.94]},opacity:{duration:.3,delay:.1}}}},U=[{category:"services",icon:n.jsx(r,{}),question:p("spa.faq.questions.services.question","Какие SPA услуги вы предлагаете?"),answer:p("spa.faq.questions.services.answer","Мы предлагаем полный спектр SPA услуг: массаж (тайский, масляный, спортивный), косметологические процедуры, лазерную эпиляцию, маникюр, педикюр, уход за волосами, а также сауну и хаммам.")},{category:"booking",icon:n.jsx(a,{}),question:p("spa.faq.questions.booking.question","Как записаться на SPA процедуру?"),answer:p("spa.faq.questions.booking.answer","Записаться можно по телефону +66 62 480 5877, через WhatsApp или лично в нашем центре. Рекомендуем бронировать заранее, особенно на популярные процедуры.")},{category:"policy",icon:n.jsx(s,{}),question:p("spa.faq.questions.policy.question","Каковы правила отмены записи?"),answer:p("spa.faq.questions.policy.answer","Просим уведомлять об отмене не менее чем за 24 часа до назначенного времени. При отмене менее чем за 24 часа может взиматься плата за отмену в размере 50% от стоимости процедуры.")},{category:"payment",icon:n.jsx(t,{}),question:p("spa.faq.questions.payment.question","Какие способы оплаты принимаются?"),answer:p("spa.faq.questions.payment.answer","Мы принимаем наличные (THB, USD, EUR), банковские карты всех систем, а также мобильные платежи. Оплата производится после процедуры.")},{category:"preparation",icon:n.jsx(o,{}),question:p("spa.faq.questions.preparation.question","Нужно ли что-то приносить с собой?"),answer:p("spa.faq.questions.preparation.answer","Мы предоставляем все необходимое: полотенца, халаты, тапочки и косметические средства. Вам нужно только прийти и расслабиться.")},{category:"gifts",icon:n.jsx(r,{}),question:p("spa.faq.questions.gifts.question","Есть ли подарочные сертификаты?"),answer:p("spa.faq.questions.gifts.answer","Да! Мы предлагаем подарочные сертификаты различного номинала на любые SPA услуги. Их можно приобрести в нашем центре или заказать по телефону.")}]
return n.jsx(g,{children:n.jsxs(f,{children:[n.jsxs(u,{children:[n.jsxs(x,{children:[n.jsx(d,{}),p("spa.faq.badge","SPA Вопросы")]}),n.jsx(v,{children:p("spa.faq.title","Часто задаваемые вопросы")}),n.jsx(b,{children:p("spa.faq.subtitle","Всё, что нужно знать о наших SPA услугах и процедурах")})]}),n.jsx(w,{children:U.map((e,i)=>n.jsx(h.div,{variants:I,custom:i,whileInView:"visible",viewport:{once:1,amount:.1},children:n.jsxs(q,{$isOpen:S===i,children:[n.jsxs(y,{onClick:()=>(e=>{z(S===e?null:e)})(i),children:[n.jsxs(j,{children:[n.jsx($,{children:e.icon}),n.jsx(A,{children:e.question})]}),n.jsx(k,{$isOpen:S===i,animate:{rotate:S===i?180:0},transition:{duration:.3,ease:"easeInOut"},children:S===i?n.jsx(l,{}):n.jsx(m,{})})]}),n.jsx(c,{children:S===i&&n.jsx(B,{variants:C,initial:"hidden",animate:"visible",exit:"hidden",children:n.jsx(O,{children:n.jsx(P,{children:e.answer})})})})]})},i))})]})})}
export{S as default}
