const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/js/AdvantagesSection-DsLqxwjm.js","assets/js/vendor-react-FHR7Sy-E.js","assets/js/vendor-other-CZupzcPt.js","assets/js/vendor-styles-DcQt-q6S.js","assets/js/vendor-animations-BsFJxBmq.js","assets/js/GallerySection-CWGp-iFI.js","assets/js/FAQSection-DyH79itT.js","assets/js/RestaurantPage-DwVVxpBi.js","assets/js/PageScrollReset-Jvg3lmV2.js","assets/js/vendor-i18n-C4kh69yx.js","assets/js/SpaPage-BZV2-Gte.js","assets/js/SportsPage-4t7tnsUw.js","assets/js/BanyaPage-BzQxyktS.js","assets/js/ContactsPage-pIPxaZfC.js","assets/js/CommonComponents-Cwz04vFv.js","assets/js/PrivacyPage-DIdQpaGD.js","assets/js/TermsPage-DErEyXAv.js","assets/js/SurveyPage-B_EWyE03.js"])))=>i.map(i=>d[i]);
...
`,D=e.createContext();let L=!1;const $=()=>e.useContext(D),O=({children:t})=>{const[a,n]=e.useState(!1),[r,o]=e.useState(!0),s=e.useRef(!1),l=e.useRef(!1);return i.jsx(D.Provider,{value:{isLoading:a,isContentReady:r,showLoading:(e=1e3)=>s.current||l.current||L?Promise.resolve():(L=!0,s.current=!0,l.current=!0,o(!1),n(!0),new Promise(i=>{setTimeout(()=>{n(!1),setTimeout(()=>{o(!0),s.current=!1,i()},200)},e)})),showContentDirectly:()=>{l.current=!0,n(!1),o(!0),s.current=!1},resetLoading:()=>{l.current=!1,s.current=!1,n(!1),o(!0)}},children:t})},H=S`
  from { opacity: 0; }
  to { opacity: 1; }
`,W=S`
  from { opacity: 1; }
