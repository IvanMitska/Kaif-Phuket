const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/js/AdvantagesSection-CTAwxijg.js","assets/js/vendor-react-Udk5_aBK.js","assets/js/vendor-other-CZupzcPt.js","assets/js/vendor-styles-DIjDOctl.js","assets/js/vendor-animations-B-vr_HsI.js","assets/js/GallerySection-CxFnw5_l.js","assets/js/FAQSection-CMsVDokL.js","assets/js/RestaurantPage-DW-3yvCN.js","assets/js/PageScrollReset-DmMAXs50.js","assets/js/vendor-i18n-C4kh69yx.js","assets/js/SpaPage-BcY3GccZ.js","assets/js/SportsPage-CQIsahsD.js","assets/js/BanyaPage-DlLYn-aJ.js","assets/js/ContactsPage-Dn47-Ru2.js","assets/js/CommonComponents-C6CHnm-k.js","assets/js/PrivacyPage-C2Iz-1Pr.js","assets/js/TermsPage-5x6Yes4g.js","assets/js/SurveyPage-BRE_bBQY.js"])))=>i.map(i=>d[i]);
import{r as e,j as i,R as t,u as a,i as n,a as o,b as r,F as s,c as l,d as c,L as p,H as d,e as m,f as u,g as h,h as g,B as b,k as f,l as _,N as y,m as x}from"./vendor-react-Udk5_aBK.js";import{f as w,m as v,d as k,o as A}from"./vendor-styles-DIjDOctl.js";import{i as F,B as C}from"./vendor-i18n-C4kh69yx.js";import{m as j,A as S}from"./vendor-animations-B-vr_HsI.js";import"./vendor-other-CZupzcPt.js";!function(){const e=document.createElement("link").relList;if(!(e&&e.supports&&e.supports("modulepreload"))){for(const e of document.querySelectorAll('link[rel="modulepreload"]'))i(e);new MutationObserver(e=>{for(const t of e)if("childList"===t.type)for(const e of t.addedNodes)"LINK"===e.tagName&&"modulepreload"===e.rel&&i(e)}).observe(document,{childList:!0,subtree:!0})}function i(e){if(e.ep)return;e.ep=!0;const i=function(e){const i={};return e.integrity&&(i.integrity=e.integrity),e.referrerPolicy&&(i.referrerPolicy=e.referrerPolicy),"use-credentials"===e.crossOrigin?i.credentials="include":"anonymous"===e.crossOrigin?i.credentials="omit":i.credentials="same-origin",i}(e);fetch(e.href,i)}}();const P={},I=function(e,i,t){let a=Promise.resolve();if(i&&i.length>0){let e=function(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:"fulfilled",value:e}),e=>({status:"rejected",reason:e}))))};document.getElementsByTagName("link");const t=document.querySelector("meta[property=csp-nonce]"),n=(null==t?void 0:t.nonce)||(null==t?void 0:t.getAttribute("nonce"));a=e(i.map(e=>{if((e=function(e){return"/"+e}(e))in P)return;P[e]=!0;const i=e.endsWith(".css"),t=i?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${e}"]${t}`))return;const a=document.createElement("link");return a.rel=i?"stylesheet":"modulepreload",i||(a.as="script"),a.crossOrigin="",a.href=e,n&&a.setAttribute("nonce",n),document.head.appendChild(a),i?new Promise((i,t)=>{a.addEventListener("load",i),a.addEventListener("error",()=>t(new Error(`Unable to preload CSS for ${e}`)))}):void 0}))}function n(e){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=e,window.dispatchEvent(i),!i.defaultPrevented)throw e}return a.then(i=>{for(const e of i||[])"rejected"===e.status&&n(e.reason);return e().catch(n)})},B=w`
...
`,Pe={logo:{initial:{scale:.95,opacity:0},animate:{scale:1,opacity:1,transition:{duration:.8,ease:"easeOut",delay:.2}}},buttons:{initial:{opacity:0,y:15},animate:{opacity:1,y:0,transition:{duration:.5,ease:"easeOut",delay:.6}}}},Ie=e.memo(()=>{const{t}=o(),[a,n]=e.useState(0);return e.useEffect(()=>{const e=setInterval(()=>{requestAnimationFrame(()=>{n(e=>(e+1)%ye.length)})},6e3);return()=>clearInterval(e)},[]),i.jsxs(xe,{children:[i.jsx(we,{children:ye.map((e,t)=>i.jsx(ve,{$active:t===a,children:i.jsxs("picture",{children:[i.jsx("source",{srcSet:e.webp,type:"image/webp"}),i.jsx("img",{src:e.fallback,alt:`KAIF - Слайд ${t+1}`,loading:0===t?"eager":"lazy",decoding:"async",onError:e=>{const i=["https://images.unsplash.com/photo-1544161515-4ab6ce6db874?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=75","https://images.unsplash.com/photo-1600334129128-685c5582fd35?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=75","https://images.unsplash.com/photo-1519823551278-64ac92734fb1?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=75","https://images.unsplash.com/photo-1515377905703-c4788e51af15?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=75"];e.target.src=i[t%i.length]}})]})},`slide-${t}`))}),i.jsx(ke,{children:i.jsxs(Ae,{children:[i.jsxs("picture",{style:{display:"block"},children:[i.jsx("source",{srcSet:"/assets/images/logo-homepage-Bvg3zKLL.webp",type:"image/webp"}),i.jsx(Fe,{src:"/assets/images/logo-homepage-H1DZjSiR.png",alt:"KAIF",initial:Pe.logo.initial,animate:Pe.logo.animate,whileHover:{scale:1.02,transition:{duration:.2,ease:"easeOut"}}})]}),i.jsxs(Se,{as:j.div,initial:Pe.buttons.initial,animate:Pe.buttons.animate,children:[i.jsx(j.div,{whileHover:{scale:1.02,transition:{duration:.15,ease:"easeOut"}},whileTap:{scale:.98},children:i.jsx(Ce,{href:"https://wa.me/66624805877?text=Здравствуйте! Хочу записаться в KAIF",target:"_blank",rel:"noopener noreferrer",children:t("common.book")})}),i.jsx(j.div,{onClick:()=>{const e=document.querySelector("#exclusive-zones");e&&e.scrollIntoView({behavior:"smooth",block:"start"})},whileHover:{scale:1.01,transition:{duration:.15,ease:"easeOut"}},whileTap:{scale:.99},children:i.jsx(je,{children:t("common.learn_more")})})]})]})})]})});Ie.displayName="HeroFullscreen";const Be=k.section`
  position: relative;
  padding: 6rem 0;
  background-color: #ffffff;
  overflow: hidden;
