...
import{u as a,L as i}from"./App-F156KX6S.js"
import{d as n}from"./styled-components-CMIfAvVS.js"
import{u as r}from"./i18n-core-CSZVPE1N.js"
import{a5 as o,aa as s,ab as l}from"./vendor-misc-Bm4JrmXh.js"
import{m as d,A as p}from"./framer-motion-h7lgP0Yp.js"
import{F as c,a as m,b as g}from"./heroicons-B0mUXsxG.js"
import h from"./GlobalStyles-SUYem3hU.js"
import"./main-C1zLyBkI.js"
...
const x=()=>{const[a,i]=e.useState(0),[n,l]=e.useState(0),[c,m]=e.useState(null),[g,h]=e.useState(null),{i18n:x,t:u}=r(),f=o(),b=s(),y=e.useCallback(e=>"/"===e&&"/"===f.pathname||"/"!==e&&f.pathname.startsWith(e)?1:0,[f.pathname]),v=e.useCallback(e=>{x.changeLanguage(e),localStorage.setItem("i18nextLng",e),document.documentElement.lang=e,l(0)},[x]),w=e.useCallback(e=>{g&&clearTimeout(g)
const t=setTimeout(()=>{b(e),setTimeout(()=>{window.scrollTo({top:0,left:0,behavior:"instant"}),document.documentElement.scrollTop=0,document.body.scrollTop=0},0),setTimeout(()=>{window.scrollY>0&&window.scrollTo(0,0)},50)},100)
h(t)},[b,g]),j=e.useMemo(()=>[{code:"ru",name:"Русский"},{code:"en",name:"English"},{code:"th",name:"ไทย"}],[]),k=e.useMemo(()=>j.find(e=>e.code===x.language)||j[0],[j,x.language])
e.useEffect(()=>{const e=e=>{e.target.closest(".language-selector")||l(0)}
return document.addEventListener("click",e),()=>document.removeEventListener("click",e)},[]),e.useEffect(()=>()=>{g&&clearTimeout(g)},[g])
...
`
n.p`
  font-family: ${({theme:e})=>{var t
return(null==(t=null==e?void 0:e.fonts)?void 0:t.primary)||"Inter, sans-serif"}};
  font-size: 0.875rem;
...
`,k=n(d.a)`
  ...
  &:hover {
    background: ${({theme:e})=>{var t,a
return(null==(a=null==(t=null==e?void 0:e.colors)?void 0:t.gradients)?void 0:a.logo)||"linear-gradient(135deg, rgba(255, 99, 71, 0.07) 0%, rgba(255, 99, 71, 0.10) 5%, rgba(206, 128, 114, 0.12) 12%, rgba(157, 157, 157, 0.15) 20%, rgba(108, 186, 200, 0.18) 28%, rgba(0, 180, 216, 0.20) 36%, rgba(71, 168, 203, 0.18) 44%, rgba(142, 157, 188, 0.15) 52%, rgba(214, 145, 173, 0.12) 60%, rgba(255, 105, 180, 0.10) 68%, rgba(219, 140, 149, 0.12) 76%, rgba(183, 175, 118, 0.15) 84%, rgba(147, 210, 95, 0.10) 92%, rgba(92, 184, 72, 0.07) 100%)"}};
...
`,z=n.h3`
  font-family: ${({theme:e})=>{var t
return(null==(t=null==e?void 0:e.fonts)?void 0:t.heading)||'"Playfair Display", serif'}};
  font-size: 1.5rem;
  font-weight: 500;
  ...
  &::after {
    ...
    background: linear-gradient(135deg, 
      ${({theme:e})=>{var t
return(null==(t=null==e?void 0:e.colors)?void 0:t.primary)||"#90B3A7"}} 0%, 
      ${({theme:e})=>{var t
return(null==(t=null==e?void 0:e.colors)?void 0:t.secondary)||"#D4A574"}} 100%
    );
  }
...
`,L=n(d.div)`
  ...
  height: 150px;
  border-radius: 50%;
  background: ${({$variant:e})=>{switch(e){case"secondary":return"linear-gradient(135deg, rgba(212, 165, 116, 0.08) 0%, rgba(184, 196, 168, 0.06) 100%)"
case"tertiary":return"linear-gradient(135deg, rgba(184, 196, 168, 0.08) 0%, rgba(144, 179, 167, 0.06) 100%)"
default:return"linear-gradient(135deg, rgba(144, 179, 167, 0.08) 0%, rgba(212, 165, 116, 0.06) 100%)"}}};
  filter: blur(60px);
  z-index: 2;
  pointer-events: none;
...
`,P=()=>{const{t:e}=r(),a={hidden:{opacity:0,y:30},visible:{opacity:1,y:0,transition:{duration:.6,ease:[.25,.46,.45,.94]}}},i={animate:{y:[0,-15,0],transition:{duration:12,repeat:1/0,ease:"easeInOut",repeatType:"mirror"}}},n=(new Date).getFullYear(),o=[{path:"/",label:e("navigation.home"),id:"home"},{path:"/restaurant",label:e("navigation.restaurant"),id:"restaurant"},{path:"/spa",label:e("navigation.spa"),id:"spa"},{path:"/sports",label:e("navigation.sports"),id:"sports-main"},{path:"/contacts",label:e("navigation.contacts"),id:"contacts"}],s=[{path:"/spa",label:e("footer.services.sauna"),id:"spa-sauna"},{path:"/restaurant",label:e("navigation.restaurant"),id:"restaurant"},{path:"/sports",label:e("footer.services.fitness"),id:"sports-fitness"},{path:"/banya",label:e("navigation.banya"),id:"banya"},{path:"/sports",label:e("footer.services.fight_club"),id:"sports-club"}]
return t.jsxs(u,{children:[t.jsx(L,{className:"deco-1",$variant:"primary",variants:i,animate:"animate"}),t.jsx(L,{className:"deco-2",$variant:"secondary",variants:i,animate:"animate",style:{animationDelay:"-4s"}}),t.jsx(L,{className:"deco-3",$variant:"tertiary",variants:i,animate:"animate",style:{animationDelay:"-8s"}}),t.jsx(f,{children:t.jsxs(d.div,{variants:{hidden:{opacity:0},visible:{opacity:1,transition:{duration:.8,staggerChildren:.2}}},initial:"hidden",whileInView:"visible",viewport:{once:1,amount:.3},children:[t.jsxs(b,{children:[t.jsxs(y,{variants:a,children:[t.jsx(v,{whileHover:{scale:1.05,transition:{duration:.3,ease:"easeOut"}},children:t.jsxs("picture",{children:[t.jsx("source",{srcSet:"/images/logos/logo-footer-2x.webp 2x, /images/logos/logo-footer-1x.webp 1x",type:"image/webp"}),t.jsx("source",{srcSet:"/images/logos/logo-footer-2x.png 2x, /images/logos/logo-footer-1x.png 1x",type:"image/png"}),t.jsx("img",{src:"/images/logos/logo-footer-1x.png",alt:"KAIF",style:{width:"100%",height:"auto",maxWidth:"360px",filter:"brightness(1.2) contrast(1.1)",imageRendering:"crisp-edges"},loading:"lazy"})]})}),t.jsx(w,{children:e("footer.brand.description")}),t.jsxs(j,{children:[t.jsx(k,{href:"https://www.instagram.com/kaif.phuket/",target:"_blank",rel:"noopener noreferrer",whileHover:{scale:1.1,transition:{duration:.3,ease:"easeOut"}},whileTap:{scale:.95},children:t.jsx("svg",{fill:"currentColor",viewBox:"0 0 24 24",children:t.jsx("path",{d:"M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"})})}),t.jsx(k,{href:"https://web.facebook.com/kaifphuketfb?mibextid=LQQJ4d&_rdc=1&_rdr#",target:"_blank",rel:"noopener noreferrer",whileHover:{scale:1.1,transition:{duration:.3,ease:"easeOut"}},whileTap:{scale:.95},children:t.jsx("svg",{fill:"currentColor",viewBox:"0 0 24 24",children:t.jsx("path",{d:"M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"})})}),t.jsx(k,{href:"https://t.me/kaifphuketchat",target:"_blank",rel:"noopener noreferrer",whileHover:{scale:1.1,transition:{duration:.3,ease:"easeOut"}},whileTap:{scale:.95},children:t.jsx("svg",{fill:"currentColor",viewBox:"0 0 24 24",children:t.jsx("path",{d:"m20.665 3.717-17.73 6.837c-1.21.486-1.203 1.161-.222 1.462l4.552 1.42 10.532-6.645c.498-.303.953-.14.579.192l-8.533 7.701h-.002l.002.001-.314 4.692c.46 0 .663-.211.921-.46l2.211-2.15 4.599 3.397c.848.467 1.457.227 1.668-.789l3.019-14.228c.309-1.239-.473-1.8-1.282-1.434z"})})}),t.jsx(k,{href:"https://www.youtube.com/@KaifPhuket",target:"_blank",rel:"noopener noreferrer",whileHover:{scale:1.1,transition:{duration:.3,ease:"easeOut"}},whileTap:{scale:.95},children:t.jsx("svg",{fill:"currentColor",viewBox:"0 0 24 24",children:t.jsx("path",{d:"M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"})})}),t.jsx(k,{href:"https://api.whatsapp.com/send/?phone=66624805877&text&type=phone_number&app_absent=0",target:"_blank",rel:"noopener noreferrer",whileHover:{scale:1.1,transition:{duration:.3,ease:"easeOut"}},whileTap:{scale:.95},children:t.jsx("svg",{fill:"currentColor",viewBox:"0 0 24 24",width:"16",height:"16",children:t.jsx("path",{d:"M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893A11.821 11.821 0 0020.885 3.488z"})})})]})]}),t.jsxs(C,{variants:a,children:[t.jsx(z,{children:e("footer.navigation")}),o.map(e=>t.jsx(S,{to:e.path,children:e.label},e.id))]}),t.jsxs(C,{variants:a,children:[t.jsx(z,{children:e("footer.services.title")}),s.map(e=>t.jsx(S,{to:e.path,children:e.label},e.id))]}),t.jsxs(C,{variants:a,children:[t.jsx(z,{children:e("navigation.contacts")}),t.jsxs(A,{children:[t.jsx(c,{}),t.jsxs(I,{children:["73, Baan Chalekiri Village,",t.jsx("br",{}),"6 Pra Phuket Keaw Road, Kathu"]})]}),t.jsxs(A,{children:[t.jsx(m,{}),t.jsx(I,{children:t.jsx(B,{href:"tel:+66624805877",children:"+66 62 480 5877"})})]}),t.jsxs(A,{children:[t.jsx(g,{}),t.jsxs(I,{children:[e("footer.schedule.daily"),t.jsx("br",{}),e("footer.schedule.hours")]})]})]})]}),t.jsxs(F,{children:[t.jsxs(T,{children:["© ",n," ",t.jsx("span",{className:"highlight",children:"KAIF"}),".",e("footer.copyright")]}),t.jsxs(E,{children:[t.jsx(l,{to:"/privacy",children:e("footer.legal.privacy")}),t.jsx(l,{to:"/terms",children:e("footer.legal.terms")})]})]})]})})]})},D=n.div`
  min-height: 100vh;
  width: 100%;
  position: relative;
  z-index: 1;
...
`,W=({children:n})=>{const r=o(),[s,l]=e.useState(1),d=e.useRef(1),{isLoading:p}=a()
return e.useEffect(()=>{if(d.current)return d.current=0,void l(1)
l(0),window.scrollTo(0,0)
const e=setTimeout(()=>{l(1)},500)
return()=>clearTimeout(e)},[r.pathname]),t.jsxs(t.Fragment,{children:[t.jsx(h,{}),t.jsx(i,{isVisible:!s&&!p}),t.jsx(x,{}),t.jsxs(D,{children:[t.jsx(M,{children:n}),s&&t.jsx(P,{})]})]})}
export{W as default}
