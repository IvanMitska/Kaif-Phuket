...
`,EventBanner=({onClose:e})=>{const[t,r]=i.useState(!0),[o,n]=i.useState(!1);i.useEffect(()=>{sessionStorage.getItem("saunaRaveBannerClosed")&&r(!1)},[]);return t?a.jsx(a.Fragment,{children:t&&a.jsxs(S,{children:[a.jsx(B,{left:"2%",top:"15%",size:"1.8rem",children:"🎄"}),a.jsx(B,{left:"97%",top:"20%",size:"1.5rem",children:"🎁"}),a.jsx(B,{left:"4%",top:"80%",size:"1.3rem",children:"🔔"}),a.jsx(B,{left:"94%",top:"75%",size:"1.6rem",children:"⭐"}),a.jsx(_,{left:"5%",size:"1.2rem",duration:"10s",delay:"0s",children:"❄"}),a.jsx(_,{left:"15%",size:"0.8rem",duration:"12s",delay:"2s",children:"❄"}),a.jsx(_,{left:"25%",size:"1rem",duration:"9s",delay:"1s",children:"✦"}),a.jsx(_,{left:"35%",size:"0.9rem",duration:"11s",delay:"3s",children:"❄"}),a.jsx(_,{left:"55%",size:"1.1rem",duration:"10s",delay:"0.5s",children:"❄"}),a.jsx(_,{left:"65%",size:"0.7rem",duration:"13s",delay:"4s",children:"✦"}),a.jsx(_,{left:"75%",size:"1rem",duration:"9s",delay:"2.5s",children:"❄"}),a.jsx(_,{left:"85%",size:"0.9rem",duration:"11s",delay:"1.5s",children:"❄"}),a.jsx(_,{left:"95%",size:"1.2rem",duration:"10s",delay:"3.5s",children:"✦"}),a.jsx($,{left:"3%",top:"20%",color:"#d4af37",size:"5px",duration:"2s",delay:"0s",glow:"8px"}),a.jsx($,{left:"10%",top:"70%",color:"#d4af37",size:"4px",duration:"2.5s",delay:"0.5s",glow:"6px"}),a.jsx($,{left:"92%",top:"30%",color:"#d4af37",size:"6px",duration:"1.8s",delay:"1s",glow:"10px"}),a.jsx($,{left:"88%",top:"75%",color:"#d4af37",size:"4px",duration:"2.2s",delay:"0.3s",glow:"6px"}),a.jsx($,{left:"7%",top:"40%",color:"#c62828",size:"4px",duration:"2.3s",delay:"0.7s",glow:"8px"}),a.jsx($,{left:"95%",top:"50%",color:"#c62828",size:"5px",duration:"1.9s",delay:"1.2s",glow:"8px"}),a.jsx($,{left:"5%",top:"85%",color:"#228B22",size:"4px",duration:"2.1s",delay:"0.2s",glow:"6px"}),a.jsx($,{left:"90%",top:"15%",color:"#228B22",size:"5px",duration:"2.4s",delay:"0.8s",glow:"8px"}),a.jsxs(A,{children:[a.jsx(E,{onClick:()=>{r(!1),sessionStorage.setItem("saunaRaveBannerClosed","true"),e&&e()},children:a.jsx(l,{})}),a.jsxs(I,{children:[a.jsx(P,{children:a.jsx(C,{src:"/images/events/rave.webp",alt:"Sauna Rave Event",loading:"eager"})}),a.jsxs(R,{children:[a.jsx(M,{children:"SAUNA RAVE"}),a.jsxs(D,{children:[a.jsxs(F,{children:[a.jsx("span",{children:"📅"})," 27 December, Saturday"]}),a.jsxs(F,{children:[a.jsx("span",{children:"🕐"})," 18:30 - 21:30"]}),a.jsxs(F,{children:[a.jsx("span",{children:"📍"})," KAIF, Kathu, Phuket"]})]}),a.jsxs(L,{children:[a.jsx(Y,{children:"Group Steaming"}),a.jsx(Y,{children:"Detox Shots"}),a.jsx(Y,{children:"DJ"})]}),a.jsx(H,{onClick:()=>n(!0),children:"🎄 Book Now 🎄"})]})]})]}),a.jsx(s,{isOpen:o,onClose:()=>n(!1),service:"Sauna Rave Event - 27 December",source:"Home - Event Banner"})]})}):null},O=i.lazy(()=>t(()=>import("./ExclusiveZones-zMi5JS1V.js"),__vite__mapDeps([0,1,2,3,4,5]))),V=i.lazy(()=>t(()=>import("./PricingSection-CN76bsyX.js"),__vite__mapDeps([6,1,2,3,7,8,4,9,5]))),N=i.lazy(()=>t(()=>import("./AdvantagesSection-CgXybR0-.js"),__vite__mapDeps([10,1,2,3,4,9])).then(e=>({default:i.memo(e.default)}))),T=i.lazy(()=>t(()=>import("./GallerySection-BdpHrPNM.js"),__vite__mapDeps([11,1,2,3,4,9,5])).then(e=>({default:i.memo(e.GallerySection)}))),G=i.lazy(()=>t(()=>import("./FAQSection-DcCnwskE.js"),__vite__mapDeps([12,1,2,3,4,5,9])).then(e=>({default:i.memo(e.default)}))),U=r.div`
  height: 120px;
  display: flex;
  align-items: center;
  justify-content: center;
...
`,J=i.memo(()=>{const{t:t}=d(),{showLoading:r}=e(),o=i.useRef(!1);return i.useEffect(()=>{o.current||(o.current=!0)},[]),a.jsxs(a.Fragment,{children:[a.jsx(n,{titleKey:"page_titles.home",description:t("home.hero.subtitle","Unique relaxation and wellness experience in Phuket"),keywords:"KAIF, spa, wellness, Phuket, gym, restaurant, banya, massage",ogImage:"/images/logos/logo-og.png"}),a.jsx(y,{}),a.jsx(EventBanner,{}),a.jsx(i.Suspense,{fallback:a.jsx(U,{}),children:a.jsx(O,{})}),a.jsx(i.Suspense,{fallback:a.jsx(U,{}),children:a.jsx(V,{})}),a.jsx(i.Suspense,{fallback:a.jsx(U,{}),children:a.jsx(N,{})}),a.jsx(i.Suspense,{fallback:a.jsx(U,{}),children:a.jsx(T,{})}),a.jsx(i.Suspense,{fallback:a.jsx(U,{}),children:a.jsx(G,{})}),a.jsx(Z,{children:a.jsxs(q,{to:"/contacts",children:[t("common.contact_us"),a.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",children:a.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M17 8l4 4m0 0l-4 4m4-4H3"})})]})})]})});J.displayName="HomePage";export{J as default};
