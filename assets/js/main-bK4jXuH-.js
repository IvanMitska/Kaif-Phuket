const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/js/AdvantagesSection-DXnb0N-9.js","assets/js/vendor-react-jkclZeQG.js","assets/js/vendor-other-CZupzcPt.js","assets/js/vendor-styles-Xp2kl99K.js","assets/js/vendor-animations-Bkvmj3bK.js","assets/js/GallerySection-Q2GwLumY.js","assets/js/FAQSection-CsvD04Uz.js","assets/js/RestaurantPage-6vuP5_qG.js","assets/js/PageScrollReset-CLBNH8P7.js","assets/js/vendor-i18n-C4kh69yx.js","assets/js/SpaPage-Bg8IxUKS.js","assets/js/SportsPage-BYI6VZd7.js","assets/js/BanyaPage-D4Lk68Ky.js","assets/js/ContactsPage-BjrsLDn_.js","assets/js/CommonComponents-BAEfHC96.js","assets/js/PrivacyPage-BVPfpogQ.js","assets/js/TermsPage-CtpibQuX.js"])))=>i.map(i=>d[i]);
import{r as e,j as i,R as t,u as a,i as n,a as o,b as r,F as s,c as l,d as c,L as p,e as d,H as m,f as u,g as h,h as g,k as f,B as b,l as _,m as y,N as x,n as v}from"./vendor-react-jkclZeQG.js";import{f as w,m as k,d as A,o as F}from"./vendor-styles-Xp2kl99K.js";import{i as C,B as j}from"./vendor-i18n-C4kh69yx.js";import{m as S,A as P}from"./vendor-animations-Bkvmj3bK.js";import"./vendor-other-CZupzcPt.js";!function(){const e=document.createElement("link").relList;if(!(e&&e.supports&&e.supports("modulepreload"))){for(const e of document.querySelectorAll('link[rel="modulepreload"]'))i(e);new MutationObserver(e=>{for(const t of e)if("childList"===t.type)for(const e of t.addedNodes)"LINK"===e.tagName&&"modulepreload"===e.rel&&i(e)}).observe(document,{childList:!0,subtree:!0})}function i(e){if(e.ep)return;e.ep=!0;const i=function(e){const i={};return e.integrity&&(i.integrity=e.integrity),e.referrerPolicy&&(i.referrerPolicy=e.referrerPolicy),"use-credentials"===e.crossOrigin?i.credentials="include":"anonymous"===e.crossOrigin?i.credentials="omit":i.credentials="same-origin",i}(e);fetch(e.href,i)}}();const I={},B=function(e,i,t){let a=Promise.resolve();if(i&&i.length>0){let e=function(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:"fulfilled",value:e}),e=>({status:"rejected",reason:e}))))};document.getElementsByTagName("link");const t=document.querySelector("meta[property=csp-nonce]"),n=(null==t?void 0:t.nonce)||(null==t?void 0:t.getAttribute("nonce"));a=e(i.map(e=>{if((e=function(e){return"/"+e}(e))in I)return;I[e]=!0;const i=e.endsWith(".css"),t=i?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${e}"]${t}`))return;const a=document.createElement("link");return a.rel=i?"stylesheet":"modulepreload",i||(a.as="script"),a.crossOrigin="",a.href=e,n&&a.setAttribute("nonce",n),document.head.appendChild(a),i?new Promise((i,t)=>{a.addEventListener("load",i),a.addEventListener("error",()=>t(new Error(`Unable to preload CSS for ${e}`)))}):void 0}))}function n(e){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=e,window.dispatchEvent(i),!i.defaultPrevented)throw e}return a.then(i=>{for(const e of i||[])"rejected"===e.status&&n(e.reason);return e().catch(n)})},T=w`
...
`,M=e.createContext();let E=!1;const K=()=>e.useContext(M),R=({children:t})=>{const[a,n]=e.useState(!1),[o,r]=e.useState(!0),s=e.useRef(!1),l=e.useRef(!1);return i.jsx(M.Provider,{value:{isLoading:a,isContentReady:o,showLoading:(e=1e3)=>s.current||l.current||E?Promise.resolve():(E=!0,s.current=!0,l.current=!0,r(!1),n(!0),new Promise(i=>{setTimeout(()=>{n(!1),setTimeout(()=>{r(!0),s.current=!1,i()},200)},e)})),showContentDirectly:()=>{l.current=!0,n(!1),r(!0),s.current=!1},resetLoading:()=>{l.current=!1,s.current=!1,n(!1),r(!0)}},children:t})},q=k`
  from { opacity: 0; }
  to { opacity: 1; }
`,L=k`
  from { opacity: 1; }
...
`,D=A.div`
  ...
  &.exiting {
    animation: ${L} 0.3s ease-in forwards;
  }
...
`,H=A.img`
  ...
  /* Упрощенная анимация */
  animation: ${O} 0.6s ease-out 0.1s both;
...
`,fe=()=>{const{t:e}=o(),t={hidden:{opacity:0,y:30},visible:{opacity:1,y:0,transition:{duration:.6,ease:[.25,.46,.45,.94]}}},a={animate:{y:[0,-15,0],transition:{duration:12,repeat:1/0,ease:"easeInOut",repeatType:"mirror"}}},n=(new Date).getFullYear(),r=[{path:"/",label:e("navigation.home"),id:"home"},{path:"/restaurant",label:e("navigation.restaurant"),id:"restaurant"},{path:"/spa",label:e("navigation.spa"),id:"spa"},{path:"/sports",label:e("navigation.sports"),id:"sports-main"},{path:"/contacts",label:e("navigation.contacts"),id:"contacts"}],d=[{path:"/spa",label:e("footer.services.sauna"),id:"spa-sauna"},{path:"/restaurant",label:e("navigation.restaurant"),id:"restaurant"},{path:"/sports",label:e("footer.services.fitness"),id:"sports-fitness"},{path:"/banya",label:e("navigation.banya"),id:"banya"},{path:"/sports",label:e("footer.services.fight_club"),id:"sports-club"}];return i.jsxs(X,{children:[i.jsx(ge,{className:"deco-1",$variant:"primary",variants:a,animate:"animate"}),i.jsx(ge,{className:"deco-2",$variant:"secondary",variants:a,animate:"animate",style:{animationDelay:"-4s"}}),i.jsx(ge,{className:"deco-3",$variant:"tertiary",variants:a,animate:"animate",style:{animationDelay:"-8s"}}),i.jsx(Z,{children:i.jsxs(S.div,{variants:{hidden:{opacity:0},visible:{opacity:1,transition:{duration:.8,staggerChildren:.2}}},initial:"hidden",whileInView:"visible",viewport:{once:!0,amount:.3},children:[i.jsxs(ee,{children:[i.jsxs(ie,{variants:t,children:[i.jsx(te,{whileHover:{scale:1.05,transition:{duration:.3,ease:"easeOut"}},children:i.jsxs("picture",{children:[i.jsx("source",{srcSet:"/images/logos/logo-footer-2x.webp 2x, /images/logos/logo-footer-1x.webp 1x",type:"image/webp"}),i.jsx("source",{srcSet:"/images/logos/logo-footer-2x.png 2x, /images/logos/logo-footer-1x.png 1x",type:"image/png"}),i.jsx("img",{src:"/images/logos/logo-footer-1x.png",alt:"KAIF",style:{width:"100%",height:"auto",maxWidth:"360px",filter:"brightness(1.2) contrast(1.1)",imageRendering:"crisp-edges"},loading:"lazy"})]})}),i.jsx(ae,{children:e("footer.brand.description")}),i.jsxs(ne,{children:[i.jsx(oe,{href:"https://www.instagram.com/kaif.phuket/",target:"_blank",rel:"noopener noreferrer",whileHover:{scale:1.1,transition:{duration:.3,ease:"easeOut"}},whileTap:{scale:.95},children:i.jsx("svg",{fill:"currentColor",viewBox:"0 0 24 24",children:i.jsx("path",{d:"M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"})})}),i.jsx(oe,{href:"https://web.facebook.com/kaifphuketfb?mibextid=LQQJ4d&_rdc=1&_rdr#",target:"_blank",rel:"noopener noreferrer",whileHover:{scale:1.1,transition:{duration:.3,ease:"easeOut"}},whileTap:{scale:.95},children:i.jsx("svg",{fill:"currentColor",viewBox:"0 0 24 24",children:i.jsx("path",{d:"M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"})})}),i.jsx(oe,{href:"https://t.me/kaifphuketchat",target:"_blank",rel:"noopener noreferrer",whileHover:{scale:1.1,transition:{duration:.3,ease:"easeOut"}},whileTap:{scale:.95},children:i.jsx("svg",{fill:"currentColor",viewBox:"0 0 24 24",children:i.jsx("path",{d:"m20.665 3.717-17.73 6.837c-1.21.486-1.203 1.161-.222 1.462l4.552 1.42 10.532-6.645c.498-.303.953-.14.579.192l-8.533 7.701h-.002l.002.001-.314 4.692c.46 0 .663-.211.921-.46l2.211-2.15 4.599 3.397c.848.467 1.457.227 1.668-.789l3.019-14.228c.309-1.239-.473-1.8-1.282-1.434z"})})}),i.jsx(oe,{href:"https://www.youtube.com/@KaifPhuket",target:"_blank",rel:"noopener noreferrer",whileHover:{scale:1.1,transition:{duration:.3,ease:"easeOut"}},whileTap:{scale:.95},children:i.jsx("svg",{fill:"currentColor",viewBox:"0 0 24 24",children:i.jsx("path",{d:"M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"})})}),i.jsx(oe,{href:"https://api.whatsapp.com/send/?phone=66624805877&text&type=phone_number&app_absent=0",target:"_blank",rel:"noopener noreferrer",whileHover:{scale:1.1,transition:{duration:.3,ease:"easeOut"}},whileTap:{scale:.95},children:i.jsx("svg",{fill:"currentColor",viewBox:"0 0 24 24",width:"16",height:"16",children:i.jsx("path",{d:"M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893A11.821 11.821 0 0020.885 3.488z"})})})]})]}),i.jsxs(re,{variants:t,children:[i.jsx(se,{children:e("footer.navigation")}),r.map(e=>i.jsx(le,{to:e.path,children:e.label},e.id))]}),i.jsxs(re,{variants:t,children:[i.jsx(se,{children:e("footer.services.title")}),d.map(e=>i.jsx(le,{to:e.path,children:e.label},e.id))]}),i.jsxs(re,{variants:t,children:[i.jsx(se,{children:e("navigation.contacts")}),i.jsxs(ce,{children:[i.jsx(s,{}),i.jsxs(pe,{children:["73, Baan Chalekiri Village,",i.jsx("br",{}),"6 Pra Phuket Keaw Road, Kathu"]})]}),i.jsxs(ce,{children:[i.jsx(l,{}),i.jsx(pe,{children:i.jsx(de,{href:"tel:+66624805877",children:"+66 62 480 5877"})})]}),i.jsxs(ce,{children:[i.jsx(c,{}),i.jsxs(pe,{children:[e("footer.schedule.daily"),i.jsx("br",{}),e("footer.schedule.hours")]})]})]})]}),i.jsxs(me,{children:[i.jsxs(ue,{children:["© ",n," ",i.jsx("span",{className:"highlight",children:"KAIF"}),".",e("footer.copyright")]}),i.jsxs(he,{children:[i.jsx(p,{to:"/privacy",children:e("footer.legal.privacy")}),i.jsx(p,{to:"/terms",children:e("footer.legal.terms")})]})]})]})})]})},be=k`
  0% {
    transform: scale(1);
...
`,_e=A.div`
  ...
  top: 85px;
  left: 50%;
  transform: translateX(-50%) ${({$isVisible:e})=>e?"translateY(0)":"translateY(-20px)"};
  z-index: 99;
  width: 100%;
  max-width: 700px;
  margin: 0 auto;
...
`,ye=A.div`
  ...
  border: 1px solid rgba(255, 255, 255, 0.2);
  animation: ${be} 2.5s infinite ease-in-out;
  backdrop-filter: blur(10px);
  pointer-events: auto;
  position: relative;
...
`,Fe=()=>{const[t,a]=e.useState(!1),{t:n}=o();return e.useEffect(()=>{const e=new Date("2025-08-01"),i=new Date;if(i>=e)return;const t=localStorage.getItem("kaifPromoClosed");if(t&&(i-new Date(t))/36e5<1)return;const n=setTimeout(()=>a(!0),300);return()=>clearTimeout(n)},[]),t?i.jsx(_e,{$isVisible:t,children:i.jsxs(ye,{children:[i.jsx(xe,{onDoubleClick:e=>{e.preventDefault(),localStorage.removeItem("kaifPromoClosed"),a(!0)},children:i.jsx(d,{})}),i.jsxs(ve,{children:[i.jsx(we,{children:n("promo.title")}),i.jsx(ke,{children:n("promo.subtitle")})]}),i.jsx(Ae,{onClick:()=>{a(!1),localStorage.setItem("kaifPromoClosed",(new Date).toISOString())},children:"×"})]})}):null},Ce=A.div`
  min-height: 100vh;
  width: 100%;
  position: relative;
  z-index: 1;
...
`,je=A.main`
  ...
  flex: 1 0 auto;
  margin: 0;
`,Se=({children:t})=>{const n=a(),[o,r]=e.useState(!0),s=e.useRef(!0),{isLoading:l}=K();return e.useEffect(()=>{if(s.current)return s.current=!1,void r(!0);r(!1),window.scrollTo(0,0);const e=setTimeout(()=>{r(!0)},500);return()=>clearTimeout(e)},[n.pathname]),i.jsxs(i.Fragment,{children:[i.jsx(z,{}),i.jsx($,{isVisible:!o&&!l}),i.jsx(Q,{}),i.jsx(Fe,{}),i.jsxs(Ce,{children:[i.jsx(je,{children:t}),o&&i.jsx(fe,{style:{marginBottom:"-2px"}})]})]})},Pe=({titleKey:t="page_titles.home",defaultTitle:a="KAIF | Jungle Club & Spa",description:n,keywords:r,ogImage:s,pageType:l="website"})=>{const{t:c,i18n:p}=o(),d=c(t,a);return e.useEffect(()=>{document.title=d},[d,p.language]),i.jsxs(m,{children:[i.jsx("title",{children:d}),n&&i.jsx("meta",{name:"description",content:n}),r&&i.jsx("meta",{name:"keywords",content:r}),i.jsx("meta",{property:"og:title",content:d}),n&&i.jsx("meta",{property:"og:description",content:n}),i.jsx("meta",{property:"og:type",content:l}),s&&i.jsx("meta",{property:"og:image",content:s}),i.jsx("meta",{name:"twitter:title",content:d}),n&&i.jsx("meta",{name:"twitter:description",content:n}),i.jsx("meta",{name:"twitter:card",content:"summary_large_image"}),s&&i.jsx("meta",{name:"twitter:image",content:s}),i.jsx("link",{rel:"shortcut icon",type:"image/png",href:"/favicon.png"}),i.jsx("link",{rel:"icon",type:"image/png",href:"/favicon.png"}),i.jsx("meta",{name:"theme-color",content:"#2C614F"})]})},Ie="/assets/images/hero-restaurant-B-WOCk0r.jpg",Be=["/assets/images/hero-spa-DTdp7JL8.jpg","/assets/images/hero-pool-D1w69rNO.jpg",Ie,"/assets/images/hero-fitness-C8kFY2Cm.jpg"],Te=A.section`
  position: relative;
  width: 100%;
  min-height: 100vh;
  height: auto;
...
`,De={logo:{initial:{scale:.95,opacity:0},animate:{scale:1,opacity:1,transition:{duration:.8,ease:"easeOut",delay:.2}}},buttons:{initial:{opacity:0,y:15},animate:{opacity:1,y:0,transition:{duration:.5,ease:"easeOut",delay:.6}}}},We=e.memo(()=>{const{t}=o(),[a,n]=e.useState(0);return e.useEffect(()=>{const e=setInterval(()=>{requestAnimationFrame(()=>{n(e=>(e+1)%Be.length)})},6e3);return()=>clearInterval(e)},[]),i.jsxs(Te,{children:[i.jsx(ze,{children:Be.map((e,t)=>i.jsx(Me,{$active:t===a,children:i.jsx("img",{src:e,alt:`KAIF - Слайд ${t+1}`,loading:0===t?"eager":"lazy",decoding:"async",onError:e=>{const i=["https://images.unsplash.com/photo-1544161515-4ab6ce6db874?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=75","https://images.unsplash.com/photo-1600334129128-685c5582fd35?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=75","https://images.unsplash.com/photo-1519823551278-64ac92734fb1?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=75","https://images.unsplash.com/photo-1515377905703-c4788e51af15?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=75"];e.target.src=i[t%i.length]}})},`slide-${t}`))}),i.jsx(Ee,{children:i.jsxs(Ke,{children:[i.jsx(Re,{src:"/assets/images/logo-homepage-Yn4-hFZp.png",alt:"KAIF",initial:De.logo.initial,animate:De.logo.animate,whileHover:{scale:1.02,transition:{duration:.2,ease:"easeOut"}}}),i.jsxs(Oe,{as:S.div,initial:De.buttons.initial,animate:De.buttons.animate,children:[i.jsx(S.div,{whileHover:{scale:1.02,transition:{duration:.15,ease:"easeOut"}},whileTap:{scale:.98},children:i.jsx(qe,{href:"https://wa.me/66624805877?text=Здравствуйте! Хочу записаться в KAIF",target:"_blank",rel:"noopener noreferrer",children:t("common.book")})}),i.jsx(S.div,{onClick:()=>{const e=document.querySelector("#exclusive-zones");e&&e.scrollIntoView({behavior:"smooth",block:"start"})},whileHover:{scale:1.01,transition:{duration:.15,ease:"easeOut"}},whileTap:{scale:.99},children:i.jsx(Le,{children:t("common.learn_more")})})]})]})})]})});We.displayName="HeroFullscreen";const He=A.section`
  position: relative;
  padding: 6rem 0;
  background-color: #ffffff;
  overflow: hidden;
...
`,ri=()=>{const{t}=o(),[a,n]=e.useState("all"),r=e.useMemo(()=>[{id:"fitness",name:t("zones.activity.fitness.name"),description:t("zones.activity.fitness.description"),image:"/images/zones/fitness.jpg",path:"/sports"},{id:"combat",name:t("zones.activity.combat.name"),description:t("zones.activity.combat.description"),image:"/images/zones/combat.jpg",path:"/sports"},{id:"pool",name:t("zones.activity.pool.name"),description:t("zones.activity.pool.description"),image:"/images/zones/pool.jpg",path:"/sports"}],[t]),s=e.useMemo(()=>[{id:"spa",name:t("zones.relax.spa.name"),description:t("zones.relax.spa.description"),image:"/images/zones/spa.jpg",path:"/spa"},{id:"banya",name:t("zones.relax.banya.name"),description:t("zones.relax.banya.description"),image:"/assets/images/hero-luxury-CYZ2FLIl.png",path:"/banya"},{id:"restaurant",name:t("zones.relax.restaurant.name"),description:t("zones.relax.restaurant.description"),image:"/images/zones/restaurant.jpg",path:"/restaurant"}],[t]),l=(e,a)=>e.map((e,n)=>i.jsxs(Xe,{initial:{opacity:0,y:30},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.1,margin:"-50px"},transition:{duration:.6,delay:.05*n},children:[i.jsx(Ze,{src:e.image,alt:e.name}),i.jsxs(ei,{children:[i.jsx(ii,{children:e.name}),i.jsx(ti,{children:e.description}),i.jsxs(ai,{to:e.path,children:[t("common.exploreMore","Подробнее"),i.jsx(g,{})]})]})]},`${a}-${e.id}`)),c=e=>{e!==a&&n(e)};return i.jsx(He,{id:"exclusive-zones",children:i.jsxs($e,{children:[i.jsxs(Ne,{children:[i.jsx(Ve,{initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.2},transition:{duration:.8},children:t("zones.overline","Пространства KAIF")}),i.jsx(Je,{initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.2},transition:{duration:.8,delay:.2},children:t("zones.title","Всё необходимое для активного отдыха и релаксации")})]}),i.jsxs(ni,{children:[i.jsx(oi,{$active:"all"===a,onClick:()=>c("all"),children:t("zones.all","Все зоны")}),i.jsxs(oi,{$active:"activity"===a,onClick:()=>c("activity"),children:[i.jsx(u,{}),t("zones.activity_label","Активити")]}),i.jsxs(oi,{$active:"relax"===a,onClick:()=>c("relax"),children:[i.jsx(h,{}),t("zones.relax_label","Релакс")]})]}),i.jsxs(Ge,{children:[("all"===a||"activity"===a)&&i.jsxs("div",{children:[i.jsx(Ue,{children:i.jsxs(Ye,{children:[i.jsx(u,{}),t("zones.activity_label","Активити")]})}),i.jsx(Qe,{children:l(r,"activity")})]}),("all"===a||"relax"===a)&&i.jsxs("div",{children:[i.jsx(Ue,{children:i.jsxs(Ye,{children:[i.jsx(h,{}),t("zones.relax_label","Релакс")]})}),i.jsx(Qe,{children:l(s,"relax")})]})]})]})})},si=e.lazy(()=>B(()=>import("./AdvantagesSection-DXnb0N-9.js"),__vite__mapDeps([0,1,2,3,4])).then(i=>({default:e.memo(i.default)}))),li=e.lazy(()=>B(()=>import("./GallerySection-Q2GwLumY.js"),__vite__mapDeps([5,1,2,3,4])).then(i=>({default:e.memo(i.GallerySection)}))),ci=e.lazy(()=>B(()=>import("./FAQSection-CsvD04Uz.js"),__vite__mapDeps([6,1,2,3,4])).then(i=>({default:e.memo(i.default)}))),pi=A.div`
  height: 120px;
  display: flex;
  align-items: center;
  justify-content: center;
...
`,ui=e.memo(()=>{const{t}=o(),{showLoading:a}=K(),n=e.useRef(!1);return e.useEffect(()=>{n.current||(n.current=!0,a(1e3))},[]),i.jsxs("main",{children:[i.jsx(Pe,{titleKey:"page_titles.home",description:t("home.hero.subtitle","Unique relaxation and wellness experience in Phuket"),keywords:"KAIF, spa, wellness, Phuket, gym, restaurant, banya, massage",ogImage:"/images/logos/logo-og.png"}),i.jsx(We,{}),i.jsx(ri,{}),i.jsx(e.Suspense,{fallback:i.jsx(pi,{}),children:i.jsx(si,{})}),i.jsx(e.Suspense,{fallback:i.jsx(pi,{}),children:i.jsx(li,{})}),i.jsx(e.Suspense,{fallback:i.jsx(pi,{}),children:i.jsx(ci,{})}),i.jsx(di,{children:i.jsxs(mi,{to:"/contacts",children:[t("common.contact_us"),i.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",children:i.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M17 8l4 4m0 0l-4 4m4-4H3"})})]})})]})});ui.displayName="HomePage";const hi=t.lazy(()=>B(()=>import("./RestaurantPage-6vuP5_qG.js"),__vite__mapDeps([7,1,2,3,8,4,9]))),gi=t.lazy(()=>B(()=>import("./SpaPage-Bg8IxUKS.js"),__vite__mapDeps([10,1,2,3,8,4,9]))),fi=t.lazy(()=>B(()=>import("./SportsPage-BYI6VZd7.js").then(e=>e.d),__vite__mapDeps([11,1,2,3,4,8]))),bi=t.lazy(()=>B(()=>import("./BanyaPage-D4Lk68Ky.js"),__vite__mapDeps([12,1,2,3,8,4,9]))),_i=t.lazy(()=>B(()=>import("./ContactsPage-BjrsLDn_.js"),__vite__mapDeps([13,1,2,3,4,14,8,9]))),yi=t.lazy(()=>B(()=>import("./PrivacyPage-BVPfpogQ.js"),__vite__mapDeps([15,1,2,3,14,4]))),xi=t.lazy(()=>B(()=>import("./TermsPage-CtpibQuX.js"),__vite__mapDeps([16,1,2,3,14,4]))),vi=()=>null,wi=()=>{const t=a();return i.jsx(e.Suspense,{fallback:i.jsx(vi,{}),children:i.jsxs(_,{location:t,children:[i.jsx(y,{path:"/",element:i.jsx(ui,{})}),i.jsx(y,{path:"/restaurant",element:i.jsx(hi,{})}),i.jsx(y,{path:"/spa",element:i.jsx(gi,{})}),i.jsx(y,{path:"/sports",element:i.jsx(fi,{})}),i.jsx(y,{path:"/banya",element:i.jsx(bi,{})}),i.jsx(y,{path:"/contacts",element:i.jsx(_i,{})}),i.jsx(y,{path:"/privacy",element:i.jsx(yi,{})}),i.jsx(y,{path:"/terms",element:i.jsx(xi,{})}),i.jsx(y,{path:"*",element:i.jsx(x,{to:"/",replace:!0})})]})})},ki=()=>{const{isLoading:e,isContentReady:t}=K();return i.jsxs(i.Fragment,{children:[i.jsx($,{isVisible:e}),i.jsx(N,{}),t&&i.jsx("div",{className:"App",children:i.jsx(Se,{children:i.jsx(wi,{})})})]})};function Ai(){const{i18n:a,t:n}=o(),[r,s]=t.useState(0);return e.useEffect(()=>{const e=()=>{s(e=>e+1)};return a.on("languageChanged",e),()=>{a.off("languageChanged",e)}},[a]),e.useEffect(()=>{document.documentElement.dir=a.dir(),document.documentElement.lang=a.language,"KAIF | Jungle Club & Spa"!==document.title&&!document.title.includes("KAIF")&&document.title.includes("|")||(document.title=n("page_titles.home","KAIF | Jungle Club & Spa"))},[a.language,n,r]),i.jsx(f,{children:i.jsxs(F,{theme:Y,children:[i.jsx(T,{}),i.jsx(z,{}),i.jsx(R,{children:i.jsx(b,{basename:"/",children:i.jsx(ki,{})})})]})},`app-${a.language}-${r}`)}console.log=()=>{},console.warn=()=>{},console.info=()=>{},"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("/sw.js").then(e=>{e.addEventListener("updatefound",()=>{const i=e.installing;i.addEventListener("statechange",()=>{"installed"===i.state&&navigator.serviceWorker.controller})})}).catch(e=>{})}),v.createRoot(document.getElementById("root")).render(i.jsx(Ai,{}));export{Pe as P,B as _,Ie as h};
