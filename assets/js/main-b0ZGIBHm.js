const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/js/AdvantagesSection-BJdd5Unk.js","assets/js/vendor-react-DNm9nmuF.js","assets/js/vendor-other-CZupzcPt.js","assets/js/vendor-styles-CvOjvN1-.js","assets/js/vendor-animations-BiVsbNIQ.js","assets/js/GallerySection-BKwQxo-s.js","assets/js/FAQSection-GfjlBrly.js","assets/js/RestaurantPage-CSe_kWFC.js","assets/js/PageScrollReset-8PFAINiq.js","assets/js/vendor-i18n-C4kh69yx.js","assets/js/SpaPage-B5IgbiuD.js","assets/js/SportsPage-WpTKhMid.js","assets/js/BanyaPage-BIPZ2o4U.js","assets/js/ContactsPage-DakDAWNw.js","assets/js/CommonComponents-Ck5sg9UK.js","assets/js/PrivacyPage-BQ0-LzVu.js","assets/js/TermsPage-DVFzXtlm.js","assets/js/SurveyPage-CdfPKXnG.js"])))=>i.map(i=>d[i]);
import{r as e,j as i,R as t,u as a,i as n,a as r,b as o,F as s,c as l,d as c,L as p,H as d,C as m,e as u,f as h,g,h as f,k as b,l as y,m as _,n as x,o as w,p as v,q as k,B as A,s as C,t as F,N as j,v as S}from"./vendor-react-DNm9nmuF.js";import{f as P,m as B,d as I,o as T}from"./vendor-styles-CvOjvN1-.js";import{i as M,B as z}from"./vendor-i18n-C4kh69yx.js";import{m as K,A as E}from"./vendor-animations-BiVsbNIQ.js";import"./vendor-other-CZupzcPt.js";!function(){const e=document.createElement("link").relList;if(!(e&&e.supports&&e.supports("modulepreload"))){for(const e of document.querySelectorAll('link[rel="modulepreload"]'))i(e);new MutationObserver(e=>{for(const t of e)if("childList"===t.type)for(const e of t.addedNodes)"LINK"===e.tagName&&"modulepreload"===e.rel&&i(e)}).observe(document,{childList:!0,subtree:!0})}function i(e){if(e.ep)return;e.ep=!0;const i=function(e){const i={};return e.integrity&&(i.integrity=e.integrity),e.referrerPolicy&&(i.referrerPolicy=e.referrerPolicy),"use-credentials"===e.crossOrigin?i.credentials="include":"anonymous"===e.crossOrigin?i.credentials="omit":i.credentials="same-origin",i}(e);fetch(e.href,i)}}();const R={},q=function(e,i,t){let a=Promise.resolve();if(i&&i.length>0){let e=function(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:"fulfilled",value:e}),e=>({status:"rejected",reason:e}))))};document.getElementsByTagName("link");const t=document.querySelector("meta[property=csp-nonce]"),n=(null==t?void 0:t.nonce)||(null==t?void 0:t.getAttribute("nonce"));a=e(i.map(e=>{if((e=function(e){return"/"+e}(e))in R)return;R[e]=!0;const i=e.endsWith(".css"),t=i?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${e}"]${t}`))return;const a=document.createElement("link");return a.rel=i?"stylesheet":"modulepreload",i||(a.as="script"),a.crossOrigin="",a.href=e,n&&a.setAttribute("nonce",n),document.head.appendChild(a),i?new Promise((i,t)=>{a.addEventListener("load",i),a.addEventListener("error",()=>t(new Error(`Unable to preload CSS for ${e}`)))}):void 0}))}function n(e){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=e,window.dispatchEvent(i),!i.defaultPrevented)throw e}return a.then(i=>{for(const e of i||[])"rejected"===e.status&&n(e.reason);return e().catch(n)})},D=P`
...
`,$=e.createContext();let O=!1;const W=()=>e.useContext($),H=({children:t})=>{const[a,n]=e.useState(!1),[r,o]=e.useState(!0),s=e.useRef(!1),l=e.useRef(!1);return i.jsx($.Provider,{value:{isLoading:a,isContentReady:r,showLoading:(e=1e3)=>s.current||l.current||O?Promise.resolve():(O=!0,s.current=!0,l.current=!0,o(!1),n(!0),new Promise(i=>{setTimeout(()=>{n(!1),setTimeout(()=>{o(!0),s.current=!1,i()},200)},e)})),showContentDirectly:()=>{l.current=!0,n(!1),o(!0),s.current=!1},resetLoading:()=>{l.current=!1,s.current=!1,n(!1),o(!0)}},children:t})},N=B`
  from { opacity: 0; }
  to { opacity: 1; }
`,V=B`
  from { opacity: 1; }
...
`,U=I.div`
  ...
  &.exiting {
    animation: ${V} 0.3s ease-in forwards;
  }
...
`,J=I.img`
  ...
  /* Упрощенная анимация */
  animation: ${G} 0.6s ease-out 0.1s both;
...
`,ve=()=>{const{t:e}=r(),t={hidden:{opacity:0,y:30},visible:{opacity:1,y:0,transition:{duration:.6,ease:[.25,.46,.45,.94]}}},a={animate:{y:[0,-15,0],transition:{duration:12,repeat:1/0,ease:"easeInOut",repeatType:"mirror"}}},n=(new Date).getFullYear(),o=[{path:"/",label:e("navigation.home"),id:"home"},{path:"/restaurant",label:e("navigation.restaurant"),id:"restaurant"},{path:"/spa",label:e("navigation.spa"),id:"spa"},{path:"/sports",label:e("navigation.sports"),id:"sports-main"},{path:"/contacts",label:e("navigation.contacts"),id:"contacts"}],d=[{path:"/spa",label:e("footer.services.sauna"),id:"spa-sauna"},{path:"/restaurant",label:e("navigation.restaurant"),id:"restaurant"},{path:"/sports",label:e("footer.services.fitness"),id:"sports-fitness"},{path:"/banya",label:e("navigation.banya"),id:"banya"},{path:"/sports",label:e("footer.services.fight_club"),id:"sports-club"}];return i.jsxs(ne,{children:[i.jsx(we,{className:"deco-1",$variant:"primary",variants:a,animate:"animate"}),i.jsx(we,{className:"deco-2",$variant:"secondary",variants:a,animate:"animate",style:{animationDelay:"-4s"}}),i.jsx(we,{className:"deco-3",$variant:"tertiary",variants:a,animate:"animate",style:{animationDelay:"-8s"}}),i.jsx(re,{children:i.jsxs(K.div,{variants:{hidden:{opacity:0},visible:{opacity:1,transition:{duration:.8,staggerChildren:.2}}},initial:"hidden",whileInView:"visible",viewport:{once:!0,amount:.3},children:[i.jsxs(oe,{children:[i.jsxs(se,{variants:t,children:[i.jsx(le,{whileHover:{scale:1.05,transition:{duration:.3,ease:"easeOut"}},children:i.jsxs("picture",{children:[i.jsx("source",{srcSet:"/images/logos/logo-footer-2x.webp 2x, /images/logos/logo-footer-1x.webp 1x",type:"image/webp"}),i.jsx("source",{srcSet:"/images/logos/logo-footer-2x.png 2x, /images/logos/logo-footer-1x.png 1x",type:"image/png"}),i.jsx("img",{src:"/images/logos/logo-footer-1x.png",alt:"KAIF",style:{width:"100%",height:"auto",maxWidth:"360px",filter:"brightness(1.2) contrast(1.1)",imageRendering:"crisp-edges"},loading:"lazy"})]})}),i.jsx(ce,{children:e("footer.brand.description")}),i.jsxs(pe,{children:[i.jsx(de,{href:"https://www.instagram.com/kaif.phuket/",target:"_blank",rel:"noopener noreferrer",whileHover:{scale:1.1,transition:{duration:.3,ease:"easeOut"}},whileTap:{scale:.95},children:i.jsx("svg",{fill:"currentColor",viewBox:"0 0 24 24",children:i.jsx("path",{d:"M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"})})}),i.jsx(de,{href:"https://web.facebook.com/kaifphuketfb?mibextid=LQQJ4d&_rdc=1&_rdr#",target:"_blank",rel:"noopener noreferrer",whileHover:{scale:1.1,transition:{duration:.3,ease:"easeOut"}},whileTap:{scale:.95},children:i.jsx("svg",{fill:"currentColor",viewBox:"0 0 24 24",children:i.jsx("path",{d:"M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"})})}),i.jsx(de,{href:"https://t.me/kaifphuketchat",target:"_blank",rel:"noopener noreferrer",whileHover:{scale:1.1,transition:{duration:.3,ease:"easeOut"}},whileTap:{scale:.95},children:i.jsx("svg",{fill:"currentColor",viewBox:"0 0 24 24",children:i.jsx("path",{d:"m20.665 3.717-17.73 6.837c-1.21.486-1.203 1.161-.222 1.462l4.552 1.42 10.532-6.645c.498-.303.953-.14.579.192l-8.533 7.701h-.002l.002.001-.314 4.692c.46 0 .663-.211.921-.46l2.211-2.15 4.599 3.397c.848.467 1.457.227 1.668-.789l3.019-14.228c.309-1.239-.473-1.8-1.282-1.434z"})})}),i.jsx(de,{href:"https://www.youtube.com/@KaifPhuket",target:"_blank",rel:"noopener noreferrer",whileHover:{scale:1.1,transition:{duration:.3,ease:"easeOut"}},whileTap:{scale:.95},children:i.jsx("svg",{fill:"currentColor",viewBox:"0 0 24 24",children:i.jsx("path",{d:"M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"})})}),i.jsx(de,{href:"https://api.whatsapp.com/send/?phone=66624805877&text&type=phone_number&app_absent=0",target:"_blank",rel:"noopener noreferrer",whileHover:{scale:1.1,transition:{duration:.3,ease:"easeOut"}},whileTap:{scale:.95},children:i.jsx("svg",{fill:"currentColor",viewBox:"0 0 24 24",width:"16",height:"16",children:i.jsx("path",{d:"M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893A11.821 11.821 0 0020.885 3.488z"})})})]})]}),i.jsxs(me,{variants:t,children:[i.jsx(ue,{children:e("footer.navigation")}),o.map(e=>i.jsx(he,{to:e.path,children:e.label},e.id))]}),i.jsxs(me,{variants:t,children:[i.jsx(ue,{children:e("footer.services.title")}),d.map(e=>i.jsx(he,{to:e.path,children:e.label},e.id))]}),i.jsxs(me,{variants:t,children:[i.jsx(ue,{children:e("navigation.contacts")}),i.jsxs(ge,{children:[i.jsx(s,{}),i.jsxs(fe,{children:["73, Baan Chalekiri Village,",i.jsx("br",{}),"6 Pra Phuket Keaw Road, Kathu"]})]}),i.jsxs(ge,{children:[i.jsx(l,{}),i.jsx(fe,{children:i.jsx(be,{href:"tel:+66624805877",children:"+66 62 480 5877"})})]}),i.jsxs(ge,{children:[i.jsx(c,{}),i.jsxs(fe,{children:[e("footer.schedule.daily"),i.jsx("br",{}),e("footer.schedule.hours")]})]})]})]}),i.jsxs(ye,{children:[i.jsxs(_e,{children:["© ",n," ",i.jsx("span",{className:"highlight",children:"KAIF"}),".",e("footer.copyright")]}),i.jsxs(xe,{children:[i.jsx(p,{to:"/privacy",children:e("footer.legal.privacy")}),i.jsx(p,{to:"/terms",children:e("footer.legal.terms")})]})]})]})})]})},ke=I.div`
  min-height: 100vh;
  width: 100%;
  position: relative;
  z-index: 1;
...
`,Ce=({children:t})=>{const n=a(),[r,o]=e.useState(!0),s=e.useRef(!0),{isLoading:l}=W();return e.useEffect(()=>{if(s.current)return s.current=!1,void o(!0);o(!1),window.scrollTo(0,0);const e=setTimeout(()=>{o(!0)},500);return()=>clearTimeout(e)},[n.pathname]),i.jsxs(i.Fragment,{children:[i.jsx(L,{}),i.jsx(X,{isVisible:!r&&!l}),i.jsx(ae,{}),i.jsxs(ke,{children:[i.jsx(Ae,{children:t}),r&&i.jsx(ve,{})]})]})},Fe=({titleKey:t="page_titles.home",defaultTitle:a="KAIF | Sauna & Spa",description:n,keywords:o,ogImage:s,pageType:l="website"})=>{const{t:c,i18n:p}=r(),m=c(t,a);return e.useEffect(()=>{document.title=m},[m,p.language]),i.jsxs(d,{children:[i.jsx("title",{children:m}),n&&i.jsx("meta",{name:"description",content:n}),o&&i.jsx("meta",{name:"keywords",content:o}),i.jsx("meta",{property:"og:title",content:m}),n&&i.jsx("meta",{property:"og:description",content:n}),i.jsx("meta",{property:"og:type",content:l}),s&&i.jsx("meta",{property:"og:image",content:s}),i.jsx("meta",{name:"twitter:title",content:m}),n&&i.jsx("meta",{name:"twitter:description",content:n}),i.jsx("meta",{name:"twitter:card",content:"summary_large_image"}),s&&i.jsx("meta",{name:"twitter:image",content:s}),i.jsx("link",{rel:"shortcut icon",type:"image/png",href:"/favicon.png"}),i.jsx("link",{rel:"icon",type:"image/png",href:"/favicon.png"}),i.jsx("meta",{name:"theme-color",content:"#2C614F"})]})},je=[{webp:"/assets/images/hero-spa-BxKtg4BM.webp",fallback:"/assets/images/hero-spa-DzcKzQht.jpg"},{webp:"/assets/images/hero-pool-CQHc_GLI.webp",fallback:"/assets/images/hero-pool-TKmiOsKg.jpg"},{webp:"/assets/images/hero-restaurant-Cmj9XTuP.webp",fallback:"/assets/images/hero-restaurant-S294Smzf.jpg"},{webp:"/assets/images/hero-fitness-DxSVtagD.webp",fallback:"/assets/images/hero-fitness-rdWcIHF3.jpg"}],Se=I.section`
  position: relative;
  width: 100%;
  min-height: 100vh;
  height: auto;
...
`,Re={logo:{initial:{scale:.95,opacity:0},animate:{scale:1,opacity:1,transition:{duration:.8,ease:"easeOut",delay:.2}}},buttons:{initial:{opacity:0,y:15},animate:{opacity:1,y:0,transition:{duration:.5,ease:"easeOut",delay:.6}}}},qe=e.memo(()=>{const{t}=r(),[a,n]=e.useState(0);return e.useEffect(()=>{const e=setInterval(()=>{requestAnimationFrame(()=>{n(e=>(e+1)%je.length)})},6e3);return()=>clearInterval(e)},[]),i.jsxs(Se,{children:[i.jsx(Pe,{children:je.map((e,t)=>i.jsx(Be,{$active:t===a,children:i.jsxs("picture",{children:[i.jsx("source",{srcSet:e.webp,type:"image/webp"}),i.jsx("img",{src:e.fallback,alt:`KAIF - Слайд ${t+1}`,loading:0===t?"eager":"lazy",decoding:"async",onError:e=>{const i=["https://images.unsplash.com/photo-1544161515-4ab6ce6db874?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=75","https://images.unsplash.com/photo-1600334129128-685c5582fd35?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=75","https://images.unsplash.com/photo-1519823551278-64ac92734fb1?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=75","https://images.unsplash.com/photo-1515377905703-c4788e51af15?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=75"];e.target.src=i[t%i.length]}})]})},`slide-${t}`))}),i.jsx(Ie,{children:i.jsxs(Te,{children:[i.jsxs("picture",{style:{display:"block"},children:[i.jsx("source",{srcSet:"/assets/images/logo-homepage-Bvg3zKLL.webp",type:"image/webp"}),i.jsx(Me,{src:"/assets/images/logo-homepage-H1DZjSiR.png",alt:"KAIF",initial:Re.logo.initial,animate:Re.logo.animate,whileHover:{scale:1.02,transition:{duration:.2,ease:"easeOut"}}})]}),i.jsxs(Ee,{as:K.div,initial:Re.buttons.initial,animate:Re.buttons.animate,children:[i.jsx(K.div,{whileHover:{scale:1.02,transition:{duration:.15,ease:"easeOut"}},whileTap:{scale:.98},children:i.jsx(ze,{href:"https://wa.me/66624805877?text=Здравствуйте! Хочу записаться в KAIF",target:"_blank",rel:"noopener noreferrer",children:t("common.book")})}),i.jsx(K.div,{onClick:()=>{const e=document.querySelector("#exclusive-zones");e&&e.scrollIntoView({behavior:"smooth",block:"start"})},whileHover:{scale:1.01,transition:{duration:.15,ease:"easeOut"}},whileTap:{scale:.99},children:i.jsx(Ke,{children:t("common.learn_more")})})]})]})})]})});qe.displayName="HeroFullscreen";const De=[{id:"monday",dayOfWeek:"Monday",dayIndex:1,title:"Double KAIF",subtitle:"1+1 Day Pass",description:'Come with a friend, pay only for one! Applies only to "Day pass" tickets for area of complex',image:"/images/promotions/monday.png",color:"#FFD700"},{id:"tuesday",dayOfWeek:"Tuesday",dayIndex:2,title:"KAIF Plus",subtitle:"Sauna + Massage Gift",description:"When you purchase a sauna subscription for 1 month, you will receive a Thai oil massage as a gift",image:"/images/promotions/tuesday.png",color:"#FF6B6B"},{id:"wednesday",dayOfWeek:"Wednesday",dayIndex:3,title:"KAIF for Subscribers",subtitle:"Member Exclusive",description:"Exclusive for subscription holders: massage -50% for club members",image:"/images/promotions/wednesday.png",color:"#4ECDC4"},{id:"thursday",dayOfWeek:"Thursday",dayIndex:4,title:"Private Steaming",subtitle:"Half Price Sessions",description:"Individual steaming sessions with brooms -50% for everyone",image:"/images/promotions/thursday.png",color:"#95E1D3"},{id:"friday",dayOfWeek:"Friday",dayIndex:5,title:"Lady KAIF",subtitle:"Ladies Free Until 16:00",description:"Admission for ladies is free until 16:00",image:"/images/promotions/friday.png",color:"#F38181"}],Le=()=>{const[t,a]=e.useState(0),[n,r]=e.useState(0),[o,s]=e.useState(0),l=e.useRef(null),c=(()=>{const e=(new Date).getDay();return 0===e?7:e})();return e.useEffect(()=>{const e=De.findIndex(e=>e.dayIndex===c);-1!==e&&(a(e),window.innerWidth<1024&&l.current&&setTimeout(()=>{var i;const t=e*(.85*window.innerWidth);null==(i=l.current)||i.scrollTo({left:t,behavior:"smooth"})},100))},[c]),i.jsx("section",{className:"py-16 lg:py-20 bg-gradient-to-b from-gray-50 to-white",children:i.jsxs("div",{className:"container mx-auto px-4",children:[i.jsxs("div",{className:"text-center mb-10 lg:mb-12",children:[i.jsx("h2",{className:"text-3xl lg:text-4xl font-bold text-gray-900 mb-4",children:"Weekly Promotions"}),i.jsx("p",{className:"text-lg text-gray-600",children:"Special offers every day of the week"})]}),i.jsx("div",{className:"hidden lg:grid lg:grid-cols-5 gap-4 max-w-7xl mx-auto",children:De.map(e=>i.jsxs("div",{className:"group relative overflow-hidden rounded-xl shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-2xl "+(e.dayIndex===c?"ring-4 ring-opacity-50":""),style:{aspectRatio:"9/16",...e.dayIndex===c?{"--tw-ring-color":"#90B3A7"}:{}},children:[i.jsx("img",{src:e.image,alt:e.dayOfWeek,className:"absolute inset-0 w-full h-full object-cover",style:{display:"block"}}),e.dayIndex===c&&i.jsx("div",{className:"absolute top-4 right-4 px-3 py-1 text-white rounded-full text-xs font-bold animate-pulse shadow-lg z-10",style:{backgroundColor:"#90B3A7"},children:"TODAY"})]},e.id))}),i.jsxs("div",{className:"lg:hidden",children:[i.jsxs("div",{className:"relative px-12",children:[i.jsx("div",{ref:l,className:"overflow-hidden relative",onTouchStart:e=>{r(e.targetTouches[0].clientX),s(0)},onTouchMove:e=>{s(e.targetTouches[0].clientX)},onTouchEnd:()=>{if(!n||!o)return;const e=n-o,i=e<-50;e>50&&t<De.length-1&&a(t+1),i&&t>0&&a(t-1),r(0),s(0)},children:i.jsx("div",{className:"flex transition-transform duration-300 ease-in-out",style:{transform:`translateX(-${100*t}%)`},children:De.map(e=>i.jsx("div",{className:"w-full flex-shrink-0 px-2",children:i.jsxs("div",{className:"relative overflow-hidden rounded-xl shadow-xl "+(e.dayIndex===c?"ring-4 ring-opacity-50":""),style:{aspectRatio:"9/16",...e.dayIndex===c?{"--tw-ring-color":"#90B3A7"}:{}},children:[i.jsx("img",{src:e.image,alt:e.dayOfWeek,className:"absolute inset-0 w-full h-full object-cover pointer-events-none select-none",style:{display:"block"},draggable:!1}),e.dayIndex===c&&i.jsx("div",{className:"absolute top-4 right-4 px-3 py-1 text-white rounded-full text-sm font-bold animate-pulse shadow-lg z-10 pointer-events-none",style:{backgroundColor:"#90B3A7"},children:"TODAY"})]})},e.id))})}),i.jsxs("div",{className:"absolute inset-0 pointer-events-none",children:[i.jsx("button",{onClick:()=>{a(e=>Math.max(0,e-1))},className:"absolute left-0 top-1/2 -translate-y-1/2 z-20 p-2 bg-white/90 rounded-full shadow-lg transition-opacity pointer-events-auto "+(0===t?"opacity-50 cursor-not-allowed":"opacity-100"),disabled:0===t,children:i.jsx(m,{className:"w-6 h-6 text-gray-800"})}),i.jsx("button",{onClick:()=>{a(e=>Math.min(De.length-1,e+1))},className:"absolute right-0 top-1/2 -translate-y-1/2 z-20 p-2 bg-white/90 rounded-full shadow-lg transition-opacity pointer-events-auto "+(t===De.length-1?"opacity-50 cursor-not-allowed":"opacity-100"),disabled:t===De.length-1,children:i.jsx(u,{className:"w-6 h-6 text-gray-800"})})]})]}),i.jsx("div",{className:"flex justify-center mt-6 gap-2",children:De.map((e,n)=>i.jsx("button",{onClick:()=>a(n),className:"h-2 rounded-full transition-all duration-300 "+(n===t?"w-8":"w-2 bg-gray-300 hover:bg-gray-400"),style:n===t?{backgroundColor:"#90B3A7"}:{}},n))})]})]})})},$e=I.section`
  position: relative;
  padding: 6rem 0;
  background-color: #ffffff;
  overflow: hidden;
...
`,ni=()=>{const{t}=r(),[a,n]=e.useState("all"),o=e.useMemo(()=>[{id:"fitness",name:t("zones.activity.fitness.name"),description:t("zones.activity.fitness.description"),image:"/images/zones/fitness.jpg",path:"/sports"},{id:"combat",name:t("zones.activity.combat.name"),description:t("zones.activity.combat.description"),image:"/images/zones/combat.jpg",path:"/sports"},{id:"pool",name:t("zones.activity.pool.name"),description:t("zones.activity.pool.description"),image:"/images/zones/pool.jpg",path:"/sports"}],[t]),s=e.useMemo(()=>[{id:"spa",name:t("zones.relax.spa.name"),description:t("zones.relax.spa.description"),image:"/images/zones/spa.jpg",path:"/spa"},{id:"banya",name:t("zones.relax.banya.name"),description:t("zones.relax.banya.description"),image:"/assets/images/hero-luxury-CYZ2FLIl.png",path:"/banya"},{id:"restaurant",name:t("zones.relax.restaurant.name"),description:t("zones.relax.restaurant.description"),image:"/images/zones/restaurant.jpg",path:"/restaurant"}],[t]),l=(e,a)=>e.map((e,n)=>i.jsxs(Je,{initial:{opacity:0,y:30},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.1,margin:"-50px"},transition:{duration:.6,delay:.05*n},children:[i.jsx(Xe,{src:e.image,alt:e.name}),i.jsxs(Qe,{children:[i.jsx(Ze,{children:e.name}),i.jsx(ei,{children:e.description}),i.jsxs(ii,{to:e.path,children:[t("common.exploreMore","Подробнее"),i.jsx(f,{})]})]})]},`${a}-${e.id}`)),c=e=>{e!==a&&n(e)};return i.jsx($e,{id:"exclusive-zones",children:i.jsxs(Oe,{children:[i.jsxs(We,{children:[i.jsx(He,{initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.2},transition:{duration:.8},children:t("zones.overline","Пространства KAIF")}),i.jsx(Ne,{initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.2},transition:{duration:.8,delay:.2},children:t("zones.title","Всё необходимое для активного отдыха и релаксации")})]}),i.jsxs(ti,{children:[i.jsx(ai,{$active:"all"===a,onClick:()=>c("all"),children:t("zones.all","Все зоны")}),i.jsxs(ai,{$active:"activity"===a,onClick:()=>c("activity"),children:[i.jsx(h,{}),t("zones.activity_label","Активити")]}),i.jsxs(ai,{$active:"relax"===a,onClick:()=>c("relax"),children:[i.jsx(g,{}),t("zones.relax_label","Релакс")]})]}),i.jsxs(Ve,{children:[("all"===a||"activity"===a)&&i.jsxs("div",{children:[i.jsx(Ge,{children:i.jsxs(Ue,{children:[i.jsx(h,{}),t("zones.activity_label","Активити")]})}),i.jsx(Ye,{children:l(o,"activity")})]}),("all"===a||"relax"===a)&&i.jsxs("div",{children:[i.jsx(Ge,{children:i.jsxs(Ue,{children:[i.jsx(g,{}),t("zones.relax_label","Релакс")]})}),i.jsx(Ye,{children:l(s,"relax")})]})]})]})})},ri=I.section`
  padding: 5rem 2rem;
...
`,ki=()=>{const{t}=r(),[a,n]=e.useState("dayPass"),o={dayPass:{icon:i.jsx(b,{}),title:t("pricing.categories.dayPass"),subtitle:t("pricing.subtitles.dayPass"),plans:[{name:t("pricing.durations.morning")+" Pass",duration:t("pricing.features.morningAccess"),price:"390",features:[t("pricing.features.gymCardio"),t("pricing.features.swimmingPool"),t("pricing.features.steamRoom"),t("pricing.features.iceBarrel"),t("pricing.features.russianSauna")+" & "+t("pricing.features.japanesePool"),t("pricing.features.saunaAfter14")],perMonth:null},{name:"Day Pass",duration:t("pricing.durations.fullDay"),price:"490",features:[t("pricing.features.gymCardio"),t("pricing.features.swimmingPool"),t("pricing.features.steamRoom"),t("pricing.features.iceBarrel"),t("pricing.features.russianSauna")+" & "+t("pricing.features.japanesePool"),t("pricing.features.towelsIncluded")],perMonth:null},{name:t("pricing.categories.groupClasses"),duration:t("pricing.durations.single"),price:"600",features:[t("pricing.features.dayAccess"),t("pricing.features.anyClass"),t("pricing.features.professionalTrainer")],perMonth:null}]},clubAccess:{icon:i.jsx(y,{}),title:"Club Access",subtitle:t("pricing.subtitles.withoutBanya"),plans:[{name:"Club Access",duration:t("pricing.durations.month"),price:"2,000",features:[t("pricing.features.gymCardio"),t("pricing.features.swimmingPool"),t("pricing.features.steamRoom"),t("pricing.features.iceBarrel")],perMonth:null},{name:"Club Access",duration:t("pricing.durations.months_3"),price:"4,800",features:[t("pricing.features.gymCardio"),t("pricing.features.swimmingPool"),t("pricing.features.steamRoom"),t("pricing.features.iceBarrel"),`${t("pricing.features.savings")} 20%`],perMonth:"1,600 ฿/мес",featured:!0,popular:!0},{name:"Club Access",duration:t("pricing.durations.months_6"),price:"9,900",features:[t("pricing.features.gymCardio"),t("pricing.features.swimmingPool"),t("pricing.features.steamRoom"),t("pricing.features.iceBarrel"),`${t("pricing.features.savings")} 17%`],perMonth:"1,650 ฿/мес"},{name:"Club Access",duration:t("pricing.durations.months_12"),price:"18,000",features:[t("pricing.features.gymCardio"),t("pricing.features.swimmingPool"),t("pricing.features.steamRoom"),t("pricing.features.iceBarrel"),`${t("pricing.features.maxSavings")} 25%`],perMonth:"1,500 ฿/мес"}]},premium:{icon:i.jsx(_,{}),title:"Club Access+",subtitle:t("pricing.subtitles.allPlusBanya"),plans:[{name:"Club Access+",duration:t("pricing.durations.day"),price:"490",features:[t("pricing.features.gymCardio"),t("pricing.features.swimmingPool"),t("pricing.features.steamRoom"),t("pricing.features.iceBarrel"),t("pricing.features.russianSauna")+" & "+t("pricing.features.japanesePool"),t("pricing.features.lockersAndShowers")],perMonth:null},{name:"Club Access+",duration:t("pricing.durations.month"),price:"3,800",features:[t("pricing.features.unlimitedAccess"),t("pricing.features.gymAndBanya"),t("pricing.features.swimmingPool"),t("pricing.features.towelsIncluded")],perMonth:null},{name:"Club Access+",duration:t("pricing.durations.months_3"),price:"9,400",features:[t("pricing.features.unlimitedAccess"),t("pricing.features.gymAndBanya"),t("pricing.features.towelsIncluded"),`${t("pricing.features.savings")} 18%`],perMonth:"3,133 ฿/мес",featured:!0,popular:!0},{name:"Club Access+",duration:t("pricing.durations.months_6"),price:"17,800",features:[t("pricing.features.unlimitedAccess"),t("pricing.features.gymAndBanya"),t("pricing.features.towelsIncluded"),`${t("pricing.features.savings")} 22%`],perMonth:"2,967 ฿/мес"},{name:"Club Access+",duration:t("pricing.durations.months_12"),price:"29,000",features:[t("pricing.features.unlimitedAccess"),t("pricing.features.gymAndBanya"),t("pricing.features.towelsIncluded"),`${t("pricing.features.maxSavings")} 36%`],perMonth:"2,417 ฿/мес"}]},groupClasses:{icon:i.jsx(x,{}),title:t("pricing.categories.groupClasses"),subtitle:t("pricing.subtitles.groupClasses"),plans:[{name:t("pricing.categories.groupClasses"),duration:t("pricing.durations.single"),price:"600",features:[t("pricing.features.dayAccess"),t("pricing.features.anyClass"),t("pricing.features.professionalTrainer")],perMonth:null},{name:t("pricing.categories.groupClasses"),duration:t("pricing.durations.classes_4"),price:"2,000",features:[`500 ฿ ${t("pricing.features.perClass")}`,t("pricing.features.validMonth"),t("pricing.features.anyClasses")],perMonth:null},{name:t("pricing.categories.groupClasses"),duration:t("pricing.durations.classes_12"),price:"3,000",features:[`250 ฿ ${t("pricing.features.perClass")}`,t("pricing.features.validMonths_2"),t("pricing.features.anyClasses"),`${t("pricing.features.savings")} 50%`],perMonth:null,featured:!0,popular:!0},{name:t("pricing.categories.groupClasses"),duration:t("pricing.durations.classes_24"),price:"5,500",features:[`229 ฿ ${t("pricing.features.perClass")}`,t("pricing.features.validMonths_3"),t("pricing.features.anyClasses"),`${t("pricing.features.savings")} 62%`],perMonth:null},{name:t("pricing.categories.groupClasses"),duration:t("pricing.durations.classes_48"),price:"10,200",features:[`213 ฿ ${t("pricing.features.perClass")}`,t("pricing.features.validMonths_6"),t("pricing.features.anyClasses"),`${t("pricing.features.maxSavings")} 65%`],perMonth:null}]},swimming:{icon:i.jsx(w,{}),title:t("pricing.categories.swimming"),subtitle:t("pricing.subtitles.swimmingSchool"),plans:[{name:t("pricing.categories.swimming"),duration:t("pricing.durations.single"),price:"800",features:[t("pricing.features.dayAccess"),t("pricing.features.individualApproach"),t("pricing.features.certifiedInstructor")],perMonth:null},{name:t("pricing.categories.swimming"),duration:t("pricing.durations.classes_8"),price:"3,800",features:[`475 ฿ ${t("pricing.features.perClass")}`,t("pricing.features.validMonths_2"),t("pricing.features.trainingProgram"),`${t("pricing.features.savings")} 41%`],perMonth:null,featured:!0,popular:!0},{name:t("pricing.categories.swimming"),duration:t("pricing.durations.classes_12"),price:"5,500",features:[`458 ฿ ${t("pricing.features.perClass")}`,t("pricing.features.validMonths_3"),t("pricing.features.fullProgram"),`${t("pricing.features.savings")} 43%`],perMonth:null}]}},s=[{key:"dayPass",label:t("pricing.categories.dayPass"),icon:i.jsx(b,{})},{key:"clubAccess",label:t("pricing.categories.clubAccess"),icon:i.jsx(y,{})},{key:"premium",label:t("pricing.categories.clubAccessPlus"),icon:i.jsx(_,{})},{key:"groupClasses",label:t("pricing.categories.groupClasses"),icon:i.jsx(x,{})},{key:"swimming",label:t("pricing.categories.swimming"),icon:i.jsx(w,{})}],l=o[a];return i.jsx(ri,{id:"pricing",children:i.jsxs(oi,{children:[i.jsxs(si,{children:[i.jsx(li,{initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},transition:{duration:.6},viewport:{once:!0},children:t("pricing.title")}),i.jsx(ci,{initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},transition:{duration:.6,delay:.1},viewport:{once:!0},children:t("pricing.subtitle")})]}),i.jsx(pi,{children:s.map(e=>i.jsxs(di,{$active:a===e.key,$categoryKey:e.key,onClick:()=>(e=>{const i=window.scrollY;n(e),setTimeout(()=>{window.scrollTo(0,i)},0)})(e.key),whileHover:{scale:1.05},whileTap:{scale:.95},children:[e.icon,e.label]},e.key))}),i.jsx(wi,{children:i.jsx(mi,{children:l.plans.map((e,n)=>i.jsxs(ui,{$featured:e.featured,$category:a,children:[i.jsxs(hi,{$category:a,children:[i.jsx(gi,{children:e.name}),i.jsx(fi,{children:e.duration})]}),i.jsx(bi,{children:i.jsxs(yi,{children:[e.price," ",i.jsx("span",{children:"฿"})]})}),i.jsx(_i,{children:e.features.map((t,n)=>i.jsxs(xi,{$category:a,$compact:e.features.length>5,$noBorder:n===e.features.length-1,children:[i.jsx(v,{}),t]},n))}),i.jsx(vi,{href:"https://wa.me/66624805877?text=Здравствуйте! Хочу приобрести абонемент",target:"_blank",rel:"noopener noreferrer",$category:a,whileHover:{scale:1.02},whileTap:{scale:.98},children:t("pricing.select_plan")})]},`${a}-${n}`))},a)})]})})},Ai=e.lazy(()=>q(()=>import("./AdvantagesSection-BJdd5Unk.js"),__vite__mapDeps([0,1,2,3,4])).then(i=>({default:e.memo(i.default)}))),Ci=e.lazy(()=>q(()=>import("./GallerySection-BKwQxo-s.js"),__vite__mapDeps([5,1,2,3,4])).then(i=>({default:e.memo(i.GallerySection)}))),Fi=e.lazy(()=>q(()=>import("./FAQSection-GfjlBrly.js"),__vite__mapDeps([6,1,2,3,4])).then(i=>({default:e.memo(i.default)}))),ji=I.div`
  height: 120px;
  display: flex;
  align-items: center;
  justify-content: center;
...
`,Bi=e.memo(()=>{const{t}=r(),{showLoading:a}=W(),n=e.useRef(!1);return e.useEffect(()=>{n.current||(n.current=!0,a(1e3))},[]),i.jsxs("main",{children:[i.jsx(Fe,{titleKey:"page_titles.home",description:t("home.hero.subtitle","Unique relaxation and wellness experience in Phuket"),keywords:"KAIF, spa, wellness, Phuket, gym, restaurant, banya, massage",ogImage:"/images/logos/logo-og.png"}),i.jsx(qe,{}),i.jsx(Le,{}),i.jsx(ni,{}),i.jsx(ki,{}),i.jsx(e.Suspense,{fallback:i.jsx(ji,{}),children:i.jsx(Ai,{})}),i.jsx(e.Suspense,{fallback:i.jsx(ji,{}),children:i.jsx(Ci,{})}),i.jsx(e.Suspense,{fallback:i.jsx(ji,{}),children:i.jsx(Fi,{})}),i.jsx(Si,{children:i.jsxs(Pi,{to:"/contacts",children:[t("common.contact_us"),i.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",children:i.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M17 8l4 4m0 0l-4 4m4-4H3"})})]})})]})});Bi.displayName="HomePage";const Ii=t.lazy(()=>q(()=>import("./RestaurantPage-CSe_kWFC.js"),__vite__mapDeps([7,1,2,3,8,4,9]))),Ti=t.lazy(()=>q(()=>import("./SpaPage-B5IgbiuD.js"),__vite__mapDeps([10,1,2,3,8,4,9]))),Mi=t.lazy(()=>q(()=>import("./SportsPage-WpTKhMid.js").then(e=>e.d),__vite__mapDeps([11,1,2,3,4,8]))),zi=t.lazy(()=>q(()=>import("./BanyaPage-BIPZ2o4U.js"),__vite__mapDeps([12,1,2,3,8,4,9]))),Ki=t.lazy(()=>q(()=>import("./ContactsPage-DakDAWNw.js"),__vite__mapDeps([13,1,2,3,4,14,8,9]))),Ei=t.lazy(()=>q(()=>import("./PrivacyPage-BQ0-LzVu.js"),__vite__mapDeps([15,1,2,3,14,4]))),Ri=t.lazy(()=>q(()=>import("./TermsPage-DVFzXtlm.js"),__vite__mapDeps([16,1,2,3,14,4]))),qi=t.lazy(()=>q(()=>import("./SurveyPage-CdfPKXnG.js"),__vite__mapDeps([17,1,2,3,8,4,9]))),Di=()=>null,Li=()=>{const t=a();return i.jsx(e.Suspense,{fallback:i.jsx(Di,{}),children:i.jsxs(C,{location:t,children:[i.jsx(F,{path:"/",element:i.jsx(Bi,{})}),i.jsx(F,{path:"/restaurant",element:i.jsx(Ii,{})}),i.jsx(F,{path:"/spa",element:i.jsx(Ti,{})}),i.jsx(F,{path:"/sports",element:i.jsx(Mi,{})}),i.jsx(F,{path:"/banya",element:i.jsx(zi,{})}),i.jsx(F,{path:"/contacts",element:i.jsx(Ki,{})}),i.jsx(F,{path:"/privacy",element:i.jsx(Ei,{})}),i.jsx(F,{path:"/terms",element:i.jsx(Ri,{})}),i.jsx(F,{path:"/survey",element:i.jsx(qi,{})}),i.jsx(F,{path:"*",element:i.jsx(j,{to:"/",replace:!0})})]})})},$i=()=>{const{isLoading:e,isContentReady:t}=W();return i.jsxs(i.Fragment,{children:[i.jsx(X,{isVisible:e}),i.jsx(Q,{}),t&&i.jsx("div",{className:"App",children:i.jsx(Ce,{children:i.jsx(Li,{})})})]})};function Oi(){const{i18n:a,t:n}=r(),[o,s]=t.useState(0);return e.useEffect(()=>{const e=()=>{s(e=>e+1)};return a.on("languageChanged",e),()=>{a.off("languageChanged",e)}},[a]),e.useEffect(()=>{document.documentElement.dir=a.dir(),document.documentElement.lang=a.language,"KAIF | Sauna & Spa"!==document.title&&!document.title.includes("KAIF")&&document.title.includes("|")||(document.title=n("page_titles.home","KAIF | Sauna & Spa"))},[a.language,n,o]),i.jsx(k,{children:i.jsxs(T,{theme:te,children:[i.jsx(D,{}),i.jsx(L,{}),i.jsx(H,{children:i.jsx(A,{basename:"/",children:i.jsx($i,{})})})]})},`app-${a.language}-${o}`)}console.log=()=>{},console.warn=()=>{},console.info=()=>{},"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("/sw.js").then(e=>{e.addEventListener("updatefound",()=>{const i=e.installing;i.addEventListener("statechange",()=>{"installed"===i.state&&navigator.serviceWorker.controller})})}).catch(e=>{})}),S.createRoot(document.getElementById("root")).render(i.jsx(Oi,{}));export{Fe as P,q as _};
