import{r as e,u as a,j as t,s as i,b as r,R as n,t as o,v as s,w as l,x as c,F as d,c as p,y as g,z as m}from"./vendor-react-core-CiytVzfL.js"
import{d as b,m as f}from"./vendor-styled-6ntj7xXP.js"
import{P as h}from"./PageScrollReset-CBLPOmkb.js"
import{P as u}from"./main-tG30qmu8.js"
import{m as x}from"./vendor-framer-DJEKn808.js"
...
return n.useEffect(()=>{const e=()=>{d(window.innerWidth<=768)}
return e(),window.addEventListener("resize",e),()=>window.removeEventListener("resize",e)},[]),t.jsx(B,{children:t.jsxs(C,{children:[t.jsxs(A,{children:[t.jsx(H,{initial:c?{opacity:0}:{opacity:0,y:20},whileInView:c?{opacity:1}:{opacity:1,y:0},viewport:{once:1},transition:{duration:c?.4:.6},children:o?"Индивидуальные парения":"Individual Steam Sessions"}),t.jsx(q,{initial:c?{opacity:0}:{opacity:0,y:20},whileInView:c?{opacity:1}:{opacity:1,y:0},viewport:{once:1},transition:{duration:c?.4:.6,delay:c?.05:.1},children:o?"Выберите свой идеальный банный ритуал":"Choose your perfect banya ritual"})]}),t.jsx(M,{children:l.map((e,a)=>t.jsxs(L,{initial:c?{opacity:0}:{opacity:0,y:20},whileInView:c?{opacity:1}:{opacity:1,y:0},viewport:{once:1,margin:c?"-20px":"-50px"},transition:{duration:c?.3:.4,delay:c?.02*a:.05*a,ease:"easeOut"},children:[t.jsx(V,{}),t.jsxs(R,{children:[t.jsx(P,{className:"ritual-title",children:e.title||"Loading..."}),t.jsx(O,{children:e.subtitle||"STEAM"}),t.jsx(G,{children:e.description||"Loading description..."})]}),t.jsxs(Y,{children:[t.jsxs(W,{children:[t.jsx(U,{children:o?"Время":"Duration"}),t.jsx(D,{children:e.duration||"0 min"})]}),t.jsxs(F,{children:[t.jsx(K,{children:o?"Стоимость":"Price"}),t.jsx(X,{children:e.price||"0 THB"})]})]})]},`${e.id}-${r}`))})]})})}
f`
...
`,Oe=()=>{const{t:e}=a(),i=()=>{const a=e("common.phone_number","+66 62 480 5877"),t=encodeURIComponent(e("common.whatsapp_messages.book_banya","Hello! I would like to book the Russian Banya"))
window.open(`https://wa.me/${a.replace(/\D/g,"")}?text=${t}`,"_blank")},n=[{icon:c,title:e("banya.booking.contact.whatsapp.title","WhatsApp"),value:e("banya.booking.contact.whatsapp.value","Book via WhatsApp"),action:i},{icon:d,title:e("banya.booking.contact.location.title","Location"),value:e("banya.booking.contact.location.value","Kathu, Phuket"),action:()=>{window.open("https://maps.app.goo.gl/h7PzpHpBeurg7eK18","_blank")}},{icon:p,title:e("banya.booking.contact.hours.title","Hours"),value:e("banya.booking.contact.hours.value","17:00 - 22:00"),action:null}]
return t.jsxs(ze,{children:[t.jsx(Pe,{className:"top-left",children:"᚛ᚃᚔᚏᚓ᚜"}),t.jsx(Pe,{className:"bottom-right",children:"᚛ᚔᚉᚓ᚜"}),t.jsxs(Ie,{children:[t.jsxs(Te,{children:[t.jsx(_e,{initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:1},transition:{duration:.6},children:e("banya.booking.badge","Booking")}),t.jsx(Se,{initial:{opacity:0,y:30},whileInView:{opacity:1,y:0},viewport:{once:1},transition:{duration:.8,delay:.2},children:t.jsx("span",{dangerouslySetInnerHTML:{__html:e("banya.booking.title",'Book the <span className="highlight">Banya</span>')}})}),t.jsx(Ee,{initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:1},transition:{duration:.6,delay:.4},children:e("banya.booking.description","Contact us through convenient channels for booking")})]}),t.jsx(x.div,{initial:{opacity:0,y:40},whileInView:{opacity:1,y:0},viewport:{once:1},transition:{duration:.8,delay:.6},children:t.jsxs(Ne,{children:[t.jsx($e,{children:t.jsx("span",{dangerouslySetInnerHTML:{__html:e("banya.booking.cta.title",'Ready to immerse in the world of <span className="highlight">Russian Banya</span>?')}})}),t.jsx(Be,{children:e("banya.booking.cta.description","Contact us for detailed information about prices, availability and features of our banya programs")}),t.jsx(Ce,{children:n.map((e,a)=>t.jsxs(Ae,{initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:1},transition:{duration:.6,delay:.8+.1*a},onClick:e.action,style:{cursor:e.action?"pointer":"default"},children:[t.jsx(He,{children:t.jsx(e.icon,{})}),t.jsx(qe,{children:e.title}),t.jsx(Me,{children:e.value})]},a))}),t.jsxs(Le,{children:[t.jsxs(Ve,{onClick:i,whileHover:{scale:1.05},whileTap:{scale:.95},children:[t.jsx(c,{}),e("banya.booking.book_whatsapp_button","Book via WhatsApp")]}),t.jsxs(Re,{onClick:()=>{const a=e("common.phone_number","+66 62 480 5877")
window.open(`tel:${a}`,"_self")},whileHover:{scale:1.05},whileTap:{scale:.95},children:[t.jsx(r,{}),e("banya.booking.call_now_button","Call Now")]})]})]})})]})]})}
f`
  0%, 100% { text-shadow: 0 0 10px #ff6b35, 0 0 20px #ff6b35; }
  50% { text-shadow: 0 0 20px #ff6b35, 0 0 30px #ff6b35, 0 0 40px #ff6b35; }
`,f`
...
`,ta=()=>{const{t:i}=a(),[r,n]=e.useState(null),o=[{question:i("banya.faq.questions.panoramic.question","What's special about the panoramic banya?"),answer:i("banya.faq.questions.panoramic.answer","Our banya is unique with several features: 150 square meters with panoramic jungle windows, built from Siberian cedar and Altai linden - premium natural materials. It's the only panoramic Russian banya in Phuket where you can enjoy traditional banya rituals with tropical nature views.")},{question:i("banya.faq.questions.procedures.question","What procedures are included in the banya ritual?"),answer:i("banya.faq.questions.procedures.answer","Depending on your chosen program you'll receive: classic banya ritual with birch brooms, aromatherapy with essential oils, herbal infusions and teas, option to order massage in the steam room, and personal accompaniment by a master attendant for VIP programs.")},{question:i("banya.faq.questions.materials.question","What materials is the banya built from?"),answer:i("banya.faq.questions.materials.answer","The banya is built exclusively from natural eco-friendly materials: Siberian cedar, Altai linden, Karelian birch. All finishes are natural, without chemical additives. Such materials create a special microclimate and provide natural aromatherapy.")}]
return t.jsx(Ge,{children:t.jsxs(Ye,{children:[t.jsxs(We,{children:[t.jsxs(Ue,{initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:1},transition:{duration:.6},children:[t.jsx(g,{}),i("banya.faq.badge","Questions & Answers")]}),t.jsx(De,{initial:{opacity:0,y:30},whileInView:{opacity:1,y:0},viewport:{once:1},transition:{duration:.8,delay:.2},children:t.jsx("span",{dangerouslySetInnerHTML:{__html:i("banya.faq.title",'Frequently Asked <span className="highlight">Questions</span>')}})}),t.jsx(Fe,{initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:1},transition:{duration:.6,delay:.4},children:i("banya.faq.subtitle","Answers to the most popular questions about our banya")})]}),t.jsx(Ke,{children:o.map((e,a)=>t.jsxs(Xe,{initial:{opacity:0,y:30},whileInView:{opacity:1,y:0},viewport:{once:1},transition:{duration:.6,delay:.1*a},children:[t.jsxs(Qe,{onClick:()=>(e=>{n(r===e?null:e)})(a),children:[t.jsx(Je,{$isOpen:r===a,children:e.question}),t.jsx(Ze,{$isOpen:r===a,children:t.jsx(m,{})})]}),t.jsx(ea,{$isOpen:r===a,children:t.jsx(aa,{children:t.jsx("p",{children:e.answer})})})]},a))})]})})},ia=b.div`
