...
`,I={small:"(max-width: 480px)",medium:"(max-width: 768px)",large:"(max-width: 1200px)",original:""},B=({src:i,alt:l="",fallbackSrc:s,sizes:m=I,loading:b="lazy",objectFit:g="cover",objectPosition:p="center",placeholderColor:r="#f5f5f5",className:t,style:n,onLoad:w,onError:o,withPlaceholder:u=!0,withLoadingIndicator:d=!0,disableWebP:c=!1,priority:h=!1,...f})=>{const[k,j]=e.useState(!1),[x,B]=e.useState(!1),P=e.useRef(null),q=(()=>{if(!i||!i.startsWith("/images/"))return{original:{webp:i,fallback:s||i}};const e=(i.startsWith("/")?i.substring(1):i).replace(/^images\//,"");return y.images[e]||{original:{webp:c?s||i:i.replace(/\.(jpg|jpeg|png)$/i,".webp"),fallback:s||i}}})(),V=q.thumbnail?y.detectWebP()&&!c?q.thumbnail.webp:q.thumbnail.fallback:null,C=(()=>{if("undefined"==typeof window)return"medium";const e=window.innerWidth;return e<=480?"small":e<=768?"medium":e<=1200?"large":"original"})(),W=q[C]||q.original;return e.useEffect(()=>{if(!P.current||"lazy"!==b||h)return;const e=new IntersectionObserver(a=>{a.forEach(a=>{if(a.isIntersecting){const i=a.target;i.setAttribute("loading","eager"),e.unobserve(i)}})},{rootMargin:"200px 0px",threshold:.01});return e.observe(P.current),()=>{P.current&&e.unobserve(P.current)}},[b,h]),a.jsxs(v,{className:t,style:n,$placeholderColor:r,onMouseEnter:()=>{q.large&&"large"!==C&&((new Image).src=y.detectWebP()&&!c?q.large.webp:q.large.fallback)},...f,children:[u&&V&&a.jsx(S,{$thumbnail:V,$loaded:k}),d&&a.jsx(A,{$loaded:k}),a.jsxs(z,{children:[!c&&q.small&&a.jsx("source",{media:"(max-width: 480px)",srcSet:q.small.webp,type:"image/webp"}),!c&&q.medium&&a.jsx("source",{media:"(max-width: 768px)",srcSet:q.medium.webp,type:"image/webp"}),!c&&q.large&&a.jsx("source",{media:"(max-width: 1200px)",srcSet:q.large.webp,type:"image/webp"}),!c&&q.original&&a.jsx("source",{srcSet:q.original.webp,type:"image/webp"}),q.small&&a.jsx("source",{media:"(max-width: 480px)",srcSet:q.small.fallback}),q.medium&&a.jsx("source",{media:"(max-width: 768px)",srcSet:q.medium.fallback}),q.large&&a.jsx("source",{media:"(max-width: 1200px)",srcSet:q.large.fallback}),a.jsx(_,{ref:P,src:x?s||i:W.fallback,alt:l,loading:h?"eager":b,onLoad:()=>{j(!0),w&&w()},onError:()=>{B(!0),o&&o()},$loaded:k,$objectFit:g,$objectPosition:p})]}),u&&!V&&a.jsx($,{$loaded:k,$placeholderColor:r})]})},P=h.section`
  position: relative;
  min-height: 100vh;
  background: white;
  display: flex;
