import{f as o}from"./styled-components-fuCKgGld.js";import"./react-core-DWAaPJsY.js";import"./vendor-misc-D8JVgYt7.js";const t=o`
  /* KAIF brand font */
  @font-face {
    font-family: 'KAIF';
  ...
  * {
  ...
  /* Типография */
  h1, h2, h3, h4, h5, h6 {
    font-family: ${({theme:o})=>o.fonts.heading||'"Playfair Display", serif'};
    font-weight: 600;
    color: ${({theme:o})=>o.colors.text.dark||"#1A2B1D"};
  }
  ...
  a {
    color: ${({theme:o})=>o.colors.primary||"#90B3A7"};
    text-decoration: none;
    transition: color 0.3s ease;
    
    &:hover {
      color: ${({theme:o})=>o.colors.secondary||"#D4A574"};
    }
  }
