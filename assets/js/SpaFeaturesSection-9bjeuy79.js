import{u as e,j as i,m as t,n as r,af as a,q as o}from"./vendor-react-core-CiytVzfL.js"
...
`,u=n.p`
  ...
  margin-bottom: 0;
  font-weight: 400;
`,f=()=>{const{t:n}=e(),s=[{id:1,icon:i.jsx(t,{}),title:n("spa.features.premium_quality.title","Премиум качество"),description:n("spa.features.premium_quality.description","Используем только лучшие продукты и оборудование для всех процедур")},{id:2,icon:i.jsx(r,{}),title:n("spa.features.full_relaxation.title","Полное расслабление"),description:n("spa.features.full_relaxation.description","Создаем атмосферу комфорта для вашего расслабления и отдыха")},{id:3,icon:i.jsx(a,{}),title:n("spa.features.experienced_masters.title","Опытные мастера"),description:n("spa.features.experienced_masters.description","Специалисты с многолетним опытом и постоянным развитием навыков")},{id:4,icon:i.jsx(o,{}),title:n("spa.features.individual_approach.title","Индивидуальный подход"),description:n("spa.features.individual_approach.description","Учитываем ваши пожелания и особенности для максимального результата")}]
return i.jsx(d,{children:i.jsxs(l,{children:[i.jsx(p,{initial:{opacity:0,y:30},whileInView:{opacity:1,y:0},transition:{duration:.6},viewport:{once:1},children:n("spa.features.title","Почему выбирают нас")}),i.jsx(c,{initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},transition:{duration:.6,delay:.2},viewport:{once:1},children:n("spa.features.subtitle","Мы стремимся предоставить вам исключительный опыт релаксации и ухода")}),i.jsx(m,{children:s.map((e,t)=>i.jsxs(x,{initial:{opacity:0,y:30},whileInView:{opacity:1,y:0},transition:{duration:.5,delay:.1*t},viewport:{once:1},whileHover:{scale:1.02},children:[i.jsx(g,{children:e.icon}),i.jsx(h,{children:e.title}),i.jsx(u,{children:e.description})]},e.id))})]})})}
export{f as default}
