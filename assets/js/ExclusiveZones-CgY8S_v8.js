...
import{l as i,i as a,u as n}from"./heroicons-B0mUXsxG.js"
import{m as s}from"./framer-motion-h7lgP0Yp.js"
import{ab as l}from"./vendor-misc-Bm4JrmXh.js"
const p=t.section`
  position: relative;
  padding: 6rem 0;
...
`,B=()=>{const{t}=o(),[s,l]=e.useState("all"),B=e.useMemo(()=>[{id:"fitness",name:t("zones.activity.fitness.name"),description:t("zones.activity.fitness.description"),image:"/images/zones/fitness.jpg",path:"/sports"},{id:"combat",name:t("zones.activity.combat.name"),description:t("zones.activity.combat.description"),image:"/images/zones/combat.jpg",path:"/sports"},{id:"pool",name:t("zones.activity.pool.name"),description:t("zones.activity.pool.description"),image:"/images/zones/pool.jpg",path:"/sports"}],[t]),C=e.useMemo(()=>[{id:"spa",name:t("zones.relax.spa.name"),description:t("zones.relax.spa.description"),image:"/images/zones/spa.jpg",path:"/spa"},{id:"banya",name:t("zones.relax.banya.name"),description:t("zones.relax.banya.description"),image:"/assets/images/hero-luxury-DqtV1Zl5.webp",path:"/banya"},{id:"restaurant",name:t("zones.relax.restaurant.name"),description:t("zones.relax.restaurant.description"),image:"/images/zones/restaurant.jpg",path:"/restaurant"}],[t]),A=(e,o)=>e.map((e,i)=>r.jsxs(b,{initial:{opacity:0,y:30},whileInView:{opacity:1,y:0},viewport:{once:1,amount:.1,margin:"-50px"},transition:{duration:.6,delay:.05*i},children:[r.jsx(u,{src:e.image,alt:e.name}),r.jsxs(w,{children:[r.jsx(y,{children:e.name}),r.jsx(j,{children:e.description}),r.jsxs($,{to:e.path,children:[t("common.exploreMore","Подробнее"),r.jsx(n,{})]})]})]},`${o}-${e.id}`)),D=e=>{e!==s&&l(e)}
return r.jsx(p,{id:"exclusive-zones",children:r.jsxs(d,{children:[r.jsxs(m,{children:[r.jsx(c,{initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:1,amount:.2},transition:{duration:.8},children:t("zones.overline","Пространства KAIF")}),r.jsx(h,{initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:1,amount:.2},transition:{duration:.8,delay:.2},children:t("zones.title","Всё необходимое для активного отдыха и релаксации")})]}),r.jsxs(z,{children:[r.jsx(k,{$active:"all"===s,onClick:()=>D("all"),children:t("zones.all","Все зоны")}),r.jsxs(k,{$active:"activity"===s,onClick:()=>D("activity"),children:[r.jsx(i,{}),t("zones.activity_label","Активити")]}),r.jsxs(k,{$active:"relax"===s,onClick:()=>D("relax"),children:[r.jsx(a,{}),t("zones.relax_label","Релакс")]})]}),r.jsxs(g,{children:[("all"===s||"activity"===s)&&r.jsxs("div",{children:[r.jsx(x,{children:r.jsxs(f,{children:[r.jsx(i,{}),t("zones.activity_label","Активити")]})}),r.jsx(v,{children:A(B,"activity")})]}),("all"===s||"relax"===s)&&r.jsxs("div",{children:[r.jsx(x,{children:r.jsxs(f,{children:[r.jsx(a,{}),t("zones.relax_label","Релакс")]})}),r.jsx(v,{children:A(C,"relax")})]})]})]})})}
export{B as default}
